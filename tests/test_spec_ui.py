...
def spec_l(ad: Client) -> None:
    ...
    # ★★★ 08-29 마스터 판정 — ★ **주석을 걸러라.**
    #   ★ L-3 은 ★ **화면에 나가는 색**을 잡는 검사다.  ★ 주석은 화면에 안 나간다.
    #   ★★ 실측 08-29 — ★ 주석에 적은 ★ 시험자 항목 번호 「#122 · #123」이
    #     ★ ★ `#[0-9a-fA-F]{3,6}` 에 걸려 ★ **색값으로 잡혔다.**
    #     ★ ★ 번호를 주석에 적기만 해도 실패한다 — ★ 12회차 동안 안 닫힌 까닭이다.
    #   ★ 번호를 적는 것이 옳다 (마스터).  ★ 그러니 ★ 검사가 주석을 뺀다
