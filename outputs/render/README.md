...
| `/admin/run` | [admin_run.html](admin_run.html) | 200 | 15,821B |
| `/admin/audit` | [admin_audit.html](admin_audit.html) | 200 | 30,350B |
| `/admin/status` | [admin_status.html](admin_status.html) | 200 | 14,897B |
| `/admin/import` | [admin_import.html](admin_import.html) | 200 | 9,134B |
| `/admin/collect` | [admin_collect.html](admin_collect.html) | 200 | 43,308B |
| `/admin/users` | [admin_users.html](admin_users.html) | 200 | 9,177B |
| `/admin/scoring` | [admin_scoring.html](admin_scoring.html) | 200 | 40,696B |
...
| `/admin/config` | [admin_config.html](admin_config.html) | 200 | 118,883B |
| `/admin/query` | [admin_query.html](admin_query.html) | 200 | 16,649B |
| `/admin/api` | [admin_api.html](admin_api.html) | 200 | 5,290B |
| `/admin/tools` | [admin_tools.html](admin_tools.html) | 200 | 8,603B |
| `/admin/docs` | [admin_docs.html](admin_docs.html) | 200 | 19,974B |
