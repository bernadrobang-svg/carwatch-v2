...
## STEP 49c [규격] — ★★ **`⑥ not_requested` 만 남은 실패는 ★ 「진행 중」이다** (개정 1122 · 09-03)

```
★★★ 개발측 v363 물음 — 「★ 규격(STEP 53 ⑥)이 ★ 한 판에 다 못 받으면 ★ `failed` 로 적으라 한다.
   ★ ★ 그런데 ★ 엔카 **136,431번**을 ★ 한 판에 받을 길이 없다.
   ★ ★ ★ 그러면 ★ `S46-241` 은 ★ **엔카가 100% 되기 전까지 늘 붉다**」
★★ **가이드 답 — ★ 개발측 안 ②를 받는다**
```

| 사유 | 어떻게 보나 | 왜 |
|---|---|---|
| ★ **⑥ `not_requested`** 만 남았다 | ★ **「진행 중」** | ★ **이어 받으면 준다** (`STEP 49a`) |
| ★ ⑤ 저장 누락 · ④ ok 0 · ③ 형식 거부 | ★ **그대로 실패** | ★ 이어 받아도 ★ **안 준다** |

```
★ 까닭 — ★ **늘 붉은 검사는 ★ 아무도 안 본다.  ★ 그것이 더 나쁘다**
★ ★ 「아직 안 끝났다」는 ★ 회차의 「끝까지 받은 묶음 N/M」이 ★ 말한다 — ★ 검사가 아니다
검산  `S46-241`
```

## STEP 49b [규격] — ★★ **빈 쪽이 이어져도 ★ 끝이 아닐 수 있다** (개정 1108 · 09-02)

```
★★★ 실측 09-02 — ★ KB 는 ★ **매물이 끝난 뒤에도 ★ 여섯 쪽을 ★ 72KB 로 돌려준다**
   page 45  carSeq 40  · 76,071B
   page 46  carSeq 11  · 69,543B   ★ 매물은 여기서 끝난다
   page 47  carSeq  0  · 72,098B   ★ **끝 신호가 없다** — ★ 빈 카드 화면이다
   page 50  carSeq  0  · 71,948B   ★ 〃
   page 53  carSeq  0  · ★ **3,585B** ★ 「차량이 없습니다」 ← ★ **진짜 끝**
★ ★ 우리 `TAIL_LIMIT` 이 ★ **4** 라 ★ 47~50 을 보고 ★ 「끝났다」로 멈췄다
★ ★ ★ 그래서 ★ `G80_25T` 한 묶음이 ★ 안 끝나 ★ **34/35** 였다 — ★ 88.3% 의 정체다
```

| 무엇 | 어떻게 |
|---|---|
| 멈추는 잣대 | ★ **「빈 쪽 N개」가 아니다** — ★ **끝 신호**를 본다 (본문 크기·「차량이 없습니다」) |
| 사이트를 붙일 때 | ★ **이것부터 잰다** — ★ 매물이 끝난 뒤 ★ 몇 쪽을 어떤 꼴로 돌려주는가 |
| 적을 곳 | ★ `docs/{SITE}_API.md` 에 ★ **끝 신호**를 적는다 |
| 금지 | ★ 「빈 쪽이 나왔으니 끝」으로 ★ **단정하는 것** |
