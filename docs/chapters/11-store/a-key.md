...
## ★ ①이 되는 까닭 — ★ 목록이 이미 준다 [실측 09-03 · KB]

```
목록 카드 한 장   제네시스 G80(RG3) 3.5 T-GDi AWD · 22/03식 · 51,234km ·
                 경기 · 3,520만원 · 진단 · 실차주 · KB보증 · 사진 · carSeq
★ 추천 여섯 축(348점) 가운데 ★ **예산 95 · 주행 107 · 연식 80 · 크기 31 이 다 선다**
★ ★ 못 서는 것 — ★ 색 25＋10 · ★ 상태 축(사고 51 · 골격 43 · 외판 28 …)
```
