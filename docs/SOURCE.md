...
| 파일 | 줄 | 무엇 |
|---|--:|---|
| `validate/v0_guide.py` | 7,505 | 가이드 문서 자체를 검사한다 (V0 계열). |
...
### `tools/browser_diff.py` — 661줄

```
pairs:35  look:48  main:298  hidden_text_report:464  encar_collect_report:598
```
