...
| `web/views.py` | 3,139 | 화면 어댑터 (14장 STEP 142 · 152). |
...
| `report/screens/tabs.py` | 1,636 | 추천 탭 2·3·4 — ★ 값을 붙인다 (지시 `r1184` A · 규격 `docs/RECOMMEND_SCREEN.md`). |
...
| `tools/fill_encar_options.py` | 102 | ★ 엔카 옵션 **이름**을 사전에 채운다 (`catalog` 창구가 준다). |
