...
| `validate/v0_guide.py` | 1,476 | 가이드 문서 자체를 검사한다 (V0 계열). |
...
| `tools/collect_kbchachacha.py` | 390 | KB차차차 목록 수집 · 총 매물 수 세기 (명령서 `ORDER_20260822_r515.md` 3-2 · 단계 9). |
...
### `tools/collect_kbchachacha.py` — 390줄
