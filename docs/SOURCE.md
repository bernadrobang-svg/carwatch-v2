...
| `validate/v0_guide.py` | 3,003 | 가이드 문서 자체를 검사한다 (V0 계열). |
...
| `tools/tmp_check.py` | 65 | 0a 계측 — 한 단계가 쓰기 트랜잭션을 몇 초 쥐는가 (사본에서 잰다). |
