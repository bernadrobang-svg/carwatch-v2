...
| 파일 | 줄 | 무엇 |
|---|--:|---|
| `validate/v0_guide.py` | 5,176 | 가이드 문서 자체를 검사한다 (V0 계열). |
| `validate/v11_web.py` | 5,049 | V11 표현 계층 검증 (14장 STEP 153). |
| `report/screens/build.py` | 4,058 | 화면 데이터 생성. |
| `web/views.py` | 2,770 | 화면 어댑터 (14장 STEP 142 · 152). |
| `validate/v3_logic.py` | 2,316 | V3 로직 검증 — 판정이 작동하는가 · 변별력이 있는가. |
| `store/core.py` | 1,887 | CORE 저장소 (L4).  사이트 무관 공통 스키마. |
| `collect/runner.py` | 1,741 | 수집 실행 규칙. |
...
| `report/render.py` | 945 | 리포트 생성 (L9). |
...
| `report/screens/views.py` | 844 | 화면 전용 DTO. |
...
| `tools/collect_kbchachacha.py` | 564 | KB차차차 목록 수집 · 총 매물 수 세기 (명령서 `ORDER_20260822_r515.md` 3-2 · 단계 9). |
...
| `tools/backfill_from_raw.py` | 526 | ★★★★★ 08-30 (명령서 r974 · 0j 4) — ★ Ⓐ 「이미 오는 것을 읽는다」. |
...
| `tools/collect_hyundai_cert.py` | 345 | 현대·제네시스 인증중고차 목록 수집 (명령서 `ORDER_20260822_r515.md` 3장 · 단계 11). |
...
| `tools/collect_volvo.py` | 241 | 볼보 셀렉트 수집 — xhr-results 쪽넘김 (명령서 1a). |
...
| `tools/collect_heydealer.py` | 182 | 헤이딜러 수집 — 토큰 → 차종별 목록 → 상세 (명령서 37). |
...
| `analyze/axis/value.py` | 172 | ① 값 250 — 시세 대비 100 · 신차가 대비 80 · 주행 대비 70. |
...
| `analyze/axis/taste.py` | 122 | ④ 취향 50점 — HUD 15 · 선루프 10 · 색상 10 · 지정 옵션 15. |
...
## 큰 파일 — 무엇이 어디에 (200줄 이상 88개)

### `validate/v0_guide.py` — 5,176줄

```
_read:25  s43_2_axis_ids:32  s44_4_scope_written:70  s44_5_site_consistent:102  s45_1_one_version:135  _order_files:158  s44_1_order_exists:171  s44_2_one_order:213  s43_2b_axis_renamed:228  s43_2c_no_hda:254  s45_5_no_axis_scores:308  s45_4_table_generated:346  s45_3_spec_totals:361  s45_2_mock_numbers:432  s44_3_specs_in_order:453  s43_3_version_matches:491  _h_tags:532  s46_21_one_screen_per_file:548  s46_22_section_order:573  _targets:642  s46_23_site_query_filled:648  s46_24_facet_unconfirmed:663  s46_30_index_covers_docs:680  s46_31_spec_sites_in_config:719  s46_32_generated_fresh:740  _req_rows:782  _tokens:794  _named_docs:809  s46_36_dropped_not_alive:821  s46_40_progress_docs_changed:849  s46_41_site_status_known:880  _templates:922  s46_45_spec_not_in_list:927  s46_46_spec_forbidden_ten:947  s46_66_links_encoded:973  s46_65_verdict_fresh:1012  _sian_files:1050  s46_67_sian_names_dont_clash:1059  s46_68_watch_is_mobile_first:1122  s46_74_rows_per_page:1176  s46_75_v4m_common:1222  s46_76_collectors_keep_raw:1262  s46_115_run_screen_still:1300  s46_125_sort_axes_really_sort:1329  s46_118_heart_has_anchor:1360  s46_121_header_rule_in_one_place:1400  s46_116_reasons_in_plain_words:1422  s46_120_registry_key_matches:1449  s46_123_toss_palette_only:1485  s46_122_shared_fragments:1527  s46_128_batch_gives_a_window:1571  s46_127_collector_has_screen_or_timer:1615  s46_124_db_opened_with_pragmas:1663  s46_126_fetch_outside_transaction:1699  s46_117_collectors_sweep_gone:1733  s46_77_kb_is_our_targets_only:1782  s46_78_encar_only_paths_are_scoped:1837  s46_87_request_site_matches_listing:1879  s46_88_encar_blocked_banner:1948  _paired_rows:2013  _grade_order_list:2053  s46_54_grade_two_step:2065  s46_55_price_gap_30:2090  s46_56_accident_split:2116  s46_90_pending_not_graded:2156  _registrable:2205  s46_94_source_url_site_matches:2219  s46_91_raw_vs_stored:2263  s46_97_raw_linked_by_source_id:2335  s46_99_login_then_watch:2403  _logged_opener:2499  _sian_seq:2538  s46_100_sian_word_order:2570  s46_102_electric_only_is_electric:2707  s46_103_sian_values_carried:2759  s46_98_sian_words_on_screen:2800  s46_95_screens_alive:2906  s46_96_site_sells_but_no_code:2962  s46_92_browser_zero_count:3002  s46_161_no_unproven_absence:3071  s46_162_promised_checks_exist:3120  s46_145_numbers_have_meaning:3150  s46_155_screen_spec_has_mockup:3179  s46_163_mockup_has_route:3212  _guide_docs:3243  s46_129_table_sum_counted:3252  s46_132_handover_says_remeasure:3284  s46_140_new_host_has_robots:3298  s46_142_site_count_matches:3317  s46_146_absence_needs_parser_check:3352  s46_154_master_wish_in_registry:3374  s46_131_paging_claim_measured:3396  s46_135_generalisation_has_sample:3418  s46_138_all_claim_needs_source:3435  s46_149_confession_is_closed:3459  s46_156_answer_touches_spec:3486  s46_130_one_tally_per_register:3512  s46_134_target_site_pair:3529  s46_141_filter_claim_measured:3555  s46_143_master_items_are_master:3572  s46_147_absence_needs_ten:3607  s46_150_column_from_ddl:3629  s46_133_check_gap_in_pending:3651  s46_136_warn_number_moves:3669  s46_137_config_key_has_reader:3691  s46_139_field_claim_counted:3720  s46_148_axis_gap_traced:3737  s46_152_dev_rounds_read:3755  s46_159_design_is_doable:3788  s46_144_empty_is_split:3807  s46_153_owner_is_judged:3824  s46_157_perf_claim_is_timed:3856  s46_158_size_claim_is_measured:3874  s46_160_ev_leak_full_mark:3892  s46_164_dev_pending_answered:3909  s46_165_fixable_not_called_unmeasurable:3943  s46_166_decision_reached_chapters:3984  s46_168_check_counts_exceptions:4014  s46_169_gone_has_reason:4048  s46_170_one_architecture:4065  s46_171_yardstick_names_screen:4083  s46_172_absence_read_as_human:4102  s46_173_endpoint_not_wordcount:4126  s46_174_no_endpoint_only_if_probed:4151  s46_175_no_lumped_axes:4178  s46_176_guide_probes_sites:4211  s46_177_catalog_not_site_locked:4239  s46_178_list_field_not_empty_axis:4264  s46_179_no_penalty_without_source:4289  s46_180_code_table_per_site:4303  s46_181_read_stored_before_probing:4330  s46_182_all_sites_before_claiming_all:4349  s46_183_master_only_after_probing:4377  s46_184_unfetched_is_not_absent:4406  s46_185_file_is_the_原本:4434  s46_186_grade_distribution_watched:4464  s46_187_cheaper_scores_higher:4478  s46_188_screen_before_claiming_missing:4505  s46_191_budget_follows_fuel_rule:4529  s46_192_pref_brands_registered:4565  s46_202_no_raw_template_tags:4590  s46_213_recommend_has_no_sold:4603  s46_203_new_site_has_target_keys:4652  s46_203_collect_writes_files_first:4684  s46_205_no_raw_response_writes:4711  s46_206_pdf_link_only:4746  _retired_s46_207_says_measured:4778  s46_207_commit_title_says_fact:4812  s46_208_market_no_negative:4850  s46_214_photo_uses_space_below:4869  _as_check:5103  results:5117  save:5142  run:5153
```

### `validate/v11_web.py` — 5,049줄

```
_web_sources:644  run:656  _late_checks:766  _templates_with_form:830  _spec_routes:851  _screen_routes:876  _routing_table_check:900  _count:937  ctx_account:944  _view_exists:950  _tpl:971  _all_templates:976  _screen_checks:981  _query_budget_check:1235  _import_origin_check:1314  _import_step4_check:1349  _browser_origin_check:1373  _browser_confirm_check:1391  _browser_chunk_check:1416  _status_screen_checks:1474  _status_liveness_check:1512  _menu_label_check:1553  _menu_paths:1581  _listing_rows:1606  _cli_caps:1624  _cli_only_check:1638  _stale_notice_check:1683  _trim_detail_check:1719  _option_sum_check:1742  _heart_line_check:1769  _recommend_terms_check:1790  _lease_checks:1809  _pick_filter_checks:1869  _shortfall_check:1908  _cash_limit_check:1927  _py_files:1958  _menu_no_path_check:1972  _listing_paging_checks:1990  _photo_checks:2026  _compare_shape_check:2067  _detail_shape_checks:2117  _filter_shape_checks:2195  _row_shape_checks:2265  _menu_shape_checks:2337  _sian_css_checks:2420  _cell_of:2495  _link_tip_checks:2518  _origin_link_check:2532  _origin_opens_bad:2577  _choose_check:2626  _order_filter_checks:2642  _checks_cfg:2685  _photo_size_by_screen_check:2694  _template_leak_check:2718  _em_dash_check:2744  _card_limits:2780  _cells_of:2797  _matches:2825  _grid_areas:2845  _hidden_cells:2875  _brace_block:2900  _place_cards:2914  _card_shape_checks:3036  _why_order_spec:3134  _why_order_check:3151  _width_policy:3186  _width_checks:3193  _chart_check:3292  _row_link_checks:3323  _screen_contradiction_check:3359  _chunk_check:3381  _csrf_reuse_check:3421  _origin_price_check:3465  _with_includes:3501  _v1_parity_checks:3523  _media_blocks:3613  _responsive_checks:3634  _dead_links:3722  _null_link_check:3736  _sian_visual_check:3800  _purchase_cost_checks:3864  _report_popup_check:3957  _detail_photo_check:4031  _raw_shown_checks:4082  _compare_diff_check:4169  _chunk_message_check:4233  _whole_char:4260  _chunk_boundary_check:4273  _cell_squeeze_check:4361  _static_version_check:4416  _axis_state_check:4434  _three_values_check:4477  _photo_size_check:4516  _render_metrics_checks:4542  _browser_scope_checks:4641  _import_opened_steps_check:4662  _import_resume_check:4690  _watch_invite_check:4709  _post_smoke_check:4753  _template_roots:4826  _loop_fields:4836  _context_supplied_check:4858  _first_item:4929  _has_field:4943  _table_counts:4949  _save_button_check:4956  _probe:5013  _scratch:5031
```

### `report/screens/build.py` — 4,058줄

```
load_config:48  site_badge:111  axis_heads:130  _grade_order:140  _not_ranked:153  _labels:169  viewer_state:173  _unknown_cfg:183  is_unknown:192  chip:208  _stamp:244  _bulk_axes:248  confirm_ratio:269  _bulk_changes:280  _total_points:307  photo_urls:319  photo_url:351  market_price:382  _days_between:399  _ceil_to:414  _bulk_market:429  _bulk_state:468  not_join_months:501  _left:524  _warranty_state:533  _axis_state:571  _sites_cfg:635  _row:648  _pen_rows:881  _pen_axes:892  _pen_sum:912  _pen_words:920  _view_cfg:929  _grade_rank_sql:943  _sold_words:998  _order_sold:1016  order_clause:1031  _site_detail_urls:1046  _source_url:1055  _view_str:1063  _lease_kinds:1068  excluded_hidden:1075  lease_hidden:1091  _option_blind_sites:1113  _option_group_match:1130  fuel_groups:1144  _fuel_where:1155  _paused_sites:1181  _listings_where:1193  model_counts:1448  count_listings:1475  view_listings:1492  _market_gap_label:1613  _score_bars:1629  _group_caps:1660  _view_list:1681  _view_dict:1686  _soh_low:1691  _view_int:1700  _bucket:1705  _high_km:1712  _option_prices:1721  recommend_funnel:1733  _bulk_upside:1751  view_recommend:1766  recommend_reason:1801  excluded_groups:1844  view_why:1862  _compare_conclusion:1872  view_compare:1895  market_trims:1962  view_market:1984  _web_cfg:2020  _median:2034  _with_height:2039  _price_bins:2054  _group_prices:2075  _by_year:2093  _year_line:2110  _by_trim:2136  _other_targets:2154  count_dealers:2163  _dealer_targets:2169  _dealer_region:2189  view_dealers:2204  view_run:2240  _rank1_of:2246  view_dashboard:2254  _bars:2391  _grade_counts:2406  _relax_sim:2424  _axis_shortfall:2445  _progress:2464  _gone_and_watch:2479  _e_reasons:2522  _today_changes:2540  _step_rows:2565  _bulk_spark:2582  view_watch:2618  _man:2718  _mmdd:2732  _chg:2745  _gap:2760  _days_since:2775  _pending_values:2800  _done_items:2809  view_notready:2835  _unmatched_rows:2876  _report_files:2921  view_reports:2953  _warranty_until:3009  _verdict_lines:3058  _manwon_str:3100  _unknown_lines:3107  _price_history:3139  _alternatives:3156  _rep_flt:3192  view_detail:3198  _quartiles_by_target:3240  market_by_target:3264  _grade_order:3301  _grade_step:3316  _miss_axes_bulk:3322  _sold_int:3370  _sold_where:3378  _days_between:3388  view_sold:3403  _sold_bins:3477  view_track:3535  _accident_bulk:3634  duplicate_listings:3649  _today_counts:3701  _notready_counts:3725  axis_zero_rates:3745  _recommend_models:3781  _active_targets:3833  view_recommend_tabs:3847  _ym_dash:4003  _first_photo:4011  _site_labels:4021  _recommend_axes:4028
```

### `web/views.py` — 2,770줄

```
_rows_per_page:30  _cfg:34  _versions:39  page_extras:58  _points:67  page:89  sold:116  listings:135  why:192  detail:244  _grade_help:277  notready:284  dashboard:294  admin_home:316  _unclassified_split:328  _rows_of:356  _check_reports:366  admin_audit:389  admin_docs:402  _int_param:426  _manwon:465  _site_buttons:470  _filter_chips:520  _order_menu:574  _carry:580  _order_label:590  ORDERS_LABELS_GET:594  _condition_sentence:598  _query_string:616  _page_links:629  _simple_paging:650  _paging:660  _filter_buttons:690  _model_menu:723  _pick_state:740  _option_name_buttons:802  _color_menus:863  _judge_buttons:878  _split_top:906  _fuel_options:912  _distinct_options:923  _km_options:935  _grade_options:943  _keep_query:950  _carry_pick:975  _lease_hidden:985  _excluded_hidden:991  _excluded_why:998  _filter:1008  recommend:1088  _recommend_old:1123  track:1156  compare:1173  market:1195  _first_target:1215  dealers:1221  watch:1241  _note_kinds:1258  _watch_notes:1265  run_view:1292  login:1304  _login_again:1346  _open_session:1362  logout:1403  _watch_queries:1420  watch_query_post:1429  _int_or_none:1459  watch_add_post:1463  _watch_note_post:1523  _watch_invite:1549  watch_update_post:1572  _now:1596  _reason_gate:1603  _gate:1624  _first_flag:1663  _all_hours:1668  admin_run:1696  _target_rows:1764  admin_dict:1777  admin_status:1814  admin_collect:1829  _take_chunk:1888  _verify_part:1931  _run_stamp:1971  _int_or_none:1982  admin_import:1987  admin_scoring:2059  _decide_cards:2112  admin_registry:2140  admin_query:2193  admin_requests:2215  _admin_extra:2277  _config_files:2292  _config_rows:2299  admin_config:2331  _typed:2382  admin_api:2398  _site_query:2448  admin_targets:2461  admin_tools:2559  join:2578  password:2609  admin_users:2624  _account_activity:2684  reports:2690  report_download:2706
```
...
### `collect/runner.py` — 1,741줄

```
CollectGroup:67  load_targets:91  collect_groups:104  facet_axes:172  aspect_names:193  check_facet_axes:197  interpret_failure:211  collect_check:240  FailStreak:310  _sleep:344  _log_request:350  _save_issues:361  make_executors:372  classify_in_group:989  _query_key:1018  _group_of:1026  _fuel_of:1041  _badge_of:1047  _pages_for:1053  _dicts:1067  _option_medians:1103  _market_medians:1149  _trim_ladders:1197  _option_base:1214  _site_grade_rules:1244  _listing_config:1260  _listing_values:1285  _option_money:1304  _owned_months:1323  _option_of:1335  _market_of:1343  _group_sums:1353  _origin_lend_table:1381  _origin_keys:1411  _origin_lent:1430  make_score_executors:1450  make_validate_executor:1670  make_registry_executor:1712
```
...
### `report/render.py` — 945줄

```
_labels:30  _site_blind_axes:35  _stamp:76  _curve_points:91  source_detail_url:134  _why_cheap_of:155  _scoring:196  _penalty_rows:204  _market_pos:218  _site_badge:262  _axis_why:269  _raw_sections:299  _photo_urls:309  _purchase_costs:332  _unknown_axis_cfg:360  render_listing:383  axis_mark:556  source_label:577  _option_rows:625  _fetch_views:685  _strengths:700  _weaknesses:707  _pending_best:714  _cost_rows:747  _known_issues:768  _diagnosis_view:786  render_target:797  render_run:878  render_halt:920  _j:938
```
...
### `report/screens/views.py` — 844줄

```
AxisChip:30  ScoreBar:55  ListingRow:71  ListingFilter:236  WatchRow:325  TargetStat:368  RelaxRow:377  MarketRow:384  ChangeRow:396  AttentionItem:406  ViewerState:414  DashboardView:428  CompareView:465  TrackPair:483  TrackView:513  MarketView:539  DealerRow:554  SoldBin:575  SoldRow:591  SoldView:614  NotReadyView:634  TodayChange:665  StepRow:677  _min_sample:689  PendingValue:707  Bucket:720  ExcludedGroup:740  ReportFile:749  ReportsView:761  RecommendAxis:783  RecommendRow:793  RecommendView:826
```
...
### `tools/collect_kbchachacha.py` — 564줄

```
_now:93  _get:97  fetch_ok:106  page_ids:123  load_filters:133  walk_group:193  count_all:235  probe_detail:261  store_details:280  fetch_details:309  load_details:377  main:456
```
...
### `tools/backfill_from_raw.py` — 526줄

```
_now:28  latest_details:32  heydealer:44  kbchachacha:124  hyundai_cert:210  reborncar:259  out_of_scope:292  bmw_bps:328  kcar:366  _record_site:397  kb_record:424  volvo:434  volvo_detail:443  lexus_detail:471  main:507
```
...
### `report/views.py` — 412줄

```
VersionStamp:18  ReportMeta:30  AxisView:40  FinanceView:64  PurchaseCostItem:85  PurchaseCostView:94  DiagnosisView:118  FetchView:130  CostRow:144  ScoreView:153  CollectSummary:260  ClassifySummary:267  PriceSummary:274  AxisStat:283  CoefficientChange:293  DictChangeSummary:303  TargetReport:311  RunStep:323  RunReport:338  HaltReport:349  FixAction:366  NotifyResult:376  ExportResult:389  display_value:398  display_points:408
```
...
### `tools/collect_hyundai_cert.py` — 345줄

```
target_of:79  _now:95  _post:99  _get:109  fetch_detail:120  load_filters:133  total_count:165  walk:178  main:210
```
...
### `analyze/axis/state.py` — 308줄

```
_panels:43  _rank_worst:47  insurance_trace:59  panel_trace:68  worse_step:80  _accident:87  _frame:109  _outer:129  _repair:151  _special:162  leak_state:174  _leak:196  _site_never:206  _sites_table:218  _consumable:236  _integrity:264  analyze_state:300
```
...
```
_now:45  _get:49  target_names:59  wanted:68  _elapsed:76  load_filters:83  _walk_plan:110  main:121
```
