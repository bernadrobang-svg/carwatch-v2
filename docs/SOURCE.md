...
| `report/screens/build.py` | 3,375 | 화면 데이터 생성. |
| `validate/v0_guide.py` | 2,706 | 가이드 문서 자체를 검사한다 (V0 계열). |
