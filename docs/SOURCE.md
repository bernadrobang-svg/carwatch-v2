...
| 파일 | 줄 | 무엇 |
|---|--:|---|
| `validate/v11_web.py` | 2,443 | V11 표현 계층 검증 (14장 STEP 153). |
| `web/views.py` | 1,842 | 화면 어댑터 (14장 STEP 142 · 152). |
...
| `store/chunk.py` | 74 | 조각 전송 — 바이트를 나누고 서버가 이어붙인다 (개정 307). |
