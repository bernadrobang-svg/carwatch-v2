...
| `validate/v0_guide.py` | 4,508 | 가이드 문서 자체를 검사한다 (V0 계열). |
...
| `tools/collect_heydealer.py` | 220 | 헤이딜러 수집 — 토큰 → 차종별 목록 → 상세 (명령서 37). |
...
### `tools/collect_heydealer.py` — 220줄

```
_now:40  _get:44  _targets:56  walk:74  main:119
```
