...
| `validate/v11_web.py` | 5,044 | V11 표현 계층 검증 (14장 STEP 153). |
| `report/screens/build.py` | 3,990 | 화면 데이터 생성. |
...
| `report/screens/views.py` | 840 | 화면 전용 DTO. |
...
| `tools/browser_diff.py` | 125 | ★★★★★ 09-01 마스터 지시 — ★ **브라우저로 시안과 화면을 대조한다.** |
