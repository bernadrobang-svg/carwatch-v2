...
| 파일 | 줄 | 무엇 |
|---|--:|---|
| `validate/v0_guide.py` | 8,531 | 가이드 문서 자체를 검사한다 (V0 계열). |
...
| `tools/week_task.py` | 325 | ★ 이번 주 과제 — ★ **계약한 차를 이기는 GV70 만** 낸다 (기한 09-11). |
...
### `tools/week_task.py` — 325줄

```
book:29  _won:34  rows:40  _gone:81  _plate:96  _has_hud:125  swap_won:138  wear_won:146  judge:154  report:237  _url:256  main:266  kb_only:303
```
