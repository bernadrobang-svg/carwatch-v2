...
| `validate/v0_guide.py` | 4,309 | 가이드 문서 자체를 검사한다 (V0 계열). |
...
| `tools/undo_wrong_gone.py` | 199 | ★★★★★ 잘못 매긴 `gone` 을 되돌린다 (마스터 0a·0c · 08-30). |
