...
| 파일 | 줄 | 무엇 |
|---|--:|---|
| `validate/v0_guide.py` | 8,145 | 가이드 문서 자체를 검사한다 (V0 계열). |
| `validate/v11_web.py` | 5,083 | V11 표현 계층 검증 (14장 STEP 153). |
| `report/screens/build.py` | 4,755 | 화면 데이터 생성. |
| `web/views.py` | 3,128 | 화면 어댑터 (14장 STEP 142 · 152). |
...
| `report/screens/fetch.py` | 211 | 마스터 회선으로 받기 (`/fetch`) — ★ 지시 `r1200` L-1 ~ L-9. |
...
### `validate/v11_web.py` — 5,083줄

```
_web_sources:644  run:656  _late_checks:766  _templates_with_form:851  _spec_routes:872  _screen_routes:897  _routing_table_check:921  _count:958  ctx_account:965  _view_exists:971  _tpl:992  _all_templates:997  _screen_checks:1002  _query_budget_check:1261  _import_origin_check:1340  _import_step4_check:1375  _browser_origin_check:1399  _browser_confirm_check:1417  _browser_chunk_check:1442  _status_screen_checks:1500  _status_liveness_check:1538  _menu_label_check:1587  _menu_paths:1615  _listing_rows:1640  _cli_caps:1658  _cli_only_check:1672  _stale_notice_check:1717  _trim_detail_check:1753  _option_sum_check:1776  _heart_line_check:1803  _recommend_terms_check:1824  _lease_checks:1843  _pick_filter_checks:1903  _shortfall_check:1942  _cash_limit_check:1961  _py_files:1992  _menu_no_path_check:2006  _listing_paging_checks:2024  _photo_checks:2060  _compare_shape_check:2101  _detail_shape_checks:2151  _filter_shape_checks:2229  _row_shape_checks:2299  _menu_shape_checks:2371  _sian_css_checks:2454  _cell_of:2529  _link_tip_checks:2552  _origin_link_check:2566  _origin_opens_bad:2611  _choose_check:2660  _order_filter_checks:2676  _checks_cfg:2719  _photo_size_by_screen_check:2728  _template_leak_check:2752  _em_dash_check:2778  _card_limits:2814  _cells_of:2831  _matches:2859  _grid_areas:2879  _hidden_cells:2909  _brace_block:2934  _place_cards:2948  _card_shape_checks:3070  _why_order_spec:3168  _why_order_check:3185  _width_policy:3220  _width_checks:3227  _chart_check:3326  _row_link_checks:3357  _screen_contradiction_check:3393  _chunk_check:3415  _csrf_reuse_check:3455  _origin_price_check:3499  _with_includes:3535  _v1_parity_checks:3557  _media_blocks:3647  _responsive_checks:3668  _dead_links:3756  _null_link_check:3770  _sian_visual_check:3834  _purchase_cost_checks:3898  _report_popup_check:3991  _detail_photo_check:4065  _raw_shown_checks:4116  _compare_diff_check:4203  _chunk_message_check:4267  _whole_char:4294  _chunk_boundary_check:4307  _cell_squeeze_check:4395  _static_version_check:4450  _axis_state_check:4468  _three_values_check:4511  _photo_size_check:4550  _render_metrics_checks:4576  _browser_scope_checks:4675  _import_opened_steps_check:4696  _import_resume_check:4724  _watch_invite_check:4743  _post_smoke_check:4787  _template_roots:4860  _loop_fields:4870  _context_supplied_check:4892  _first_item:4963  _has_field:4977  _table_counts:4983  _save_button_check:4990  _probe:5047  _scratch:5065
```
...
```
_rows_per_page:33  _cfg:37  _versions:42  page_extras:61  _points:70  page:92  sold:126  listings:145  why:208  detail:260  _grade_help:293  notready:300  dashboard:310  admin_home:332  _unclassified_split:344  _rows_of:372  _check_reports:382  admin_audit:405  admin_docs:418  _int_param:442  _manwon:481  _site_buttons:486  _fallback_sites:547  _filter_chips:559  _order_menu:613  _carry:619  _order_label:629  ORDERS_LABELS_GET:633  _condition_sentence:637  _query_string:655  _page_links:668  _simple_paging:689  _paging:699  _filter_buttons:729  _model_menu:762  _pick_state:779  _option_name_buttons:845  _color_menus:906  _judge_buttons:921  _split_top:949  _fuel_options:955  _distinct_options:966  _km_options:978  _grade_options:986  _keep_query:993  _carry_pick:1018  _lease_hidden:1028  _paused_note:1034  _paired_url:1054  _paired_n:1063  _excluded_hidden:1069  _excluded_why:1076  _filter:1086  recommend:1177  fetch_screen:1246  fetch_queue:1257  fetch_put:1276  _analyze_go:1305  analyze:1313  analyze_add:1327  analyze_drop:1346  analyze_copy:1360  _path_int:1376  _recommend_old:1384  track:1417  compare:1434  market:1456  _first_target:1476  dealers:1482  watch:1502  _note_kinds:1519  _watch_notes:1526  run_view:1553  login:1565  _login_again:1607  _open_session:1623  logout:1664  _watch_queries:1681  watch_query_post:1690  _int_or_none:1720  watch_add_post:1724  _watch_note_post:1784  _watch_invite:1810  watch_update_post:1833  _now:1857  _reason_gate:1864  _said:1889  _gate:1894  _first_flag:1933  _all_hours:1938  admin_run:1966  _target_rows:2034  admin_dict:2047  admin_status:2084  admin_collect:2099  _take_chunk:2169  _verify_part:2212  _run_stamp:2252  _int_or_none:2263  admin_import:2268  admin_scoring:2340  _decide_cards:2408  _unclassified_count:2436  admin_registry:2445  admin_query:2542  admin_requests:2564  _admin_extra:2626  _config_files:2641  _config_rows:2648  admin_config:2680  _typed:2731  admin_api:2747  _site_query:2797  admin_targets:2810  admin_tools:2908  join:2927  password:2958  admin_users:2973  _account_activity:3033  reports:3039  report_download:3055
```
...
### `report/screens/fetch.py` — 211줄

```
_cfg:37  _col:41  _has_col:45  step_counts:49  queue:78  put_one:119  view_fetch:150  _last_run:182  save_last:196
```
