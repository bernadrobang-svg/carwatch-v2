...
| 파일 | 줄 | 무엇 |
|---|--:|---|
| `validate/v0_guide.py` | 8,632 | 가이드 문서 자체를 검사한다 (V0 계열). |
| `validate/v11_web.py` | 5,087 | V11 표현 계층 검증 (14장 STEP 153). |
