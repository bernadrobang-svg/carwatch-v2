...
| 파일 | 줄 | 무엇 |
|---|--:|---|
| `validate/v0_guide.py` | 7,990 | 가이드 문서 자체를 검사한다 (V0 계열). |
...
| `tools/make_unclassified.py` | 86 | 미분류(out_of_scope) 를 갈래로 묶어 마스터께 여쭐 표를 만든다 (09-05). |
