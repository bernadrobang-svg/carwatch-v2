...
| 파일 | 줄 | 무엇 |
|---|--:|---|
| `validate/v0_guide.py` | 7,596 | 가이드 문서 자체를 검사한다 (V0 계열). |
...
| `tools/browser_diff.py` | 754 | ★★★★★ 09-01 마스터 지시 — ★ **브라우저로 시안과 화면을 대조한다.** |
...
### `tools/browser_diff.py` — 754줄

```
pairs:35  look:48  main:298  hidden_text_report:464  _site_report:598  encar_collect_report:658  kb_collect_report:751
```
