...
| `report/screens/build.py` | 4,640 | 화면 데이터 생성. |
...
| `tools/browser_diff.py` | 545 | ★★★★★ 09-01 마스터 지시 — ★ **브라우저로 시안과 화면을 대조한다.** |
