...
| 파일 | 줄 | 무엇 |
|---|--:|---|
| `validate/v0_guide.py` | 8,578 | 가이드 문서 자체를 검사한다 (V0 계열). |
...
| `report/screens/tabs.py` | 1,789 | 추천 탭 2·3·4 — ★ 값을 붙인다 (지시 `r1184` A · 규격 `docs/RECOMMEND_SCREEN.md`). |
