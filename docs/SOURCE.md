...
| 파일 | 줄 | 무엇 |
|---|--:|---|
| `validate/v0_guide.py` | 8,646 | 가이드 문서 자체를 검사한다 (V0 계열). |
| `validate/v11_web.py` | 5,091 | V11 표현 계층 검증 (14장 STEP 153). |
| `report/screens/build.py` | 4,767 | 화면 데이터 생성. |
| `web/views.py` | 3,150 | 화면 어댑터 (14장 STEP 142 · 152). |
| `validate/v3_logic.py` | 2,337 | V3 로직 검증 — 판정이 작동하는가 · 변별력이 있는가. |
| `collect/runner.py` | 2,224 | 수집 실행 규칙. |
| `store/core.py` | 2,117 | CORE 저장소 (L4).  사이트 무관 공통 스키마. |
| `report/screens/tabs.py` | 2,062 | 추천 탭 2·3·4 — ★ 값을 붙인다 (지시 `r1184` A · 규격 `docs/RECOMMEND_SCREEN.md`). |
| `tests/test_spec_ui.py` | 1,494 | 규격 기준 통합 테스트 (통합테스트_시나리오_규격기준.md). |
| `tests/test_integration.py` | 1,278 | 통합 테스트 — 실제 HTTP 로 전 화면 (통합테스트_시나리오.md). |
| `tools/check_src.py` | 1,201 | CarWatch v2 — 지시서 ↔ 소스 대조 검증기. |
| `report/screens/admin.py` | 1,158 | 관리자 화면 — 표현 계층 (13장 STEP 138 · 138a). |
...
| `report/render.py` | 1,043 | 리포트 생성 (L9). |
| `validate/v2_load.py` | 960 | V2 적재 검증 — 옮겨졌는가 · 전일 대비 변동이 타당한가. |
...
| `store/dictionary.py` | 744 | 사전 저장소 (L5).  RAW 에서 생성한다. |
...
| `web/app.py` | 567 | 화면 조립 (14장 STEP 144 · 147 · 149). |
| `tools/check_spec.py` | 557 | CarWatch v2 지시서 자체 점검 — 7종 |
| `tests/test_web.py` | 527 | 14장 표현 계층 시험 — 템플릿 · 라우팅. |
| `tools/week_task.py` | 502 | ★ 이번 주 과제 — ★ **계약한 차를 이기는 GV70 만** 낸다 (기한 09-11). |
...
| `collect/worker.py` | 191 | 큐 소비기 (13장 STEP 132a · 개정 261). |
| `web/routes.py` | 189 | 라우팅 표 (14장 STEP 142). |
...
| `tools/fill_undercarriage.py` | 137 | ★ M-5 — **하체 낱말 13개**를 잡아 경고한다 (지시 r1212). |
...
| `tools/fetch_candidate_details.py` | 135 | 탭 3 후보의 상세를 ★ **서버가** 받는다 (지시 r1206 L-1 ~ L-2). |
...
| `tools/watch_gimpo.py` | 124 | ★ P-7 — 김포 `42497136` 을 ★ **한 시간마다** 지켜본다 (지시 r1216). |
...
| `tools/fill_encar_options.py` | 107 | ★ 엔카 옵션 **이름**을 사전에 채운다 (`catalog` 창구가 준다). |
| `tools/fill_gate.py` | 106 | 사이트 × 칸 채움율을 재고, 구멍이 있으면 붉게 낸다 (09-08 마스터 지시). |
| `tools/probe_kb_wall.py` | 106 | KB 봇 차단을 ★ 재는 도구 (명령서 08-25 · 마스터 「가려 받지 마라」). |
| `tools/fill_kb_frame.py` | 102 | ★ M-3 — ★ KB 상세 원문에서 ★ **골격(프레임)·외판** 을 집는다 (지시 r1232). |
| `tools/fill_kb_options.py` | 102 | ★ KB 상세 원문에서 ★ **주요옵션**을 집는다 (지시 r1232 1단계). |
...
| `store/options.py` | 90 | 옵션 목록 — ★ **두 꼴**을 한 자리에서 푼다 (지시 H · 09-10). |
...
| `store/pipeline.py` | 70 | ★ 수집 기록 — ★ 「그날 그 사이트가 뭘 했나」를 남긴다 (09-12 지시 1번). |
...
### `validate/v0_guide.py` — 8,646줄

```
_pick_db:25  _read:55  s43_2_axis_ids:62  s44_4_scope_written:100  s44_5_site_consistent:132  s45_1_one_version:165  _order_files:188  s44_1_order_exists:201  s44_2_one_order:243  s43_2b_axis_renamed:258  s43_2c_no_hda:284  s45_5_no_axis_scores:338  s45_4_table_generated:376  s45_3_spec_totals:391  s45_2_mock_numbers:465  s44_3_specs_in_order:492  s43_3_version_matches:530  _h_tags:571  s46_21_one_screen_per_file:587  s46_22_section_order:612  _targets:681  s46_23_site_query_filled:687  s46_24_facet_unconfirmed:702  s46_30_index_covers_docs:727  s46_31_spec_sites_in_config:766  s46_32_generated_fresh:787  _req_rows:829  _tokens:841  _named_docs:856  s46_36_dropped_not_alive:868  s46_40_progress_docs_changed:896  s46_41_site_status_known:927  _templates:969  s46_45_spec_not_in_list:974  s46_46_spec_forbidden_ten:994  s46_66_links_encoded:1020  s46_65_verdict_fresh:1059  _sian_files:1097  s46_67_sian_names_dont_clash:1106  s46_68_watch_is_mobile_first:1190  s46_74_rows_per_page:1244  s46_75_v4m_common:1290  s46_76_collectors_keep_raw:1330  s46_115_run_screen_still:1368  s46_125_sort_axes_really_sort:1397  s46_118_heart_has_anchor:1428  s46_121_header_rule_in_one_place:1468  s46_116_reasons_in_plain_words:1490  s46_120_registry_key_matches:1517  s46_123_toss_palette_only:1553  s46_122_shared_fragments:1605  s46_128_batch_gives_a_window:1649  s46_127_collector_has_screen_or_timer:1693  s46_124_db_opened_with_pragmas:1741  s46_126_fetch_outside_transaction:1777  s46_117_collectors_sweep_gone:1811  s46_77_kb_is_our_targets_only:1860  s46_78_encar_only_paths_are_scoped:1916  s46_87_request_site_matches_listing:1958  s46_88_encar_blocked_banner:2035  _paired_rows:2100  _grade_order_list:2140  s46_54_grade_two_step:2152  s46_55_price_gap_30:2177  s46_56_accident_split:2203  s46_90_pending_not_graded:2243  _registrable:2292  s46_94_source_url_site_matches:2306  s46_91_raw_vs_stored:2350  s46_97_raw_linked_by_source_id:2422  s46_99_login_then_watch:2490  _logged_opener:2586  _sian_seq:2625  s46_100_sian_word_order:2657  s46_102_electric_only_is_electric:2794  s46_103_sian_values_carried:2846  s46_98_sian_words_on_screen:2887  s46_95_screens_alive:3005  s46_96_site_sells_but_no_code:3061  s46_92_browser_zero_count:3140  s46_161_no_unproven_absence:3209  s46_162_promised_checks_exist:3258  s46_145_numbers_have_meaning:3288  s46_155_screen_spec_has_mockup:3317  s46_163_mockup_has_route:3350  _guide_docs:3381  s46_129_table_sum_counted:3390  s46_132_handover_says_remeasure:3422  s46_140_new_host_has_robots:3436  s46_142_site_count_matches:3455  s46_146_absence_needs_parser_check:3490  s46_154_master_wish_in_registry:3512  s46_131_paging_claim_measured:3534  s46_135_generalisation_has_sample:3556  s46_138_all_claim_needs_source:3573  s46_149_confession_is_closed:3597  s46_156_answer_touches_spec:3624  s46_130_one_tally_per_register:3650  s46_134_target_site_pair:3667  s46_141_filter_claim_measured:3693  s46_143_master_items_are_master:3710  s46_147_absence_needs_ten:3745  s46_150_column_from_ddl:3767  s46_133_check_gap_in_pending:3789  s46_136_warn_number_moves:3807  s46_137_config_key_has_reader:3829  s46_139_field_claim_counted:3858  s46_148_axis_gap_traced:3875  s46_152_dev_rounds_read:3893  s46_159_design_is_doable:3930  s46_144_empty_is_split:3949  s46_153_owner_is_judged:3966  s46_157_perf_claim_is_timed:3998  s46_158_size_claim_is_measured:4016  s46_160_ev_leak_full_mark:4034  s46_164_dev_pending_answered:4051  s46_165_fixable_not_called_unmeasurable:4085  s46_166_decision_reached_chapters:4126  s46_168_check_counts_exceptions:4156  s46_169_gone_has_reason:4195  s46_170_one_architecture:4212  s46_171_yardstick_names_screen:4230  s46_172_absence_read_as_human:4249  s46_173_endpoint_not_wordcount:4273  s46_174_no_endpoint_only_if_probed:4298  s46_175_no_lumped_axes:4325  s46_176_guide_probes_sites:4358  s46_177_catalog_not_site_locked:4386  s46_178_list_field_not_empty_axis:4411  s46_179_no_penalty_without_source:4436  s46_180_code_table_per_site:4450  s46_181_read_stored_before_probing:4477  s46_182_all_sites_before_claiming_all:4496  s46_183_master_only_after_probing:4524  s46_184_unfetched_is_not_absent:4553  s46_185_file_is_the_原本:4586  s46_186_grade_distribution_watched:4616  s46_187_cheaper_scores_higher:4630  s46_188_screen_before_claiming_missing:4657  s46_191_budget_follows_fuel_rule:4681  s46_192_pref_brands_registered:4727  s46_202_no_raw_template_tags:4752  s46_227_absent_only_declared:4765  s46_213_recommend_has_no_sold:4816  s46_203_new_site_has_target_keys:4862  s46_203_collect_writes_files_first:4894  s46_205_no_raw_response_writes:4922  s46_206_pdf_link_only:4957  _retired_s46_207_says_measured:4989  s46_207_commit_title_says_fact:5023  s46_208_market_no_negative:5061  s46_214_photo_uses_space_below:5080  s46_215_collector_respects_active:5105  s46_229_recommend_not_active_off:5131  s46_230_schema_change_counts_one_run:5159  s46_231_all_sites_in_filter:5189  s46_232_budget_curve_is_log:5216  s46_233_size_axis_never_zero:5260  s46_234_top_site_sweeps_gone:5299  s46_235_screen_hides_unsellable:5331  _recommend_rows_once:5373  s46_240_all_indexes_exist:5391  s46_237_recommend_in_budget:5432  s46_236_interior_color_axis:5464  s46_238_trim_not_double_counting:5499  s46_241_regrade_alive_on_deploy:5522  s46_242_mock_has_required_header:5617  s46_243_empty_says_why:5641  s46_244_failed_response_kept:5671  s46_245_each_screen_has_its_parts:5691  s46_246_every_screen_has_a_mock:5726  s46_253_browser_confirms_deploy:5762  s46_247_site_coverage:5832  s46_248_grade_is_realistic:5898  s46_249_budget_pairs_are_masters:5932  s46_250_mock_has_real_shape:5961  s46_251_vehicle_key_per_site:5994  s46_252_admin_write_actually_saves:6024  s46_253_part1_seen_in_browser:6056  s46_254_pair_badge_not_by_order:6099  s46_255_tester_items_listed_one_by_one:6133  v0_01_version_matches_history:6155  v0_02_retired_marks_match:6181  v0_03_points_only_in_appendix:6207  v1_22_site_given_is_not_remade:6249  _file_detail_ids:6292  _rates_in:6310  s46_261_report_matches_deploy:6334  s46_256_blocked_needs_evidence:6434  s46_257_pipeline_not_encar_only:6465  _as_check:6498  results:6512  save:6551  run:6562  s46_258_part_axis_decided:6587  s46_259_master_target_names:6619  s46_260_end_signal_not_empty_pages:6677  s46_262_dev_questions_answered:6702  s46_263_four_states_and_pending:6734  s46_264_deploy_is_up:6773  s46_265_raw_purged_after_load:6816  s46_266_detail_not_refetched:6853  s46_267_sold_swept_after_detail:6875  s46_268_order_is_one_and_current:6900  s46_269_recommend_set_and_chips:6955  s46_270_hidden_text_ruler:7006  s46_283_axis_score_filled:7038  s46_271_screen_checked_in_browser:7094  s46_272_photo_url_only_max20:7154  s46_273_encar_banner_counts_browser:7184  s46_274_default_sort_grade_price_rank:7212  s46_275_axis_score_persisted:7258  s46_276_encar_collect_no_gap:7288  s46_277_admin_query_allows_order_limit:7344  s46_278_kb_saves_blocked_raw:7369  s46_279_kb_fields_filled:7408  s46_280_all_sites_no_gap:7458  s46_281_option_names_collected:7515  s46_282_field_map_by_site:7542  s46_283_recommend_tabs_filters_page:7577  s46_284_order_is_readable:7620  s46_285_master_targets_have_detail:7686  s46_286_taste_axes_165:7718  s46_287_taste_fixed_by_target:7751  s46_288_no_asking_about_out_of_scope:7787  s46_289_vehicle_table_is_source:7838  s46_290_master_line_fetch:7867  s46_291_mockup_css_reaches_appcss:7909  s46_292_tab3_is_master_car_only:7965  s46_293_tab3_filter_in_config:7993  s46_294_tab4_spec_is_stored:8022  s46_295_undercarriage_words:8048  s46_296_no_parser_holes:8068  s46_297_round_runs_itself:8105  s46_298_week_task:8132  s46_299_root_vars_have_values:8211  s46_300_root_is_listings:8263  s46_301_tab4_filter_exists:8283  s46_302_no_stale_filter_words:8323
```

### `validate/v11_web.py` — 5,091줄

```
_web_sources:644  run:656  _late_checks:766  _templates_with_form:851  _spec_routes:872  _screen_routes:897  _routing_table_check:921  _count:962  ctx_account:969  _view_exists:975  _tpl:996  _all_templates:1001  _screen_checks:1006  _query_budget_check:1269  _import_origin_check:1348  _import_step4_check:1383  _browser_origin_check:1407  _browser_confirm_check:1425  _browser_chunk_check:1450  _status_screen_checks:1508  _status_liveness_check:1546  _menu_label_check:1595  _menu_paths:1623  _listing_rows:1648  _cli_caps:1666  _cli_only_check:1680  _stale_notice_check:1725  _trim_detail_check:1761  _option_sum_check:1784  _heart_line_check:1811  _recommend_terms_check:1832  _lease_checks:1851  _pick_filter_checks:1911  _shortfall_check:1950  _cash_limit_check:1969  _py_files:2000  _menu_no_path_check:2014  _listing_paging_checks:2032  _photo_checks:2068  _compare_shape_check:2109  _detail_shape_checks:2159  _filter_shape_checks:2237  _row_shape_checks:2307  _menu_shape_checks:2379  _sian_css_checks:2462  _cell_of:2537  _link_tip_checks:2560  _origin_link_check:2574  _origin_opens_bad:2619  _choose_check:2668  _order_filter_checks:2684  _checks_cfg:2727  _photo_size_by_screen_check:2736  _template_leak_check:2760  _em_dash_check:2786  _card_limits:2822  _cells_of:2839  _matches:2867  _grid_areas:2887  _hidden_cells:2917  _brace_block:2942  _place_cards:2956  _card_shape_checks:3078  _why_order_spec:3176  _why_order_check:3193  _width_policy:3228  _width_checks:3235  _chart_check:3334  _row_link_checks:3365  _screen_contradiction_check:3401  _chunk_check:3423  _csrf_reuse_check:3463  _origin_price_check:3507  _with_includes:3543  _v1_parity_checks:3565  _media_blocks:3655  _responsive_checks:3676  _dead_links:3764  _null_link_check:3778  _sian_visual_check:3842  _purchase_cost_checks:3906  _report_popup_check:3999  _detail_photo_check:4073  _raw_shown_checks:4124  _compare_diff_check:4211  _chunk_message_check:4275  _whole_char:4302  _chunk_boundary_check:4315  _cell_squeeze_check:4403  _static_version_check:4458  _axis_state_check:4476  _three_values_check:4519  _photo_size_check:4558  _render_metrics_checks:4584  _browser_scope_checks:4683  _import_opened_steps_check:4704  _import_resume_check:4732  _watch_invite_check:4751  _post_smoke_check:4795  _template_roots:4868  _loop_fields:4878  _context_supplied_check:4900  _first_item:4971  _has_field:4985  _table_counts:4991  _save_button_check:4998  _probe:5055  _scratch:5073
```

### `report/screens/build.py` — 4,767줄

```
load_config:48  site_badge:122  axis_heads:141  _grade_order:151  _not_ranked:164  _labels:180  viewer_state:184  _unknown_cfg:194  is_unknown:203  chip:219  _stamp:255  _bulk_axes:259  confirm_ratio:280  _bulk_changes:291  _total_points:318  _photo_note:330  photo_urls:366  photo_url:418  _deploy_is_https:457  _blocked_by_https:471  market_price:480  _days_between:497  _ceil_to:512  _bulk_market:527  _bulk_state:566  not_join_months:599  _left:622  _warranty_state:631  _axis_state:669  _sites_cfg:739  _row:752  _pen_rows:1024  _pen_axes:1035  _pen_sum:1055  _pen_words:1063  _ym_parts:1076  _age_label:1088  _km_per_year:1109  _pen_top:1129  _view_cfg:1143  _grade_rank_sql:1157  _sold_words:1212  _order_sold:1230  order_clause:1245  _site_detail_urls:1275  _source_url:1312  _view_str:1342  _lease_kinds:1347  paused_hidden:1354  _topic:1391  paired_count:1402  excluded_hidden:1425  lease_hidden:1441  _option_blind_sites:1463  _option_group_match:1480  fuel_groups:1494  _fuel_where:1505  _paused_sites:1531  _listings_where:1560  model_counts:1852  count_listings:1879  view_listings:1896  _market_gap_label:2060  _score_bars:2076  _group_caps:2107  _view_list:2128  _view_dict:2133  _soh_low:2138  _view_int:2147  _bucket:2152  _high_km:2159  _option_prices:2168  recommend_funnel:2180  _bulk_upside:2198  view_recommend:2213  recommend_reason:2248  excluded_groups:2293  view_why:2311  _compare_conclusion:2321  view_compare:2344  market_trims:2411  view_market:2433  _web_cfg:2469  _median:2483  _with_height:2488  _price_bins:2503  _group_prices:2524  _by_year:2542  _year_line:2559  _by_trim:2585  _other_targets:2603  count_dealers:2612  _dealer_targets:2618  region_of:2638  _region_short:2665  _dealer_region:2685  view_dealers:2700  view_run:2736  _rank1_of:2742  view_dashboard:2750  _bars:2887  _grade_counts:2902  _relax_sim:2920  _axis_shortfall:2941  _progress:2960  _gone_and_watch:2975  _e_reasons:3018  _today_changes:3036  _step_rows:3061  _bulk_spark:3078  view_watch:3114  _man:3214  _mmdd:3228  _chg:3241  _gap:3256  _days_since:3271  _pending_values:3296  _done_items:3305  view_notready:3331  _unmatched_rows:3372  _report_files:3417  view_reports:3449  _warranty_until:3505  _verdict_lines:3554  _manwon_str:3596  _unknown_lines:3603  _price_history:3635  _alternatives:3652  _rep_flt:3688  view_detail:3694  _quartiles_by_target:3736  market_by_target:3760  _grade_order:3797  _grade_step:3812  _miss_axes_bulk:3818  _sold_int:3866  _sold_where:3874  _days_between:3884  view_sold:3899  _sold_bins:3977  _pair_rows:4035  _lease_words:4081  view_track:4095  _accident_bulk:4223  duplicate_listings:4238  _today_counts:4290  _notready_counts:4314  axis_zero_rates:4334  _recommend_year_from:4374  _recommend_models:4386  _active_targets:4458  view_recommend_tabs:4485  _ym_dash:4699  _first_photo:4707  _site_labels:4717  _recommend_axes:4724  _axis_labels:4758
```

### `web/views.py` — 3,150줄

```
_rows_per_page:33  _cfg:37  _versions:42  page_extras:61  _points:70  page:92  sold:126  listings:145  why:208  detail:260  _grade_help:293  notready:300  dashboard:310  admin_home:332  _unclassified_split:344  _rows_of:372  _check_reports:382  admin_audit:405  admin_docs:418  _int_param:442  _manwon:481  _site_buttons:486  _fallback_sites:547  _filter_chips:559  _order_menu:613  _carry:619  _order_label:629  ORDERS_LABELS_GET:633  _condition_sentence:637  _query_string:655  _page_links:668  _simple_paging:689  _paging:699  _filter_buttons:729  _model_menu:762  _pick_state:779  _option_name_buttons:845  _color_menus:906  _judge_buttons:921  _split_top:949  _fuel_options:955  _distinct_options:966  _km_options:978  _grade_options:986  _keep_query:993  _carry_pick:1018  _lease_hidden:1028  _paused_note:1034  _paired_url:1054  _paired_n:1063  _excluded_hidden:1069  _excluded_why:1076  _filter:1086  recommend:1177  fetch_screen:1249  fetch_queue:1260  fetch_put:1287  _analyze_go:1316  analyze:1324  analyze_add:1338  analyze_drop:1357  analyze_copy:1371  _path_int:1387  _recommend_old:1395  track:1428  compare:1445  market:1467  _first_target:1487  dealers:1493  watch:1513  _note_kinds:1530  _watch_notes:1537  run_view:1564  login:1576  _login_again:1618  _open_session:1634  logout:1675  _watch_queries:1692  watch_query_post:1701  _int_or_none:1731  watch_add_post:1735  _watch_note_post:1795  _watch_invite:1821  watch_update_post:1844  _now:1868  _reason_gate:1875  _said:1900  _gate:1905  _first_flag:1944  _all_hours:1949  admin_run:1977  _target_rows:2045  admin_dict:2058  admin_status:2095  admin_pipeline:2110  admin_collect:2120  _take_chunk:2190  _verify_part:2233  _run_stamp:2273  _int_or_none:2284  admin_import:2289  admin_scoring:2361  _decide_cards:2429  _unclassified_count:2457  admin_registry:2466  admin_query:2563  admin_requests:2585  _admin_extra:2647  _config_files:2662  _config_rows:2669  admin_config:2701  _typed:2752  admin_api:2768  _site_query:2818  admin_targets:2831  admin_tools:2929  join:2948  password:2979  admin_users:2994  _account_activity:3054  reports:3060  report_download:3076
```
...
### `collect/runner.py` — 2,224줄

```
CollectGroup:67  load_targets:91  collect_groups:116  facet_axes:184  aspect_names:205  check_facet_axes:209  interpret_failure:223  _detail_calls:252  collect_check:266  FailStreak:336  Pace:370  _sleep:420  _log_request:435  _save_issues:446  _may_fetch:457  _master_line_only:478  make_executors:493  classify_in_group:1355  _query_key:1384  _group_of:1392  _fuel_of:1407  _badge_of:1413  _pages_for:1419  _dicts:1434  _option_medians:1476  _lease_types:1527  _market_medians:1541  _trim_ladders:1598  _option_base:1615  _site_grade_rules:1645  _cfg_num:1664  _dimensions:1680  _listing_config:1709  _listing_values:1743  _option_money:1762  _owned_months:1786  _option_of:1798  _market_of:1806  _group_sums:1816  _origin_lend_table:1844  _origin_keys:1874  _origin_lent:1893  make_score_executors:1913  make_validate_executor:2153  make_registry_executor:2195
```

### `store/core.py` — 2,117줄

```
resolve_listing_id:39  resolve_dealer_id:57  serialize_container:73  record_change:84  split_pii:112  flush_dealer_pii:164  _record_dropped:176  classify_invariant_change:211  _lookback:272  _source_history:286  _schema_change_min:315  _current:329  _today:335  _photo_max:352  _cap_photos:370  _drop_non_values:394  origin_dropped:406  _drop_impossible_origin:411  _note_skipped:440  upsert_core:461  mark_gone:589  mark_relisted:613  sweep_gone:640  sweep_gone_groups:684  load_snapshot:726  build_identities:844  resolve_vehicle_id:870  merge_conflict:902  upsert_vehicle:913  upsert_dealer:934  dealer_trust:961  _trust_cfg:1054  upsert_child:1071  _flag:1092  _not_join_months:1106  state_counts:1131  current_versions:1184  diagnosis_of:1214  target_counts:1227  top_target:1234  vehicle_of:1239  collect_scale:1246  our_fault:1266  catalog_coverage:1275  _walk:1319  _sample_bodies:1335  hits_of:1348  key_seen:1367  stored_hits:1382  sample_bodies:1398  observed:1420  known_leaves:1458  has_unclassified:1473  classify_unclassified:1480  _card_limit:1523  _value_chars:1528  _admin_cfg:1533  unclassified_cards:1550  _peek:1606  _short:1653  _blocking_paths:1664  _raw_rows_max:1684  used_endpoints:1694  raw_sections:1703  _flatten:1742  option_diff:1766  _option_names:1807  blocking_keys:1823  full_hits:1841  axis_paths_empty:1866  blocking_rows:1903  record_mismatch_sql:1965  record_mismatch_count:1971  relist_counts:1997  listing_models:2014  filter_options:2034  site_counts:2051  unscored_count:2064  photo_ready_sites:2081  unclassified_fields:2106
```

### `report/screens/tabs.py` — 2,062줄

```
tabs_config:33  tab_list:51  tab_template:69  tab_targets:76  _won:84  _km:91  _ym:97  _year_dot:106  _q:111  _median:121  _quantile:129  _band_where:143  _picks:155  _sorts:201  _pager:224  _sel:245  _region_kind:257  _region_key:269  view_tab2:280  _dep:459  _dep_ok:466  _opt_label:472  _warranty:482  analyze_count:492  view_analyze_list:499  _parts:540  copy_text:574  _source_link:596  _lease_where:614  _band_case:636  _grid_stats:646  _year_label:673  view_tab4:680  _split_km:781  _avg_km_of:798  _split_trim:807  _market:824  _cell_rows:850  _calc:897  _mark:930  _tab3_cfg:937  _warranty_left:942  _insurance_won:949  view_tab3:953  _tab3_head:1020  _tab3_sub:1026  _tab3_cond:1034  _tab3_card:1055  _accident_tone:1163  _verdict:1178  _thin_why:1187  _good_line:1198  _source_url_of:1212  _t4:1230  _dep_pct:1234  _fee:1251  _wear:1255  view_gv70:1269  _gv70_card:1402  _pkgs:1518  _bars:1559  _mark_best:1579  _gv70_say:1597  _accident_cells:1623  _panel_book:1675  _frame_said:1683  _under_say:1692  _t4_sift:1709  _is_lease:1720  _t4_logic:1735  _first_won:1748  _t4_gate:1759  _t4_drop:1778  _first_text:1820  _t4_rank:1827  _pct_say:1844  _ym_num:1849  _t4_pack:1855  _t4_check:1873  _opt_won_at_least:1911  _acc_line1:1958  _acc_cls1:1974  _acc_line2:1980  _acc_cls2:2016  _opt_won_gap:2022  _t4_rule:2036
```
...
### `tests/test_integration.py` — 1,278줄

```
rec:31  Client:41  text:96  links:101  start_server:105  seed_admin:149  m1:165  m2:263  m3:337  m4:666  s3:737  unit:803  gaps:838  flows:946  guide7:1049  _account_id:1182  make_users:1189  main:1207  _write_table:1256
```
...
### `report/render.py` — 1,043줄

```
_labels:32  _site_blind_axes:37  _stamp:78  _curve_points:93  source_detail_url:136  _why_cheap_of:157  _scoring:198  _record_cols:209  record_rows:218  _penalty_rows:272  _market_pos:286  _site_badge:330  _axis_why:337  _raw_sections:367  _photo_why:377  _photo_urls:398  _purchase_costs:421  _unknown_axis_cfg:449  render_listing:472  axis_mark:650  source_label:675  _option_rows:723  _fetch_views:783  _strengths:798  _weaknesses:805  _pending_best:812  _cost_rows:845  _known_issues:866  _diagnosis_view:884  render_target:895  render_run:976  render_halt:1018  _j:1036
```

### `validate/v2_load.py` — 960줄

```
DayGapReport:163  GapCause:176  run:182  _surrogate_key_checks:360  _raw_says_ok_check:452  _not_null_check:473  _chained_subscript_check:490  _Boom:538  _salvage_check:546  _table_exists:587  _exception_shape_checks:593  _schema_sync_check:659  _pii_access_check:696  gap_alerts:735  diff_prev_day:751  explain_gap:773  _pii_column_check:805  _secret_key_check:823  _parser_common_fields_check:861  _null_target_not_judged_check:912  _null_target_visible_check:937
```
...
### `store/dictionary.py` — 744줄

```
CodeEntry:32  AxisPolicy:58  policy:123  scope_key:131  seed_fixed_enums:156  _with_site_query:215  target_map:258  target_key_of:295  fuel_normalize:330  collect_group_of:353  match_target_name:358  known_model_names:375  known_model_of:392  mapped_of:397  upsert_enum:418  _handle_conflict:470  upsert_option3:491  retire_unseen:527  resolve_code:542  installed_option_names:580  normalize_enum:598  assert_no_unknown:614  bump_dict_version:657  list_pending:667  confirm_enum:675  vehicle_table:710  vehicle_says:727  vehicle_keys:741
```
...
```
menu_items:22  _tip:107  _label:112  empty_state:123  banner_of:142  _encar_blocked:203  _list_stale:242  static_version:268  build_page:308  check_post:329  redirect:351  take_flashes:371  _display_now:384  make_app:410  _Denied:543  build_context:551  _title_of:566
```
...
### `tests/test_web.py` — 527줄

```
check:21  test_routes:28  test_template:85  test_no_logic_in_template:126  test_static_escape:141  test_session_cookie:153  test_error_page:171  test_layout:198  test_filters:227  test_empty_state:250  test_menu_by_role:277  test_guard_and_csrf:298  _call:345  test_screens_render:362  test_sketch_match:458  test_account_policy:473
```

### `tools/week_task.py` — 502줄

```
book:29  _won:34  rows:40  _opt_names:81  _gone:115  _plate:130  _acc_say:159  _has_pkg:173  _has_hud:210  swap_won:223  wear_won:231  judge:239  report:362  _url:381  main:391  kb_only:453  final:478
```
...
### `parse/revolt/mapping.py` — 322줄

```
_int:37  _won:44  _ym:49  _photo_field:57  parse_list_item:76  _options:126  parse_detail:145  options_of:192  warranty_of:203  _months_since:236  record_of:247  panels_of:290
```
