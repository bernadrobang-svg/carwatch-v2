...
| `S46-36` | 폐기된 요구가 규격에 안 살아 있는가 | fatal | `validate/v0_guide.py:804` | **★ 없음** | 없음 | HYUNDAI_CERTIFIED_API.md:209 · trace/00_공통머리.md:44 · guide/01_요구사항.md:25 |
...
| `S46-75` | v4m 여덟 장 공통 규칙 | fatal | `validate/v0_guide.py:1205` | **★ 없음** | 없음 | guide/01_요구사항.md:114 · guide/03_이력.md:766 · guide/06_오판대장.md:200 |
| `S46-76` | 수집기가 원문을 남기는가 | fatal | `validate/v0_guide.py:1245` | **★ 없음** | 없음 | — |
| `S46-77` | KB 는 우리 20종만 받는가 | fatal | `validate/v0_guide.py:1273` | **★ 없음** | 없음 | — |
| `S46-78` | 엔카 전용 경로가 좁혀 있는가 | fatal | `validate/v0_guide.py:1316` | **★ 없음** | 없음 | — |
...
| `V1-22` | — | — | **★ 코드에 없다** | — | — | trace/05-score.md:47 · guide/01_요구사항.md:152 · guide/01_요구사항.md:268 |
...
| `V2-19` | 원문 유래 컬럼에 NOT NULL 없음 | run | `validate/v2_load.py:102` | **★ 없음** | 없음 | guide/01_요구사항.md:903 · guide/01_요구사항.md:912 · guide/01_요구사항.md:913 |
| `V2-20` | 파싱 실패 필드가 있는 행도 CORE 에 있음 | run | `validate/v2_load.py:64` | **★ 없음** | 없음 | guide/01_요구사항.md:916 · guide/01_요구사항.md:925 · guide/01_요구사항.md:926 |
...
| `V3-31` | 딜러 NULL 매물에 dealer_untrusted 없음 | run | `validate/v3_logic.py:358` | **★ 없음** | 없음 | guide/01_요구사항.md:942 · guide/01_요구사항.md:951 · guide/01_요구사항.md:952 |
| `V3-32` | seizing null 매물이 「저당 없음」으로 판정되지 않음 | run | `validate/v3_logic.py:125` | **★ 없음** | 없음 | guide/01_요구사항.md:942 · guide/01_요구사항.md:951 · guide/01_요구사항.md:952 |
...
| `V3-39` | 이론가와 실제 중앙값의 차가 상한 안 | run | `validate/v3_logic.py:294` | **★ 없음** | 없음 | guide/01_요구사항.md:184 · guide/01_요구사항.md:194 · guide/01_요구사항.md:195 |
...
| `V3-42` | — | — | **★ 코드에 없다** | — | — | trace/14-web.md:55 · guide/01_요구사항.md:150 · guide/01_요구사항.md:226 |
...
| `V3-47` | 축별 차종 간 결측률 편차가 상한 안 | run | `validate/v3_logic.py:289` | **★ 없음** | 없음 | trace/05-score.md:92 · trace/RULES.md:248 · guide/01_요구사항.md:240 |
| `V3-49` | — | — | **★ 코드에 없다** | — | — | ENCAR_API.md:182 · trace/05-score.md:57 · guide/01_요구사항.md:151 |
| `V3-50` | 성능부와 보험이력이 어긋난 건을 셈 | run | `validate/v3_logic.py:155` | **★ 없음** | 없음 | trace/05-score.md:93 · guide/03_이력.md:314 · guide/03_이력.md:434 |
| `V3-52` | 「싸다」에 이유가 붙어 있음 | run | `validate/v3_logic.py:341` | **★ 없음** | 없음 | trace/05-score.md:90 · trace/14-web.md:86 · guide/01_요구사항.md:294 |
...
| `V3-64` | 등급 경계가 절대 기준 | run | `validate/v3_logic.py:304` | **★ 없음** | 없음 | trace/05-score.md:26 · guide/01_요구사항.md:348 · guide/01_요구사항.md:358 |
...
| `V3-68` | 부록 F 전 24축이 구현돼 있음 | run | `validate/v3_logic.py:335` | **★ 없음** | 없음 | guide/01_요구사항.md:376 · guide/01_요구사항.md:386 · guide/01_요구사항.md:387 |
...
| `V4-11b` | 판정에 안 쓰는 미분류 경로 | run | `validate/v4_mapping.py:55` | **★ 없음** | 없음 | trace/RULES.md:243 · guide/01_요구사항.md:171 · guide/01_요구사항.md:180 |
...
| `V4-26` | 미분류가 원인별로 갈려 있음 | run | `validate/v4_mapping.py:58` | **★ 없음** | 없음 | trace/12-dict.md:62 · guide/01_요구사항.md:793 · guide/01_요구사항.md:803 |
| `V4-27` | 판정을 막는 것만 막음 | run | `validate/v4_mapping.py:64` | **★ 없음** | 없음 | trace/12-dict.md:63 · guide/01_요구사항.md:793 · guide/01_요구사항.md:803 |
...
| `V9-09` | 같은 점수에서 사이트 보증이 높은 쪽이 앞 | run | `validate/v9_multisite.py:55` | **★ 없음** | 없음 | trace/50-multisite.md:72 · trace/RULES.md:299 · guide/01_요구사항.md:321 |
...
| `V10-17` | admin 수가 0 이 되는 변경이 거부됨 | run | `validate/v10_admin.py:78` | **★ 없음** | 없음 | guide/03_이력.md:178 · guide/03_이력.md:215 · chapters/61-web.md:1986 |
...
| `V11-01` | web/ 에 SQL 문자열이 없음 | run | `validate/v11_web.py:40` | **★ 없음** | 없음 | guide/03_이력.md:161 · chapters/61-web.md:36 · chapters/61-web.md:1556 |
| `V11-02` | 기본 바인딩이 127.0.0.1 | run | `validate/v11_web.py:43` | **★ 없음** | 없음 | chapters/61-web.md:107 · chapters/61-web.md:2053 · chapters/61-web.md:2122 |
| `V11-03` | 전 Route 에 role 이 지정됨 | run | `validate/v11_web.py:47` | **★ 없음** | 없음 | chapters/61-web.md:175 · chapters/61-web.md:2123 |
| `V11-04` | 템플릿에 산술 연산이 없음 | run | `validate/v11_web.py:49` | **★ 없음** | 없음 | trace/RULES.md:163 · chapters/61-web.md:286 · chapters/61-web.md:2098 |
| `V11-05` | {{! }} 사용처가 화이트리스트에 있음 | run | `validate/v11_web.py:52` | **★ 없음** | 없음 | trace/RULES.md:163 · chapters/61-web.md:303 · chapters/61-web.md:2125 |
| `V11-06` | 정적 경로 탈출이 거부됨 | run | `validate/v11_web.py:57` | **★ 없음** | 없음 | trace/RULES.md:165 · trace/RULES.md:278 · chapters/61-web.md:408 |
| `V11-07` | 쿠키에 role 문자열이 없음 | run | `validate/v11_web.py:59` | **★ 없음** | 없음 | chapters/61-web.md:1355 · chapters/61-web.md:2127 |
| `V11-08` | 상태 변경이 GET 경로에 없음 | run | `validate/v11_web.py:61` | **★ 없음** | 없음 | chapters/61-web.md:1391 · chapters/61-web.md:2128 |
| `V11-09` | 미리보기 없이 저장이 안 됨 | run | `validate/v11_web.py:64` | **★ 없음** | 없음 | trace/RULES.md:68 · chapters/61-web.md:1419 · chapters/61-web.md:1906 |
| `V11-10` | 오류 화면에 스택 트레이스가 없음 | run | `validate/v11_web.py:66` | **★ 없음** | 없음 | chapters/61-web.md:1453 · chapters/61-web.md:2130 |
| `V11-11` | result_* 가 비었을 때 안내가 나옴 | run | `validate/v11_web.py:70` | **★ 없음** | 없음 | chapters/61-web.md:1482 · chapters/61-web.md:2131 |
| `V11-12` | 라우팅 표의 view 가 10·13장에 실재함 | run | `validate/v11_web.py:167` | **★ 없음** | 없음 | guide/03_이력.md:191 · guide/03_이력.md:272 · guide/03_이력.md:277 |
| `V11-13` | app.css 에 토큰 밖의 색값이 없음 | run | `validate/v11_web.py:93` | **★ 없음** | 없음 | guide/03_이력.md:214 · guide/03_이력.md:230 · chapters/61-web.md:451 |
| `V11-14` | 숫자 셀에 mono 가 걸려 있음 | run | `validate/v11_web.py:96` | **★ 없음** | 없음 | chapters/61-web.md:483 · chapters/61-web.md:2134 |
| `V11-15` | 화면이 빌드 산출물에 의존하지 않음 | run | `validate/v11_web.py:99` | **★ 없음** | 없음 | chapters/61-web.md:1298 · chapters/61-web.md:2135 |
| `V11-16` | /why 가 전 Component 를 냄 | run | `validate/v11_web.py:102` | **★ 없음** | 없음 | chapters/61-web.md:1504 · chapters/61-web.md:1579 · chapters/61-web.md:2136 |
| `V11-17` | /why 가 조회 상태 절을 냄 | run | `validate/v11_web.py:105` | **★ 없음** | 없음 | chapters/61-web.md:1579 · chapters/61-web.md:1633 · chapters/61-web.md:2137 |
| `V11-18` | 축 태그가 전건 필터 링크임 | run | `validate/v11_web.py:108` | **★ 없음** | 없음 | chapters/61-web.md:1677 · chapters/61-web.md:2138 |
| `V11-19` | 폴링 실패 시 화면이 안 깨짐 | run | `validate/v11_web.py:111` | **★ 없음** | 없음 | chapters/61-web.md:1697 · chapters/61-web.md:2139 |
| `V11-20` | 분모 표시가 있음 | run | `validate/v11_web.py:114` | **★ 없음** | 없음 | guide/03_이력.md:237 · chapters/61-web.md:1723 · chapters/61-web.md:2140 |
| `V11-21` | 행동 요청 파라미터가 현재 필터와 일치 | run | `validate/v11_web.py:117` | **★ 없음** | 없음 | chapters/61-web.md:1777 · chapters/61-web.md:2141 |
| `V11-22` | excluded 축이 「—/N」 으로 표시됨 | run | `validate/v11_web.py:120` | **★ 없음** | 없음 | chapters/61-web.md:1819 · chapters/61-web.md:2142 |
| `V11-23` | 비로그인 관심 POST 가 유도 화면을 냄 | run | `validate/v11_web.py:123` | **★ 없음** | 없음 | guide/03_이력.md:238 · chapters/61-web.md:1849 · chapters/61-web.md:2143 |
| `V11-24` | 메뉴 분류가 잠금 단위와 일치 | run | `validate/v11_web.py:126` | **★ 없음** | 없음 | chapters/61-web.md:1880 · chapters/61-web.md:2144 |
| `V11-25` | 사유 없이 설정이 저장되지 않음 | run | `validate/v11_web.py:129` | **★ 없음** | 없음 | chapters/61-web.md:1906 · chapters/61-web.md:2145 |
| `V11-26` | 되돌릴 수 없는 행동에 확인이 있음 | run | `validate/v11_web.py:132` | **★ 없음** | 없음 | chapters/61-web.md:1950 · chapters/61-web.md:2146 |
| `V11-27` | 가입 정책에 따라 화면이 바뀜 | run | `validate/v11_web.py:135` | **★ 없음** | 없음 | chapters/61-web.md:2007 · chapters/61-web.md:2147 |
| `V11-28` | 응답 헤더에 비 ASCII 없음 | run | `validate/v11_web.py:73` | **★ 없음** | 없음 | guide/03_이력.md:188 · chapters/61-web.md:1432 · chapters/61-web.md:2148 |
| `V11-29` | 렌더된 폼의 csrf_token 이 비어 있지 않음 | run | `validate/v11_web.py:77` | **★ 없음** | 없음 | guide/03_이력.md:189 · chapters/61-web.md:393 · chapters/61-web.md:2149 |
| `V11-30` | 시안 ↔ 템플릿 대조 통과 | run | `validate/v11_web.py:81` | **★ 없음** | 없음 | guide/03_이력.md:190 · chapters/61-web.md:348 · chapters/61-web.md:1532 |
| `V11-31` | must_change_secret=1 에서 /password 가 200 | run | `validate/v11_web.py:84` | **★ 없음** | 없음 | chapters/61-web.md:1376 · chapters/61-web.md:2151 |
| `V11-32` | known_issues 의 키가 전부 targets 에 있음 | run | `validate/v11_web.py:89` | **★ 없음** | 없음 | ref/B-config.md:377 · guide/03_이력.md:196 · chapters/61-web.md:2152 |
| `V11-33` | POST 가 저장 없이 성공 메시지를 내지 않음 | run | `validate/v11_web.py:138` | **★ 없음** | 없음 | guide/03_이력.md:220 · chapters/61-web.md:2031 · chapters/61-web.md:2153 |
| `V11-34` | 화면이 요청당 쿼리 상한을 넘지 않음 | run | `validate/v11_web.py:144` | **★ 없음** | 없음 | trace/41-view.md:22 · trace/41-view.md:70 · trace/RULES.md:164 |
| `V11-35` | 중첩 if 가 안쪽부터 닫힘 | run | `validate/v11_web.py:141` | **★ 없음** | 없음 | guide/03_이력.md:233 · chapters/61-web.md:1331 · chapters/61-web.md:2155 |
| `V11-36` | 잘못된 쿼리 파라미터가 500 을 내지 않음 | run | `validate/v11_web.py:148` | **★ 없음** | 없음 | guide/03_이력.md:235 · chapters/61-web.md:1340 · chapters/61-web.md:2156 |
| `V11-37` | POST 가 예상 밖 500 을 내지 않음 | run | `validate/v11_web.py:152` | **★ 없음** | 없음 | — |
| `V11-38` | 템플릿이 쓰는 값을 뷰가 넘김 | run | `validate/v11_web.py:157` | **★ 없음** | 없음 | — |
| `V11-39` | 저장 단추가 실제로 저장함 | run | `validate/v11_web.py:162` | **★ 없음** | 없음 | — |
| `V11-40` | 반입분의 origin 이 'import' 임 | run | `validate/v11_web.py:170` | **★ 없음** | 없음 | trace/11-store.md:36 · guide/03_이력.md:263 · guide/03_이력.md:271 |
| `V11-41` | 반입 뒤 S5~S10 이 이어서 돎 | run | `validate/v11_web.py:175` | **★ 없음** | 없음 | guide/03_이력.md:263 · chapters/61-web.md:2158 · chapters/60-admin/c-tools.md:213 |
| `V11-42` | S4 완료 행의 actual 이 'import' 임 | run | `validate/v11_web.py:626` | **★ 없음** | 없음 | guide/03_이력.md:264 · chapters/61-web.md:2159 · chapters/60-admin/c-tools.md:295 |
| `V11-43` | 브라우저 수집분의 origin 이 'browser' 임 | run | `validate/v11_web.py:180` | **★ 없음** | 없음 | trace/02-collect.md:63 · trace/60-admin.md:99 · trace/60-admin.md:100 |
| `V11-44` | 사람 확인 없이 저장되지 않음 | run | `validate/v11_web.py:185` | **★ 없음** | 없음 | trace/60-admin.md:99 · trace/60-admin.md:100 · trace/60-admin.md:102 |
| `V11-45` | CLI 로만 되는 기능이 없음 | run | `validate/v11_web.py:402` | **★ 없음** | 없음 | trace/00-standard.md:38 · trace/60-admin.md:28 · trace/60-admin.md:29 |
| `V11-46` | 반입으로 연 단계의 actual 이 'import' 임 | run | `validate/v11_web.py:621` | **★ 없음** | 없음 | trace/13-pipeline.md:39 · trace/RULES.md:223 · guide/03_이력.md:278 |
| `V11-47` | 브라우저 수집이 한 번에 max_form_bytes 를 넘기지 않음 | run | `validate/v11_web.py:607` | **★ 없음** | 없음 | trace/02-collect.md:23 · trace/02-collect.md:24 · trace/60-admin.md:107 |
| `V11-48` | 전 차종 수집에 확인 절차가 있음 | run | `validate/v11_web.py:613` | **★ 없음** | 없음 | trace/02-collect.md:26 · trace/60-admin.md:114 · trace/60-admin.md:116 |
...
| `V11-53` | 진행 판정이 큐만 보지 않음 | run | `validate/v11_web.py:190` | **★ 없음** | 없음 | trace/14-web.md:128 · trace/60-admin.md:150 · guide/01_요구사항.md:752 |
...
| `V11-57` | 사진 없는 매물이 화면을 무너뜨리지 않음 | run | `validate/v11_web.py:210` | **★ 없음** | 없음 | guide/03_이력.md:293 · chapters/61-web.md:545 · chapters/61-web.md:2173 |
| `V11-58` | 쪽을 넘겨도 조건이 남음 | run | `validate/v11_web.py:215` | **★ 없음** | 없음 | — |
| `V11-59` | 시안의 클래스가 CSS 에 있음 | run | `validate/v11_web.py:219` | **★ 없음** | 없음 | trace/00-standard.md:207 · trace/00-standard.md:208 · trace/00-standard.md:209 |
| `V11-60` | 시안 CSS 를 다시 만들지 않음 | run | `validate/v11_web.py:223` | **★ 없음** | 없음 | trace/00-standard.md:207 · trace/00-standard.md:208 · trace/00-standard.md:209 |
| `V11-61` | 이어질 수 있는 값이 링크임 | run | `validate/v11_web.py:227` | **★ 없음** | 없음 | trace/14-web.md:57 · guide/03_이력.md:295 · chapters/61-web.md:1199 |
| `V11-62` | 코드·줄임말에 title 이 있음 | run | `validate/v11_web.py:231` | **★ 없음** | 없음 | trace/14-web.md:58 · trace/14-web.md:126 · chapters/61-web.md:1200 |
| `V11-63` | 매물 화면에 원문 링크가 있음 | run | `validate/v11_web.py:235` | **★ 없음** | 없음 | trace/14-web.md:59 · guide/03_이력.md:481 · chapters/61-web.md:1216 |
| `V11-64` | 고를 수 있는 값이 목록으로 제공됨 | run | `validate/v11_web.py:239` | **★ 없음** | 없음 | trace/14-web.md:123 · chapters/61-web.md:1238 · chapters/61-web.md:2179 |
...
| `V11-68` | v1 이 낸 열이 v2 에도 있음 | run | `validate/v11_web.py:255` | **★ 없음** | 없음 | trace/14-web.md:39 · trace/14-web.md:40 · guide/01_요구사항.md:504 |
| `V11-69` | v1 이 가진 조작이 v2 에도 있음 | run | `validate/v11_web.py:260` | **★ 없음** | 없음 | trace/14-web.md:41 · guide/01_요구사항.md:504 · guide/01_요구사항.md:514 |
| `V11-70` | 좁은 폭에서 값이 사라지지 않음 | run | `validate/v11_web.py:265` | **★ 없음** | 없음 | trace/14-web.md:21 · guide/01_요구사항.md:518 · guide/01_요구사항.md:528 |
| `V11-71` | 가로 스크롤로 떠넘기지 않음 | run | `validate/v11_web.py:273` | **★ 없음** | 없음 | guide/01_요구사항.md:518 · guide/01_요구사항.md:528 · guide/01_요구사항.md:529 |
...
| `V11-75` | 링크가 유효함 | run | `validate/v11_web.py:593` | **★ 없음** | 없음 | — |
| `V11-76` | 화면 크기·시간이 상한 안 | run | `validate/v11_web.py:596` | **★ 없음** | 없음 | UI_REVIEW.md:1032 · guide/03_이력.md:759 · guide/03_이력.md:761 |
...
| `V11-80` | 사진이 최소 크기 이상 | run | `validate/v11_web.py:578` | **★ 없음** | 없음 | trace/14-web.md:27 · guide/01_요구사항.md:532 · guide/01_요구사항.md:542 |
| `V11-81` | 신차가 · 시세 · 가격 셋이 함께 나옴 | run | `validate/v11_web.py:582` | **★ 없음** | 없음 | trace/41-view.md:45 · guide/01_요구사항.md:198 · guide/01_요구사항.md:208 |
...
| `V11-93` | — | — | **★ 코드에 없다** | — | — | trace/14-web.md:47 · guide/01_요구사항.md:155 · guide/01_요구사항.md:574 |
| `V11-94` | 추천 조건이 화면에 적혀 있음 | run | `validate/v11_web.py:426` | **★ 없음** | 없음 | trace/14-web.md:74 · guide/01_요구사항.md:588 · guide/01_요구사항.md:598 |
...
| `V11-104` | 템플릿 문법이 화면에 새지 않음 | run | `validate/v11_web.py:293` | **★ 없음** | 없음 | guide/01_요구사항.md:630 · guide/01_요구사항.md:639 · guide/01_요구사항.md:640 |
...
| `V11-108` | 좁은 폭에서 한 화면에 매물 2개 이상 | run | `validate/v11_web.py:345` | **★ 없음** | 없음 | trace/14-web.md:28 · chapters/61-web/a-common.md:64 |
| `V11-109` | 카드가 부록 G 줄 수 상한을 안 넘음 | run | `validate/v11_web.py:351` | **★ 없음** | 없음 | trace/14-web.md:75 · trace/14-web.md:78 · chapters/00-standard.md:1265 |
| `V11-110` | 상세 절 순서가 부록 G 와 같음 | run | `validate/v11_web.py:340` | **★ 없음** | 없음 | trace/14-web.md:84 · chapters/61-web/d-detail.md:73 |
| `V11-111` | — | — | **★ 코드에 없다** | — | — | chapters/61-web/e-compare.md:38 |
| `V11-113` | 다섯 폭 스크린샷이 있음 | run | `validate/v11_web.py:305` | **★ 없음** | 없음 | trace/14-web.md:23 · guide/03_이력.md:356 · chapters/61-web/f-width.md:32 |
| `V11-114` | 폭마다 부록 G 의 배치임 | run | `validate/v11_web.py:311` | **★ 없음** | 없음 | trace/14-web.md:22 · chapters/61-web/f-width.md:33 |
| `V11-115` | 어느 폭에서도 글자가 세로로 안 떨어짐 | run | `validate/v11_web.py:317` | **★ 없음** | 없음 | trace/14-web.md:24 · guide/03_이력.md:356 · chapters/61-web/f-width.md:34 |
| `V11-116` | 카드 전체가 상세 링크임 | run | `validate/v11_web.py:323` | **★ 없음** | 없음 | trace/14-web.md:64 · guide/03_이력.md:357 · guide/03_이력.md:395 |
| `V11-117` | 터치로 미리보기가 뜸 | run | `validate/v11_web.py:329` | **★ 없음** | 없음 | trace/14-web.md:65 · chapters/61-web/f-width.md:60 |
| `V11-118` | — | — | **★ 코드에 없다** | — | — | guide/03_이력.md:357 · chapters/61-web/d-detail.md:120 · chapters/61-web/f-width.md:78 |
| `V11-119` | 화면마다 부록 G 가 정한 차트가 있음 | run | `validate/v11_web.py:334` | **★ 없음** | 없음 | trace/14-web.md:91 · trace/14-web.md:92 · trace/14-web.md:99 |
| `V11-120` | 매물마다 사이트별 구매 총액이 나옴 | run | `validate/v11_web.py:357` | **★ 없음** | 없음 | trace/40-report.md:67 · trace/40-report.md:71 · trace/40-report.md:72 |
| `V11-121` | 여러 사이트에 있는 차는 총액을 나란히 냄 | run | `validate/v11_web.py:363` | **★ 없음** | 없음 | trace/40-report.md:69 · trace/40-report.md:70 · trace/40-report.md:71 |
| `V11-122` | 리포트를 화면에서 읽을 수 있음 | run | `validate/v11_web.py:537` | **★ 없음** | 없음 | trace/40-report.md:74 · trace/40-report.md:75 · trace/40-report.md:76 |
...
| `V11-132` | 상세에 큰 사진과 썸네일이 있음 | run | `validate/v11_web.py:531` | **★ 없음** | 없음 | guide/03_이력.md:394 · chapters/61-web/d-detail.md:106 |
| `V11-133` | — | — | **★ 코드에 없다** | — | — | guide/03_이력.md:396 · chapters/61-web/d-detail.md:159 |
| `V11-134` | 상세에 「받은 원문」 절이 있음 | run | `validate/v11_web.py:368` | **★ 없음** | 없음 | guide/03_이력.md:397 · guide/03_이력.md:427 · chapters/00-standard.md:1962 |
| `V11-135` | 파서가 없어도 원문을 그대로 냄 | run | `validate/v11_web.py:374` | **★ 없음** | 없음 | chapters/61-web/d-detail.md:193 |
| `V11-136` | 받은 것 중 묻혀 있는 것이 없음 | run | `validate/v11_web.py:379` | **★ 없음** | 없음 | guide/03_이력.md:397 · chapters/61-web/d-detail.md:211 |
...
| `V11-147` | 조각 절단면이 글자 경계임 | run | `validate/v11_web.py:390` | **★ 없음** | 없음 | guide/03_이력.md:409 |
| `V11-148` | 조각마다 길이·해시를 대조함 | run | `validate/v11_web.py:397` | **★ 없음** | 없음 | guide/03_이력.md:409 |
| `V11-149` | 조각 실패 문구에 서버 message 가 있음 | run | `validate/v11_web.py:525` | **★ 없음** | 없음 | guide/03_이력.md:414 |
| `V11-150` | 메뉴 라벨이 경로가 아님 | run | `validate/v11_web.py:520` | **★ 없음** | 없음 | guide/03_이력.md:416 · chapters/61-web.md:264 |
| `V11-151` | 부족액 문구가 화면에 없음 | run | `validate/v11_web.py:509` | **★ 없음** | 없음 | guide/03_이력.md:420 · chapters/41-view.md:454 |
| `V11-152` | cash_limit 을 한 곳에서만 읽음 | run | `validate/v11_web.py:514` | **★ 없음** | 없음 | guide/03_이력.md:420 · chapters/41-view.md:455 |
| `V11-153` | 기본 목록에 리스·렌트가 없음 | run | `validate/v11_web.py:431` | **★ 없음** | 없음 | guide/03_이력.md:440 |
| `V11-154` | 뺀 건수가 화면에 있음 | run | `validate/v11_web.py:436` | **★ 없음** | 없음 | — |
| `V11-155` | 차종·가격대 필터가 있음 | run | `validate/v11_web.py:440` | **★ 없음** | 없음 | — |
| `V11-156` | 필터 조건이 그대로 넘어감 | run | `validate/v11_web.py:504` | **★ 없음** | 없음 | guide/03_이력.md:440 |
| `V11-157` | 상단 메뉴가 다섯을 넘지 않음 | run | `validate/v11_web.py:492` | **★ 없음** | 없음 | guide/03_이력.md:447 · guide/03_이력.md:458 · guide/03_이력.md:463 |
| `V11-158` | 내린 화면이 열리고 ★ 들어가는 문이 있음 | run | `validate/v11_web.py:498` | **★ 없음** | 없음 | UI_REVIEW.md:562 · UI_REVIEW.md:855 · guide/03_이력.md:565 |
| `V11-159` | 상세 11개 절이 규격 순서로 있음 | run | `validate/v11_web.py:451` | **★ 없음** | 없음 | CROSS_SITE_COMPARE.md:161 · UI_REVIEW.md:88 · UI_REVIEW.md:328 |
| `V11-160` | 1 절에 「왜 그 등급인가」 문장이 있음 | run | `validate/v11_web.py:456` | **★ 없음** | 없음 | guide/03_이력.md:511 · chapters/41-view.md:98 |
| `V11-161` | 3 절에 총 구매비용 표가 있음 | run | `validate/v11_web.py:462` | **★ 없음** | 없음 | chapters/41-view.md:99 |
| `V11-162` | 목록 한 행의 칸이 8을 넘지 않음 | run | `validate/v11_web.py:480` | **★ 없음** | 없음 | chapters/41-view.md:390 |
| `V11-163` | 네 묶음 막대가 목록에 있음 | run | `validate/v11_web.py:486` | **★ 없음** | 없음 | chapters/41-view.md:391 |
| `V11-164` | 점수 필터가 SQL 로 걸림 | run | `validate/v11_web.py:468` | **★ 없음** | 없음 | chapters/41-view.md:424 |
| `V11-165` | 고른 조건이 문장으로 나옴 | run | `validate/v11_web.py:474` | **★ 없음** | 없음 | KCAR_API.md:313 · guide/03_이력.md:447 · guide/03_이력.md:466 |
| `V11-166` | 비교에 막대 넷·총 구매비용·결론이 있음 | run | `validate/v11_web.py:445` | **★ 없음** | 없음 | guide/03_이력.md:449 · chapters/41-view.md:495 |
...
- `V1-22` — trace/05-score.md:47 · guide/01_요구사항.md:152 · guide/01_요구사항.md:268
...
- `V11-93` — trace/14-web.md:47 · guide/01_요구사항.md:155 · guide/01_요구사항.md:574
...
- `V3-42` — trace/14-web.md:55 · guide/01_요구사항.md:150 · guide/01_요구사항.md:226
- `V3-44` — guide/02_결함대장.md:85 · guide/02_결함대장.md:95 · guide/03_이력.md:310
- `V3-49` — ENCAR_API.md:182 · trace/05-score.md:57 · guide/01_요구사항.md:151
