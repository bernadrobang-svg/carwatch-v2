...
| `S46-299` | :root 변수가 값을 가지는가 | fatal | `validate/v0_guide.py:8203` | **★ 없음** | 없음 | guide/03_이력.md:1368 · guide/03_이력.md:1369 |
| `S46-300` | 첫 화면이 목록인가 | fatal | `validate/v0_guide.py:8235` | **★ 없음** | 없음 | guide/03_이력.md:1370 |
