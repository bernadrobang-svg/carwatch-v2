...
| `V1-22` | — | — | **★ 코드에 없다** | — | — | trace/05-score.md:47 · guide/01_요구사항.md:150 · guide/01_요구사항.md:266 |
...
| `V2-19` | 원문 유래 컬럼에 NOT NULL 없음 | run | `validate/v2_load.py:102` | **★ 없음** | 없음 | guide/01_요구사항.md:901 · guide/01_요구사항.md:910 · guide/01_요구사항.md:911 |
| `V2-20` | 파싱 실패 필드가 있는 행도 CORE 에 있음 | run | `validate/v2_load.py:64` | **★ 없음** | 없음 | guide/01_요구사항.md:914 · guide/01_요구사항.md:923 · guide/01_요구사항.md:924 |
...
| `V3-31` | 딜러 NULL 매물에 dealer_untrusted 없음 | run | `validate/v3_logic.py:358` | **★ 없음** | 없음 | guide/01_요구사항.md:940 · guide/01_요구사항.md:949 · guide/01_요구사항.md:950 |
| `V3-32` | seizing null 매물이 「저당 없음」으로 판정되지 않음 | run | `validate/v3_logic.py:125` | **★ 없음** | 없음 | guide/01_요구사항.md:940 · guide/01_요구사항.md:949 · guide/01_요구사항.md:950 |
...
| `V3-39` | 이론가와 실제 중앙값의 차가 상한 안 | run | `validate/v3_logic.py:294` | **★ 없음** | 없음 | guide/01_요구사항.md:182 · guide/01_요구사항.md:192 · guide/01_요구사항.md:193 |
...
| `V3-42` | — | — | **★ 코드에 없다** | — | — | trace/14-web.md:55 · guide/01_요구사항.md:148 · guide/01_요구사항.md:224 |
...
| `V3-47` | 축별 차종 간 결측률 편차가 상한 안 | run | `validate/v3_logic.py:289` | **★ 없음** | 없음 | trace/05-score.md:92 · trace/RULES.md:248 · guide/01_요구사항.md:238 |
| `V3-49` | — | — | **★ 코드에 없다** | — | — | ENCAR_API.md:182 · trace/05-score.md:57 · guide/01_요구사항.md:149 |
| `V3-50` | 성능부와 보험이력이 어긋난 건을 셈 | run | `validate/v3_logic.py:155` | **★ 없음** | 없음 | trace/05-score.md:93 · guide/03_이력.md:314 · guide/03_이력.md:434 |
| `V3-52` | 「싸다」에 이유가 붙어 있음 | run | `validate/v3_logic.py:341` | **★ 없음** | 없음 | trace/05-score.md:90 · trace/14-web.md:86 · guide/01_요구사항.md:292 |
...
| `V3-64` | 등급 경계가 절대 기준 | run | `validate/v3_logic.py:304` | **★ 없음** | 없음 | trace/05-score.md:26 · guide/01_요구사항.md:346 · guide/01_요구사항.md:356 |
...
| `V3-67` | — | — | **★ 코드에 없다** | — | — | guide/01_요구사항.md:151 · guide/01_요구사항.md:360 · guide/01_요구사항.md:370 |
| `V3-68` | 부록 F 전 24축이 구현돼 있음 | run | `validate/v3_logic.py:335` | **★ 없음** | 없음 | guide/01_요구사항.md:374 · guide/01_요구사항.md:384 · guide/01_요구사항.md:385 |
...
| `V4-11b` | 판정에 안 쓰는 미분류 경로 | run | `validate/v4_mapping.py:55` | **★ 없음** | 없음 | trace/RULES.md:243 · guide/01_요구사항.md:169 · guide/01_요구사항.md:178 |
...
| `V4-26` | 미분류가 원인별로 갈려 있음 | run | `validate/v4_mapping.py:58` | **★ 없음** | 없음 | trace/12-dict.md:62 · guide/01_요구사항.md:791 · guide/01_요구사항.md:801 |
| `V4-27` | 판정을 막는 것만 막음 | run | `validate/v4_mapping.py:64` | **★ 없음** | 없음 | trace/12-dict.md:63 · guide/01_요구사항.md:791 · guide/01_요구사항.md:801 |
...
| `V9-09` | 같은 점수에서 사이트 보증이 높은 쪽이 앞 | run | `validate/v9_multisite.py:55` | **★ 없음** | 없음 | trace/50-multisite.md:72 · trace/RULES.md:299 · guide/01_요구사항.md:319 |
...
| `V11-53` | 진행 판정이 큐만 보지 않음 | run | `validate/v11_web.py:190` | **★ 없음** | 없음 | trace/14-web.md:128 · trace/60-admin.md:150 · guide/01_요구사항.md:750 |
...
| `V11-68` | v1 이 낸 열이 v2 에도 있음 | run | `validate/v11_web.py:255` | **★ 없음** | 없음 | trace/14-web.md:39 · trace/14-web.md:40 · guide/01_요구사항.md:502 |
| `V11-69` | v1 이 가진 조작이 v2 에도 있음 | run | `validate/v11_web.py:260` | **★ 없음** | 없음 | trace/14-web.md:41 · guide/01_요구사항.md:502 · guide/01_요구사항.md:512 |
| `V11-70` | 좁은 폭에서 값이 사라지지 않음 | run | `validate/v11_web.py:265` | **★ 없음** | 없음 | trace/14-web.md:21 · guide/01_요구사항.md:516 · guide/01_요구사항.md:526 |
| `V11-71` | 가로 스크롤로 떠넘기지 않음 | run | `validate/v11_web.py:273` | **★ 없음** | 없음 | guide/01_요구사항.md:516 · guide/01_요구사항.md:526 · guide/01_요구사항.md:527 |
...
| `V11-80` | 사진이 최소 크기 이상 | run | `validate/v11_web.py:578` | **★ 없음** | 없음 | trace/14-web.md:27 · guide/01_요구사항.md:530 · guide/01_요구사항.md:540 |
| `V11-81` | 신차가 · 시세 · 가격 셋이 함께 나옴 | run | `validate/v11_web.py:582` | **★ 없음** | 없음 | trace/41-view.md:45 · guide/01_요구사항.md:196 · guide/01_요구사항.md:206 |
...
| `V11-87` | — | — | **★ 코드에 없다** | — | — | guide/01_요구사항.md:147 · guide/01_요구사항.md:210 · guide/01_요구사항.md:220 |
| `V11-88` | — | — | **★ 코드에 없다** | — | — | guide/01_요구사항.md:152 · guide/01_요구사항.md:558 · guide/01_요구사항.md:568 |
...
| `V11-93` | — | — | **★ 코드에 없다** | — | — | trace/14-web.md:47 · guide/01_요구사항.md:153 · guide/01_요구사항.md:572 |
| `V11-94` | 추천 조건이 화면에 적혀 있음 | run | `validate/v11_web.py:426` | **★ 없음** | 없음 | trace/14-web.md:74 · guide/01_요구사항.md:586 · guide/01_요구사항.md:596 |
...
| `V11-104` | 템플릿 문법이 화면에 새지 않음 | run | `validate/v11_web.py:293` | **★ 없음** | 없음 | guide/01_요구사항.md:628 · guide/01_요구사항.md:637 · guide/01_요구사항.md:638 |
...
- `V1-22` — trace/05-score.md:47 · guide/01_요구사항.md:150 · guide/01_요구사항.md:266
...
- `V11-87` — guide/01_요구사항.md:147 · guide/01_요구사항.md:210 · guide/01_요구사항.md:220
- `V11-88` — guide/01_요구사항.md:152 · guide/01_요구사항.md:558 · guide/01_요구사항.md:568
- `V11-93` — trace/14-web.md:47 · guide/01_요구사항.md:153 · guide/01_요구사항.md:572
...
- `V3-42` — trace/14-web.md:55 · guide/01_요구사항.md:148 · guide/01_요구사항.md:224
- `V3-44` — guide/02_결함대장.md:85 · guide/02_결함대장.md:95 · guide/03_이력.md:310
- `V3-49` — ENCAR_API.md:182 · trace/05-score.md:57 · guide/01_요구사항.md:149
- `V3-67` — guide/01_요구사항.md:151 · guide/01_요구사항.md:360 · guide/01_요구사항.md:370
