...
|---|---|---|---|---|---|---|
| `S1` | 디렉터리 (STEP 15) | fatal | `tools/check_src.py:216` | **★ 없음** | 없음 | trace/13-pipeline.md:38 · trace/RULES.md:223 · ref/E-attach.md:62 |
| `S2` | 구조체 정의 | fatal | `tools/check_src.py:238` | **★ 없음** | 없음 | trace/13-pipeline.md:38 · trace/13-pipeline.md:41 · trace/RULES.md:223 |
| `S3` | 함수 정의 | fatal | `tools/check_src.py:259` | **★ 없음** | 없음 | CROSS_SITE_COMPARE.md:11 · HEYDEALER_API.md:203 · MULTISITE_MAPPING.md:335 |
...
| `S7` | 매직 넘버 (V4-13) | fatal | `tools/check_src.py:448` | **★ 없음** | 없음 | ref/E-attach.md:67 · guide/03_이력.md:734 · guide/03_이력.md:1254 |
...
| `S11` | 분석 계층 순수성 (STEP 2) | fatal | `tools/check_src.py:496` | **★ 없음** | 없음 | UI_REVIEW.md:1273 · ref/E-attach.md:71 · guide/01_시작.md:71 |
| `S12` | 축 파일 STEP 주석 | fatal | `tools/check_src.py:511` | **★ 없음** | 없음 | CROSS_SITE_COMPARE.md:278 · ref/E-attach.md:72 · guide/01_시작.md:235 |
| `S13` | 본문 config 예시 대조 | fatal | `tools/check_src.py:578` | **★ 없음** | 없음 | ref/B-config.md:298 · ref/D-update.md:31 · ref/E-attach.md:73 |
| `S14` | 상수 등록·성격 (V4-17) | fatal | `tools/check_src.py:627` | **★ 없음** | 없음 | ref/E-attach.md:74 · chapters/20-verify/c-v3v4.md:208 · chapters/20-verify/c-v3v4.md:214 |
| `S14-1` | 화면에 배점을 박지 않음 (V4-17) | fatal | `tools/check_src.py:660` | **★ 없음** | 없음 | — |
| `S15` | 계층 의존 (STEP 15) | fatal | `tools/check_src.py:538` | **★ 없음** | 없음 | ref/E-attach.md:75 · guide/03_이력.md:120 · chapters/10-collect/00-intro.md:226 |
| `S16` | 검증 코드 대조 | fatal | `tools/check_src.py:712` | **★ 없음** | 없음 | ref/E-attach.md:76 · ref/E-attach.md:217 · guide/03_이력.md:157 |
| `S23` | 실행 환경 (Python 3.11+) | fatal | `tools/check_src.py:719` | **★ 없음** | 없음 | trace/00-standard.md:21 · trace/00-standard.md:22 · trace/RULES.md:81 |
| `S24` | 시험 격리 (운영 DB 미사용) | fatal | `tools/check_src.py:738` | **★ 없음** | 없음 | trace/00-standard.md:29 · trace/00-standard.md:30 · trace/00-standard.md:31 |
...
| `S34-2` | 표의 소스·검사가 실재 | fatal | `tools/check_src.py:982` | **★ 없음** | 없음 | trace/00-standard.md:231 · trace/00-standard.md:232 · trace/00-standard.md:234 |
| `S34-3` | 추적표 빈 칸을 센다 | fatal | `tools/check_src.py:933` | **★ 없음** | 없음 | guide/03_이력.md:427 · chapters/00-standard.md:1540 · chapters/00-standard.md:1830 |
| `S34-4` | 규격이 표에 있음 | fatal | `tools/check_src.py:1072` | **★ 없음** | 없음 | guide/03_이력.md:368 · guide/03_이력.md:423 · chapters/00-standard.md:1541 |
| `S35-1` | 자기 칸만 고침 | fatal | `tools/check_src.py:1157` | **★ 없음** | 없음 | trace/00-standard.md:235 · trace/00-standard.md:236 · trace/00-standard.md:237 |
| `S36-1` | 「정식 서비스 착수」 목록이 있음 | fatal | `tools/check_src.py:1174` | **★ 없음** | 없음 | trace/00-standard.md:250 · trace/00-standard.md:251 · trace/00-standard.md:252 |
| `S37-1` | 파는 쪽 개념이 안 남아 있음 | fatal | `tools/check_src.py:1192` | **★ 없음** | 없음 | trace/00-standard.md:260 · trace/RULES.md:123 · trace/RULES.md:124 |
| `S38-4` | 상태가 세 칸에서 유도한 값과 같음 | fatal | `tools/check_src.py:1017` | **★ 없음** | 없음 | guide/03_이력.md:425 · chapters/00-standard.md:1817 |
| `S38-5` | 「!」·「?」 가 도구 실행 뒤에도 남음 | fatal | `tools/check_src.py:1019` | **★ 없음** | 없음 | guide/03_이력.md:425 · chapters/00-standard.md:1818 |
| `S39-1` | R 마다 층이 적혀 있음 | fatal | `tools/check_src.py:1059` | **★ 없음** | 없음 | guide/03_이력.md:389 · guide/03_이력.md:417 · chapters/00-standard.md:2107 |
| `S39-2` | 화면 층이 아닌데 「화면 없음」이 아님 | fatal | `tools/check_src.py:1061` | **★ 없음** | 없음 | guide/03_이력.md:389 · chapters/00-standard.md:2108 |
| `S43-2` | 규격의 축 id 가 config 에 있는가 | fatal | `validate/v0_guide.py:62` | **★ 없음** | 없음 | guide/03_이력.md:510 · guide/03_이력.md:512 · guide/03_이력.md:517 |
| `S43-2b` | config 축 id 가 규격 이름인가 | fatal | `validate/v0_guide.py:258` | **★ 없음** | 없음 | guide/00_버전.md:116 · guide/03_이력.md:519 · guide/03_이력.md:522 |
| `S43-2c` | HDA 가 저장소에 없는가 | fatal | `validate/v0_guide.py:284` | **★ 없음** | 없음 | guide/00_버전.md:115 · guide/01_요구사항.md:50 · guide/03_이력.md:520 |
| `S43-3` | 버전이 이력 마지막과 같은가 | fatal | `validate/v0_guide.py:530` | **★ 없음** | 없음 | guide/03_이력.md:510 · guide/03_이력.md:518 · guide/03_이력.md:553 |
| `S44-1` | 가리키는 명령서가 실제로 있는가 | fatal | `validate/v0_guide.py:201` | **★ 없음** | 없음 | guide/00_버전.md:118 · guide/03_이력.md:456 · guide/03_이력.md:463 |
| `S44-2` | 명령서가 하나뿐인가 | fatal | `validate/v0_guide.py:243` | **★ 없음** | 없음 | guide/03_이력.md:456 · guide/03_이력.md:463 · guide/03_이력.md:510 |
| `S44-3` | 규격을 명령서가 가리키는가 | fatal | `validate/v0_guide.py:492` | **★ 없음** | 없음 | guide/03_이력.md:555 · guide/03_이력.md:556 · guide/03_이력.md:566 |
| `S44-4` | 명령서에 수집 범위가 있는가 | fatal | `validate/v0_guide.py:100` | **★ 없음** | 없음 | guide/03_이력.md:557 · guide/03_이력.md:558 · guide/03_이력.md:891 |
| `S44-5` | 명령서이 사이트를 한 가지로 적는가 | fatal | `validate/v0_guide.py:132` | **★ 없음** | 없음 | KCAR_API.md:436 · guide/03_이력.md:557 · guide/03_이력.md:803 |
| `S45-1` | f-table 절 제목과 표가 같은가 | fatal | `validate/v0_guide.py:165` | **★ 없음** | 없음 | guide/03_이력.md:460 · guide/03_이력.md:501 · guide/03_이력.md:510 |
| `S45-2` | 시안에 옛 배점·분모가 없는가 | fatal | `validate/v0_guide.py:465` | **★ 없음** | 없음 | guide/00_버전.md:113 · guide/00_버전.md:114 · guide/03_이력.md:521 |
| `S45-3` | 규격에 옛 총점이 없는가 | fatal | `validate/v0_guide.py:391` | **★ 없음** | 없음 | guide/00_버전.md:110 · guide/00_버전.md:112 · guide/03_이력.md:523 |
| `S45-4` | 배점표가 config 에서 생성한 것과 같은가 | fatal | `validate/v0_guide.py:376` | **★ 없음** | 없음 | guide/00_버전.md:108 · guide/03_이력.md:527 |
| `S45-5` | 규격이 배점을 손으로 적지 않는가 | fatal | `validate/v0_guide.py:338` | **★ 없음** | 없음 | guide/00_버전.md:107 · guide/03_이력.md:528 · guide/03_이력.md:553 |
| `S46-21` | 시안 한 파일에 화면이 하나인가 | fatal | `validate/v0_guide.py:587` | **★ 없음** | 없음 | UI_REVIEW.md:421 · guide/01_요구사항.md:61 · guide/03_이력.md:644 |
| `S46-22` | 시안 절 차례가 화면과 같은가 | fatal | `validate/v0_guide.py:612` | **★ 없음** | 없음 | UI_REVIEW.md:423 · UI_REVIEW.md:731 · UI_REVIEW.md:836 |
| `S46-23` | 빈 site_query 가 없는가 | fatal | `validate/v0_guide.py:687` | **★ 없음** | 없음 | guide/01_요구사항.md:58 · guide/01_요구사항.md:88 · guide/01_요구사항.md:119 |
| `S46-24` | facet 미확인 차종이 없는가 | warn | `validate/v0_guide.py:702` | **★ 없음** | 없음 | guide/03_이력.md:647 · guide/03_이력.md:669 · guide/03_이력.md:678 |
| `S46-30` | INDEX 가 docs 를 다 가리키는가 | warn | `validate/v0_guide.py:727` | **★ 없음** | 없음 | guide/03_이력.md:661 |
| `S46-31` | 규격이 있는 사이트가 config 에 있는가 | fatal | `validate/v0_guide.py:766` | **★ 없음** | 없음 | BMW_BPS_API.md:7 · BOBAEDREAM_API.md:7 · ENCAR_API.md:7 |
| `S46-32` | 생성물이 최신인가 | fatal | `validate/v0_guide.py:787` | **★ 없음** | 없음 | ROADMAP_20260830.md:66 · guide/01_요구사항.md:65 · guide/03_이력.md:672 |
| `S46-36` | 폐기된 요구가 규격에 안 살아 있는가 | fatal | `validate/v0_guide.py:868` | **★ 없음** | 없음 | HYUNDAI_CERTIFIED_API.md:209 · trace/00_공통머리.md:44 · guide/01_요구사항.md:25 |
| `S46-40` | 「진행」인 요구의 문서가 바뀌었는가 | warn | `validate/v0_guide.py:896` | **★ 없음** | 없음 | guide/01_요구사항.md:69 · guide/03_이력.md:682 · guide/06_오판대장.md:182 |
| `S46-41` | 사이트 status 가 규격의 셋 안인가 | fatal | `validate/v0_guide.py:927` | **★ 없음** | 없음 | guide/06_오판대장.md:183 |
| `S46-45` | 제원이 목록에 안 나오는가 | fatal | `validate/v0_guide.py:974` | **★ 없음** | 없음 | UI_REVIEW.md:517 · guide/01_요구사항.md:77 · guide/03_이력.md:691 |
| `S46-46` | 금지 제원 열 항목이 화면에 없는가 | fatal | `validate/v0_guide.py:994` | **★ 없음** | 없음 | UI_REVIEW.md:518 · guide/01_요구사항.md:77 · guide/03_이력.md:691 |
| `S46-54` | 짝 중 등급이 두 칸 갈린 것 | warn | `validate/v0_guide.py:2142` | **★ 없음** | 없음 | CROSS_SITE_COMPARE.md:7 · CROSS_SITE_COMPARE.md:288 · CROSS_SITE_COMPARE.md:456 |
| `S46-55` | 짝 중 값이 30% 갈린 것 | warn | `validate/v0_guide.py:2167` | **★ 없음** | 없음 | CROSS_SITE_COMPARE.md:7 · CROSS_SITE_COMPARE.md:289 |
| `S46-56` | 짝 중 사고 판정이 갈린 것 | warn | `validate/v0_guide.py:2193` | **★ 없음** | 없음 | CROSS_SITE_COMPARE.md:7 · CROSS_SITE_COMPARE.md:290 |
| `S46-65` | 판본이 하루 넘게 오래되지 않았는가 | fatal | `validate/v0_guide.py:1059` | **★ 없음** | 없음 | guide/01_요구사항.md:107 · guide/03_이력.md:745 · guide/03_이력.md:746 |
| `S46-66` | 화면이 낸 링크가 인코딩돼 있는가 | fatal | `validate/v0_guide.py:1020` | **★ 없음** | 없음 | UI_REVIEW.md:896 · guide/01_요구사항.md:108 · guide/03_이력.md:747 |
| `S46-67` | 시안 이름이 app.css 와 안 겹치는가 | fatal | `validate/v0_guide.py:1106` | **★ 없음** | 없음 | UI_REVIEW.md:1308 · UI_REVIEW.md:1606 · guide/03_이력.md:749 |
| `S46-68` | 관심이 모바일 기준 카드인가 | fatal | `validate/v0_guide.py:1190` | **★ 없음** | 없음 | UI_REVIEW.md:999 · guide/01_요구사항.md:111 · guide/03_이력.md:754 |
| `S46-74` | 한 쪽 장 수가 규격과 같은가 | fatal | `validate/v0_guide.py:1244` | **★ 없음** | 없음 | UI_REVIEW.md:1033 · guide/01_요구사항.md:114 · guide/03_이력.md:761 |
| `S46-75` | v4m 여덟 장 공통 규칙 | fatal | `validate/v0_guide.py:1290` | **★ 없음** | 없음 | guide/01_요구사항.md:116 · guide/03_이력.md:766 · guide/06_오판대장.md:219 |
| `S46-76` | 수집기가 원문을 남기는가 | fatal | `validate/v0_guide.py:1330` | **★ 없음** | 없음 | guide/01_요구사항.md:118 · guide/03_이력.md:770 · guide/03_이력.md:771 |
| `S46-77` | KB 는 우리 20종만 받는가 | fatal | `validate/v0_guide.py:1850` | **★ 없음** | 없음 | guide/03_이력.md:1187 |
| `S46-78` | 엔카 전용 경로가 좁혀 있는가 | fatal | `validate/v0_guide.py:1906` | **★ 없음** | 없음 | guide/03_이력.md:771 |
| `S46-87` | 부른 주소가 그 매물의 사이트인가 | fatal | `validate/v0_guide.py:1948` | **★ 없음** | 없음 | guide/03_이력.md:772 · guide/03_이력.md:773 · guide/03_이력.md:855 |
| `S46-88` | 엔카가 막히면 화면이 까닭을 말하는가 | fatal | `validate/v0_guide.py:2025` | **★ 없음** | 없음 | guide/03_이력.md:773 |
| `S46-90` | 근거가 절반도 없는데 등급을 매기지 않는가 | fatal | `validate/v0_guide.py:2233` | **★ 없음** | 없음 | UI_REVIEW.md:1083 · guide/03_이력.md:780 |
| `S46-91` | 받은 원문이 저장까지 갔는가 | fatal | `validate/v0_guide.py:2340` | **★ 없음** | 없음 | guide/03_이력.md:781 · guide/06_오판대장.md:226 |
| `S46-92` | 브라우저 수집이 0건을 받았는가 | warn | `validate/v0_guide.py:3130` | **★ 없음** | 없음 | guide/03_이력.md:783 · guide/03_이력.md:784 |
| `S46-94` | 원문 문이 그 매물의 사이트로 가는가 | fatal | `validate/v0_guide.py:2296` | **★ 없음** | 없음 | guide/03_이력.md:787 · guide/06_오판대장.md:229 |
| `S46-95` | 배포된 화면이 다 열리는가 | fatal | `validate/v0_guide.py:2995` | **★ 없음** | 없음 | guide/03_이력.md:788 · guide/03_이력.md:789 · guide/03_이력.md:792 |
| `S46-96` | 사이트가 파는 차종인데 코드가 없는가 | warn | `validate/v0_guide.py:3051` | **★ 없음** | 없음 | ROADMAP_20260830.md:95 · guide/00_인수인계.md:154 · guide/03_이력.md:791 |
| `S46-97` | 원문이 source_id 로 매물에 이어지는가 | fatal | `validate/v0_guide.py:2412` | **★ 없음** | 없음 | guide/00_인수인계.md:134 · guide/03_이력.md:792 · guide/03_이력.md:879 |
| `S46-98` | 시안의 낱말이 화면에 있는가 | fatal | `validate/v0_guide.py:2877` | **★ 없음** | 없음 | RECOMMEND_SCREEN.md:358 · UI_REVIEW.md:1881 · guide/03_이력.md:793 |
| `S46-99` | 로그인하면 관심·관리가 열리는가 | fatal | `validate/v0_guide.py:2480` | **★ 없음** | 없음 | guide/03_이력.md:794 · guide/03_이력.md:879 · guide/03_이력.md:1009 |
| `S46-100` | 시안의 낱말 차례가 화면과 같은가 | fatal | `validate/v0_guide.py:2647` | **★ 없음** | 없음 | RECOMMEND_SCREEN.md:358 · guide/03_이력.md:804 · guide/03_이력.md:879 |
| `S46-102` | 「전기만」에 전기 아닌 것이 없는가 | fatal | `validate/v0_guide.py:2784` | **★ 없음** | 없음 | UI_REVIEW.md:1134 · guide/03_이력.md:814 · guide/06_오판대장.md:240 |
| `S46-103` | 시안의 크기·자리 값을 담았는가 | fatal | `validate/v0_guide.py:2836` | **★ 없음** | 없음 | guide/03_이력.md:819 · guide/03_이력.md:847 · guide/06_오판대장.md:242 |
...
| `S46-117` | 목록을 받는 수집기가 팔린 차를 거르는가 | fatal | `validate/v0_guide.py:1801` | **★ 없음** | 없음 | KCAR_API.md:151 · guide/03_이력.md:851 · guide/03_이력.md:855 |
| `S46-118` | 하트가 자기 카드 안에 앉는가 | fatal | `validate/v0_guide.py:1428` | **★ 없음** | 없음 | UI_REVIEW.md:1430 · guide/03_이력.md:852 |
| `S46-120` | 등록부의 감사 열쇠가 목록 열쇠와 같은가 | fatal | `validate/v0_guide.py:1517` | **★ 없음** | 없음 | guide/03_이력.md:854 |
| `S46-121` | 머리띠 규칙이 한 곳에만 있는가 | fatal | `validate/v0_guide.py:1468` | **★ 없음** | 없음 | UI_REVIEW.md:1511 · guide/03_이력.md:862 · guide/09_설계뒤에할것_20260829.md:102 |
| `S46-122` | 머리·발이 한 곳에만 있는가 | fatal | `validate/v0_guide.py:1595` | **★ 없음** | 없음 | UI_REVIEW.md:1546 · guide/03_이력.md:863 · guide/09_설계뒤에할것_20260829.md:101 |
| `S46-123` | 토스 표에 없는 색이 없는가 | fatal | `validate/v0_guide.py:1553` | **★ 없음** | 없음 | UI_REVIEW.md:1610 · guide/03_이력.md:863 |
| `S46-124` | DB 를 PRAGMA 없이 열지 않는가 | fatal | `validate/v0_guide.py:1731` | **★ 없음** | 없음 | VOLVO_SELEKT_API.md:513 · guide/03_이력.md:866 |
| `S46-125` | 고른 정렬 축이 정말 먹는가 | fatal | `validate/v0_guide.py:1397` | **★ 없음** | 없음 | guide/03_이력.md:868 |
| `S46-126` | 수집기가 통신·sleep 을 트랜잭션 밖에서 하는가 | fatal | `validate/v0_guide.py:1767` | **★ 없음** | 없음 | guide/03_이력.md:870 · guide/03_이력.md:935 · guide/06_오판대장.md:283 |
| `S46-127` | 수집기마다 화면이나 타이머가 있는가 | fatal | `validate/v0_guide.py:1683` | **★ 없음** | 없음 | guide/03_이력.md:1067 · guide/06_오판대장.md:259 · guide/07_밀린일대장.md:382 |
| `S46-128` | 묶어 쓰는 단계가 다른 쓰기에 창을 주는가 | fatal | `validate/v0_guide.py:1639` | **★ 없음** | 없음 | guide/06_오판대장.md:260 |
| `S46-129` | 표의 합이 맞는가 | fatal | `validate/v0_guide.py:3380` | **★ 없음** | 없음 | guide/03_이력.md:977 · guide/03_이력.md:987 · guide/06_오판대장.md:261 |
| `S46-130` | 합계표가 문서마다 하나인가 | fatal | `validate/v0_guide.py:3640` | **★ 없음** | 없음 | guide/03_이력.md:1001 · guide/06_오판대장.md:262 |
| `S46-131` | 「쪽넘김이 없다」에 실측이 있는가 | fatal | `validate/v0_guide.py:3524` | **★ 없음** | 없음 | guide/06_오판대장.md:263 · guide/07_밀린일대장.md:342 |
| `S46-132` | 인계문이 다시 재라고 적는가 | fatal | `validate/v0_guide.py:3412` | **★ 없음** | 없음 | guide/06_오판대장.md:264 |
| `S46-133` | 검사 구멍이 밀린일에 있는가 | fatal | `validate/v0_guide.py:3779` | **★ 없음** | 없음 | guide/06_오판대장.md:265 |
| `S46-134` | 질의와 규격이 어긋나지 않는가 | fatal | `validate/v0_guide.py:3657` | **★ 없음** | 없음 | guide/06_오판대장.md:266 |
| `S46-135` | 일반화에 표본이 있는가 | fatal | `validate/v0_guide.py:3546` | **★ 없음** | 없음 | guide/06_오판대장.md:267 |
| `S46-136` | 규격의 warn 수가 지금 값과 같은가 | fatal | `validate/v0_guide.py:3797` | **★ 없음** | 없음 | guide/06_오판대장.md:268 · guide/07_밀린일대장.md:343 |
| `S46-137` | 질의 열쇠를 읽는 코드가 있는가 | fatal | `validate/v0_guide.py:3819` | **★ 없음** | 없음 | guide/06_오판대장.md:269 |
| `S46-138` | 「전량」에 세는 법이 있는가 | fatal | `validate/v0_guide.py:3563` | **★ 없음** | 없음 | guide/03_이력.md:999 · guide/06_오판대장.md:270 |
| `S46-139` | 「칸이 비었다」에 전수가 있는가 | fatal | `validate/v0_guide.py:3848` | **★ 없음** | 없음 | guide/06_오판대장.md:271 |
| `S46-140` | 쓰는 호스트가 robots 문서에 있는가 | fatal | `validate/v0_guide.py:3426` | **★ 없음** | 없음 | guide/06_오판대장.md:272 · guide/07_밀린일대장.md:342 |
| `S46-141` | 거르개 판정에 실측이 있는가 | fatal | `validate/v0_guide.py:3683` | **★ 없음** | 없음 | guide/06_오판대장.md:273 |
| `S46-142` | 「N 사이트」가 config 와 같은가 | fatal | `validate/v0_guide.py:3445` | **★ 없음** | 없음 | guide/03_이력.md:1213 · guide/03_이력.md:1215 · guide/06_오판대장.md:274 |
| `S46-143` | 마스터께 올릴 것이 세어졌는가 | fatal | `validate/v0_guide.py:3700` | **★ 없음** | 없음 | guide/03_이력.md:1001 · guide/06_오판대장.md:275 |
| `S46-144` | 「비었다」가 ⑤·⑥·⑦ 로 갈렸는가 | fatal | `validate/v0_guide.py:3939` | **★ 없음** | 없음 | guide/03_이력.md:983 · guide/06_오판대장.md:276 · guide/12_남은것_20260829.md:15 |
| `S46-145` | 마스터께 드리는 표에 수의 뜻이 있는가 | fatal | `validate/v0_guide.py:3278` | **★ 없음** | 없음 | guide/03_이력.md:985 · guide/06_오판대장.md:277 |
| `S46-146` | 「안 준다」를 쓰며 파서를 봤는가 | fatal | `validate/v0_guide.py:3480` | **★ 없음** | 없음 | guide/03_이력.md:997 · guide/06_오판대장.md:278 |
| `S46-147` | 「안 준다」의 표본이 열 건인가 | fatal | `validate/v0_guide.py:3735` | **★ 없음** | 없음 | guide/05_가이드역할.md:1500 · guide/06_오판대장.md:279 · evidence/absence_20260829.md:6 |
| `S46-148` | 「축이 빈다」가 칼럼·파서를 짚는가 | fatal | `validate/v0_guide.py:3865` | **★ 없음** | 없음 | guide/03_이력.md:1001 · guide/03_이력.md:1215 · guide/06_오판대장.md:280 |
| `S46-149` | 자백이 닫혔는가 | fatal | `validate/v0_guide.py:3587` | **★ 없음** | 없음 | guide/06_오판대장.md:281 · guide/07_밀린일대장.md:343 |
| `S46-150` | 규격의 칼럼이 DDL 에 있는가 | fatal | `validate/v0_guide.py:3757` | **★ 없음** | 없음 | ROADMAP_20260830.md:65 · guide/06_오판대장.md:282 |
| `S46-152` | 마지막 개발 회차를 읽었는가 | fatal | `validate/v0_guide.py:3883` | **★ 없음** | 없음 | guide/03_이력.md:991 · guide/03_이력.md:1007 · guide/03_이력.md:1009 |
| `S46-153` | 「마스터 몫」이 진짜 마스터 몫인가 | fatal | `validate/v0_guide.py:3956` | **★ 없음** | 없음 | guide/03_이력.md:1007 · guide/03_이력.md:1009 · guide/06_오판대장.md:285 |
| `S46-154` | 마스터 말씀이 요구 추적표에 있는가 | fatal | `validate/v0_guide.py:3502` | **★ 없음** | 없음 | guide/01_요구사항.md:49 · guide/03_이력.md:1005 · guide/06_오판대장.md:286 |
| `S46-155` | 화면 규격마다 시안이 있는가 | fatal | `validate/v0_guide.py:3307` | **★ 없음** | 없음 | guide/03_이력.md:985 · guide/03_이력.md:1003 · guide/06_오판대장.md:287 |
| `S46-156` | 개발측 물음의 답이 규격에 있는가 | fatal | `validate/v0_guide.py:3614` | **★ 없음** | 없음 | guide/06_오판대장.md:288 |
| `S46-157` | 성능 판정에 시간이 있는가 | fatal | `validate/v0_guide.py:3988` | **★ 없음** | 없음 | guide/06_오판대장.md:289 |
| `S46-158` | 용량 판정에 수가 있는가 | fatal | `validate/v0_guide.py:4006` | **★ 없음** | 없음 | guide/06_오판대장.md:290 |
| `S46-159` | 설계도가 할 수 있는 것만 시키는가 | fatal | `validate/v0_guide.py:3920` | **★ 없음** | 없음 | guide/06_오판대장.md:291 · guide/07_밀린일대장.md:343 |
| `S46-160` | 전기차 누유가 만점·분모 910 인가 | fatal | `validate/v0_guide.py:4024` | **★ 없음** | 없음 | guide/03_이력.md:971 · guide/06_오판대장.md:292 · guide/06_오판대장.md:293 |
| `S46-161` | 「사이트가 안 준다」에 증거가 있는가 | fatal | `validate/v0_guide.py:3199` | **★ 없음** | 없음 | guide/03_이력.md:975 · guide/03_이력.md:977 · guide/03_이력.md:979 |
| `S46-162` | 오판이 약속한 검사가 실제로 있는가 | fatal | `validate/v0_guide.py:3248` | **★ 없음** | 없음 | guide/03_이력.md:977 · guide/03_이력.md:979 · guide/03_이력.md:985 |
| `S46-163` | 시안마다 라우팅 표에 주소가 있는가 | fatal | `validate/v0_guide.py:3340` | **★ 없음** | 없음 | guide/03_이력.md:985 · guide/03_이력.md:1003 · guide/03_이력.md:1243 |
| `S46-164` | 개발 회차의 「마스터 몫」에 답을 냈는가 | fatal | `validate/v0_guide.py:4041` | **★ 없음** | 없음 | guide/03_이력.md:991 · guide/06_오판대장.md:296 · guide/14_누가할것_20260829.md:39 |
| `S46-165` | 「못 잰다」가 진짜인가 | fatal | `validate/v0_guide.py:4075` | **★ 없음** | 없음 | guide/03_이력.md:1011 · guide/06_오판대장.md:297 · guide/06_오판대장.md:298 |
| `S46-166` | 마스터 확정이 장 규격에 닿았는가 | fatal | `validate/v0_guide.py:4116` | **★ 없음** | 없음 | ARCHITECTURE_20260830.md:8 · guide/03_이력.md:1017 · guide/06_오판대장.md:299 |
| `S46-168` | 검사가 예외를 수로 내는가 | fatal | `validate/v0_guide.py:4146` | **★ 없음** | 없음 | guide/03_이력.md:1037 · guide/03_이력.md:1067 · guide/03_이력.md:1240 |
| `S46-169` | 「왜 죽었는지」가 규격에 있는가 | fatal | `validate/v0_guide.py:4185` | **★ 없음** | 없음 | ARCHITECTURE_20260830.md:8 · ARCHITECTURE_20260830.md:148 · guide/03_이력.md:1045 |
| `S46-170` | 설계도가 하나인가 | fatal | `validate/v0_guide.py:4202` | **★ 없음** | 없음 | ARCHITECTURE_20260830.md:301 · guide/03_이력.md:1057 |
| `S46-171` | 잣대가 화면을 적었는가 | fatal | `validate/v0_guide.py:4220` | **★ 없음** | 없음 | guide/03_이력.md:1061 · guide/06_오판대장.md:301 |
| `S46-172` | 「없다」를 본문 낱말로 쟀는가 | fatal | `validate/v0_guide.py:4239` | **★ 없음** | 없음 | guide/03_이력.md:1075 · guide/06_오판대장.md:302 |
| `S46-173` | 규격이 창구를 적었는가 | fatal | `validate/v0_guide.py:4263` | **★ 없음** | 없음 | guide/03_이력.md:1077 · guide/06_오판대장.md:303 |
| `S46-174` | 「창구가 없다」를 열어 보고 적었는가 | fatal | `validate/v0_guide.py:4288` | **★ 없음** | 없음 | guide/03_이력.md:1081 · guide/06_오판대장.md:304 |
| `S46-175` | 점수를 「나머지 N」으로 뭉개지 않는가 | fatal | `validate/v0_guide.py:4315` | **★ 없음** | 없음 | guide/03_이력.md:1083 · guide/03_이력.md:1127 · guide/06_오판대장.md:305 |
| `S46-176` | 사이트 두드리기를 넘기지 않는가 | fatal | `validate/v0_guide.py:4348` | **★ 없음** | 없음 | guide/03_이력.md:1085 · guide/03_이력.md:1241 · guide/06_오판대장.md:306 |
| `S46-177` | 카탈로그를 site 로 가두지 않는가 | fatal | `validate/v0_guide.py:4376` | **★ 없음** | 없음 | guide/03_이력.md:1101 · chapters/30-score/f-table.md:1808 |
| `S46-178` | 목록이 주는 칸이 파서에 있는가 | fatal | `validate/v0_guide.py:4401` | **★ 없음** | 없음 | guide/03_이력.md:1101 · chapters/30-score/f-table.md:1832 |
| `S46-179` | 못 받은 축에 감점이 없는가 | fatal | `validate/v0_guide.py:4426` | **★ 없음** | 없음 | guide/03_이력.md:1111 · chapters/30-score/f-table.md:1955 |
| `S46-180` | 코드 표가 사이트마다 있는가 | fatal | `validate/v0_guide.py:4440` | **★ 없음** | 없음 | guide/03_이력.md:1113 · guide/03_이력.md:1127 · guide/06_오판대장.md:308 |
| `S46-181` | 받아 둔 조사를 먼저 보는가 | fatal | `validate/v0_guide.py:4467` | **★ 없음** | 없음 | CROSS_SITE_COMPARE.md:1076 · guide/03_이력.md:1115 · guide/06_오판대장.md:309 |
| `S46-182` | 「전 사이트」를 사이트별로 열고 말했는가 | fatal | `validate/v0_guide.py:4486` | **★ 없음** | 없음 | guide/03_이력.md:1123 · guide/06_오판대장.md:310 |
| `S46-183` | 「마스터 몫」 전에 내가 열었는가 | fatal | `validate/v0_guide.py:4514` | **★ 없음** | 없음 | guide/03_이력.md:1127 · guide/03_이력.md:1215 · guide/03_이력.md:1233 |
| `S46-184` | 「미조회」를 「없다」로 옮기지 않는가 | fatal | `validate/v0_guide.py:4543` | **★ 없음** | 없음 | guide/03_이력.md:1131 · guide/03_이력.md:1348 · guide/06_오판대장.md:312 |
| `S46-185` | 원문 파일을 지우지 않는가 | fatal | `validate/v0_guide.py:4576` | **★ 없음** | 없음 | ARCHITECTURE_20260830.md:386 · guide/03_이력.md:1133 · guide/03_이력.md:1274 |
| `S46-186` | 등급 분포를 보고 있는가 | fatal | `validate/v0_guide.py:4606` | **★ 없음** | 없음 | guide/06_오판대장.md:313 |
| `S46-187` | 값 곡선이 쌀수록 높은가 | fatal | `validate/v0_guide.py:4620` | **★ 없음** | 없음 | guide/03_이력.md:1141 · guide/06_오판대장.md:314 |
| `S46-188` | 「화면에 없다」를 열어 보고 적었는가 | fatal | `validate/v0_guide.py:4647` | **★ 없음** | 없음 | guide/06_오판대장.md:315 |
| `S46-191` | 차종별 예산이 원칙대로인가 | fatal | `validate/v0_guide.py:4671` | **★ 없음** | 없음 | guide/03_이력.md:1164 · guide/03_이력.md:1184 · guide/03_이력.md:1185 |
| `S46-192` | 선호차종이 등록부에 다 있는가 | fatal | `validate/v0_guide.py:4717` | **★ 없음** | 없음 | guide/03_이력.md:1166 |
| `S46-202` | 안 풀린 틀 문법이 없는가 | fatal | `validate/v0_guide.py:4742` | **★ 없음** | 없음 | RECOMMEND_SCREEN.md:399 · guide/03_이력.md:1186 |
| `S46-203` | 넣으라 한 사이트에 차종 열쇠가 있는가 | fatal | `validate/v0_guide.py:4852` | **★ 없음** | 없음 | guide/06_오판대장.md:317 |
| `S46-204` | 받기가 파일에 쓰는가 | fatal | `validate/v0_guide.py:4884` | **★ 없음** | 없음 | guide/03_이력.md:1189 · guide/03_이력.md:1270 · guide/06_오판대장.md:347 |
| `S46-205` | raw_response 에 넣으라 하지 않는가 | fatal | `validate/v0_guide.py:4912` | **★ 없음** | 없음 | guide/03_이력.md:1190 · guide/03_이력.md:1274 · guide/03_이력.md:1287 |
| `S46-206` | PDF 를 받아 두라 하지 않는가 | fatal | `validate/v0_guide.py:4947` | **★ 없음** | 없음 | guide/03_이력.md:1191 · guide/06_오판대장.md:320 · chapters/10-collect/d-policy.md:186 |
| `S46-207` | 커밋 제목이 사실을 말하는가 | fatal | `validate/v0_guide.py:5013` | **★ 없음** | 없음 | ROADMAP_20260830.md:66 · guide/03_이력.md:1193 · guide/03_이력.md:1215 |
| `S46-208` | 시세 축이 음수를 내지 않는가 | fatal | `validate/v0_guide.py:5051` | **★ 없음** | 없음 | guide/03_이력.md:1195 · guide/06_오판대장.md:321 · chapters/30-score/f-table.md:2673 |
| `S46-213` | 추천에 판매완료가 없는가 | fatal | `validate/v0_guide.py:4806` | **★ 없음** | 없음 | RECOMMEND_SCREEN.md:558 · guide/03_이력.md:1207 |
| `S46-214` | 사진 밑에 빈칸이 없는가 | fatal | `validate/v0_guide.py:5070` | **★ 없음** | 없음 | RECOMMEND_SCREEN.md:746 · UI_REVIEW.md:2035 · guide/03_이력.md:1210 |
| `S46-215` | 수집기가 active 를 보는가 | fatal | `validate/v0_guide.py:5095` | **★ 없음** | 없음 | guide/03_이력.md:1219 · guide/03_이력.md:1233 · chapters/10-collect/00-intro.md:651 |
| `S46-227` | 밝힌 없음에 안 준 것이 없는가 | fatal | `validate/v0_guide.py:4755` | **★ 없음** | 없음 | guide/03_이력.md:1228 · chapters/11-store/a-key.md:1109 |
| `S46-229` | recommend 로 거르는가 | fatal | `validate/v0_guide.py:5121` | **★ 없음** | 없음 | RECOMMEND_SCREEN.md:786 · guide/03_이력.md:1232 · guide/03_이력.md:1233 |
| `S46-230` | ④ 셈이 같은 판 안만 세는가 | fatal | `validate/v0_guide.py:5149` | **★ 없음** | 없음 | guide/03_이력.md:1234 · guide/03_이력.md:1240 · guide/07_밀린일대장.md:272 |
| `S46-231` | 매물 있는 사이트가 거르개에 다 있는가 | fatal | `validate/v0_guide.py:5179` | **★ 없음** | 없음 | guide/03_이력.md:1234 · guide/03_이력.md:1240 · guide/06_오판대장.md:330 |
| `S46-232` | 예산 곡선이 한계에서 0 인가 | fatal | `validate/v0_guide.py:5206` | **★ 없음** | 없음 | guide/03_이력.md:1235 |
| `S46-233` | 크기 축이 0점을 안 주는가 | fatal | `validate/v0_guide.py:5250` | **★ 없음** | 없음 | guide/03_이력.md:1235 · guide/03_이력.md:1239 · guide/06_오판대장.md:337 |
| `S46-234` | 매물 최다 사이트가 gone 을 매기는가 | fatal | `validate/v0_guide.py:5289` | **★ 없음** | 없음 | — |
| `S46-235` | 화면이 안 파는 것을 감추는가 | fatal | `validate/v0_guide.py:5321` | **★ 없음** | 없음 | — |
| `S46-236` | 내장색 축이 있고 기피가 0이 아닌가 | fatal | `validate/v0_guide.py:5454` | **★ 없음** | 없음 | guide/03_이력.md:1236 · guide/03_이력.md:1237 · guide/06_오판대장.md:334 |
| `S46-237` | 추천이 예산 안인가 | fatal | `validate/v0_guide.py:5422` | **★ 없음** | 없음 | — |
| `S46-238` | 트림이 신차가를 두 번 안 세는가 | fatal | `validate/v0_guide.py:5489` | **★ 없음** | 없음 | guide/03_이력.md:1236 |
| `S46-240` | DDL 색인이 DB 에 다 있는가 | fatal | `validate/v0_guide.py:5381` | **★ 없음** | 없음 | guide/03_이력.md:1238 |
| `S46-241` | 배포에서 재판정이 살아 있는가 | fatal | `validate/v0_guide.py:5512` | **★ 없음** | 없음 | guide/03_이력.md:1240 · guide/03_이력.md:1263 · guide/03_이력.md:1272 |
| `S46-242` | 시안에 「반드시 있는 것」 머리가 있는가 | fatal | `validate/v0_guide.py:5607` | **★ 없음** | 없음 | guide/03_이력.md:1241 |
| `S46-243` | 비는 자리가 까닭을 내는가 | fatal | `validate/v0_guide.py:5631` | **★ 없음** | 없음 | guide/03_이력.md:1241 |
| `S46-244` | 실패 응답도 원문으로 남는가 | fatal | `validate/v0_guide.py:5661` | **★ 없음** | 없음 | guide/03_이력.md:1242 |
| `S46-245` | 화면마다 그 화면에 드는 것이 있는가 | fatal | `validate/v0_guide.py:5681` | **★ 없음** | 없음 | guide/03_이력.md:1243 · guide/06_오판대장.md:338 · guide/07_밀린일대장.md:106 |
| `S46-246` | 화면마다 시안이 있는가 | fatal | `validate/v0_guide.py:5716` | **★ 없음** | 없음 | guide/03_이력.md:1243 · guide/06_오판대장.md:338 |
| `S46-247` | 사이트에 있는 것을 얼마나 받았나 | fatal | `validate/v0_guide.py:5822` | **★ 없음** | 없음 | guide/03_이력.md:1245 · guide/03_이력.md:1262 · guide/03_이력.md:1287 |
| `S46-248` | 등급이 현실을 가르는가 | fatal | `validate/v0_guide.py:5888` | **★ 없음** | 없음 | guide/03_이력.md:1244 |
| `S46-249` | 마스터 예산이 그대로인가 | fatal | `validate/v0_guide.py:5922` | **★ 없음** | 없음 | guide/03_이력.md:1244 |
| `S46-250` | 시안이 모양을 갖췄는가 | fatal | `validate/v0_guide.py:5951` | **★ 없음** | 없음 | guide/03_이력.md:1245 |
| `S46-251` | 사이트마다 차량 키가 붙는가 | fatal | `validate/v0_guide.py:5984` | **★ 없음** | 없음 | guide/03_이력.md:1247 |
| `S46-252` | 관리 쓰기가 정말 저장되는가 | fatal | `validate/v0_guide.py:6014` | **★ 없음** | 없음 | guide/03_이력.md:1248 · guide/03_이력.md:1274 |
| `S46-253` | 1부를 브라우저로 봤는가 | fatal | `validate/v0_guide.py:6046` | **★ 없음** | 없음 | — |
| `S46-254` | 짝지어진 차를 순위로 올리지 않는가 | fatal | `validate/v0_guide.py:6089` | **★ 없음** | 없음 | CROSS_SITE_COMPARE.md:188 · guide/03_이력.md:1250 · guide/03_이력.md:1251 |
| `S46-255` | 시험자 번호가 낱개로 있는가 | fatal | `validate/v0_guide.py:6123` | **★ 없음** | 없음 | guide/03_이력.md:1251 · guide/07_밀린일대장.md:179 |
| `S46-256` | 막혔다를 증거 없이 쓰지 않는가 | fatal | `validate/v0_guide.py:6424` | **★ 없음** | 없음 | guide/03_이력.md:1252 · guide/06_오판대장.md:341 · chapters/13-pipeline.md:290 |
| `S46-257` | 파이프라인이 엔카만 돌지 않는가 | fatal | `validate/v0_guide.py:6455` | **★ 없음** | 없음 | guide/03_이력.md:1253 · guide/03_이력.md:1274 · guide/06_오판대장.md:356 |
| `S46-258` | 판정 축 사전이 정해졌는가 | fatal | `validate/v0_guide.py:6577` | **★ 없음** | 없음 | guide/03_이력.md:1255 |
| `S46-259` | 마스터 차종 이름이 그대로인가 | fatal | `validate/v0_guide.py:6609` | **★ 없음** | 없음 | guide/03_이력.md:1256 · guide/03_이력.md:1257 · guide/06_오판대장.md:342 |
| `S46-260` | 빈 쪽이 아니라 끝 신호로 멈추는가 | fatal | `validate/v0_guide.py:6667` | **★ 없음** | 없음 | guide/03_이력.md:1258 · chapters/13-pipeline.md:334 |
| `S46-261` | 회차의 수와 배포의 수가 같은가 | fatal | `validate/v0_guide.py:6324` | **★ 없음** | 없음 | — |
| `S46-262` | 개발측 「여쭐 것」이 물렸는가 | fatal | `validate/v0_guide.py:6692` | **★ 없음** | 없음 | guide/03_이력.md:1261 · guide/03_이력.md:1262 · guide/03_이력.md:1333 |
| `S46-263` | 네 갈래 로직이 규격에 있는가 | fatal | `validate/v0_guide.py:6724` | **★ 없음** | 없음 | guide/03_이력.md:1265 · guide/03_이력.md:1266 · guide/03_이력.md:1267 |
| `S46-264` | 배포가 열려 있는가 | fatal | `validate/v0_guide.py:6763` | **★ 없음** | 없음 | guide/03_이력.md:1268 · guide/03_이력.md:1269 · guide/06_오판대장.md:346 |
| `S46-265` | 적재 뒤 raw_response 를 지우는가 | fatal | `validate/v0_guide.py:6806` | **★ 없음** | 없음 | guide/03_이력.md:1270 · guide/06_오판대장.md:347 · guide/07_밀린일대장.md:101 |
| `S46-266` | 이미 받은 상세를 다시 안 받는가 | fatal | `validate/v0_guide.py:6843` | **★ 없음** | 없음 | guide/03_이력.md:1271 · guide/07_밀린일대장.md:103 · chapters/10-collect/00-intro.md:516 |
| `S46-267` | 팔린 것을 대조하고 치우는가 | fatal | `validate/v0_guide.py:6865` | **★ 없음** | 없음 | guide/03_이력.md:1271 · guide/07_밀린일대장.md:105 · chapters/10-collect/00-intro.md:553 |
| `S46-268` | 지시문이 한 벌이고 지금 판인가 | fatal | `validate/v0_guide.py:6890` | **★ 없음** | 없음 | guide/03_이력.md:1273 · guide/03_이력.md:1317 · guide/03_이력.md:1359 |
| `S46-269` | 추천 차종과 단추 크기가 확정대로인가 | fatal | `validate/v0_guide.py:6945` | **★ 없음** | 없음 | guide/03_이력.md:1276 · guide/03_이력.md:1277 · guide/06_오판대장.md:355 |
| `S46-270` | 가려진 글자를 세는 자가 있는가 | fatal | `validate/v0_guide.py:6996` | **★ 없음** | 없음 | guide/03_이력.md:1279 · guide/06_오판대장.md:348 |
| `S46-271` | 화면을 브라우저로 열어 재는가 | fatal | `validate/v0_guide.py:7084` | **★ 없음** | 없음 | guide/03_이력.md:1280 · guide/03_이력.md:1281 · guide/03_이력.md:1287 |
| `S46-272` | 사진을 URL 로만 스무 장까지 두는가 | fatal | `validate/v0_guide.py:7144` | **★ 없음** | 없음 | guide/03_이력.md:1298 · chapters/10-collect/00-intro.md:495 |
| `S46-273` | 엔카 배너가 마스터가 받은 것을 세는가 | fatal | `validate/v0_guide.py:7174` | **★ 없음** | 없음 | guide/03_이력.md:1300 |
| `S46-274` | 기본 차례가 등급 > 값 > 추천인가 | fatal | `validate/v0_guide.py:7202` | **★ 없음** | 없음 | RECOMMEND_SCREEN.md:292 · guide/03_이력.md:1301 · guide/03_이력.md:1319 |
| `S46-275` | 축 점수를 저장하는가 | fatal | `validate/v0_guide.py:7248` | **★ 없음** | 없음 | guide/03_이력.md:1302 · guide/03_이력.md:1317 · guide/06_오판대장.md:350 |
| `S46-276` | 엔카 수집에 구멍이 없는가 | fatal | `validate/v0_guide.py:7278` | **★ 없음** | 없음 | guide/03_이력.md:1306 · guide/07_밀린일대장.md:13 |
| `S46-277` | 관리 질의가 조회를 막지 않는가 | fatal | `validate/v0_guide.py:7334` | **★ 없음** | 없음 | guide/03_이력.md:1307 · guide/03_이력.md:1315 · guide/07_밀린일대장.md:12 |
| `S46-278` | KB 가 막힌 응답도 남기는가 | fatal | `validate/v0_guide.py:7359` | **★ 없음** | 없음 | guide/03_이력.md:1309 · guide/07_밀린일대장.md:11 |
| `S46-279` | KB 값·항목·사진이 찼는가 | fatal | `validate/v0_guide.py:7398` | **★ 없음** | 없음 | guide/03_이력.md:1309 · guide/07_밀린일대장.md:14 |
| `S46-280` | 열두 사이트에 같은 구멍이 없는가 | fatal | `validate/v0_guide.py:7448` | **★ 없음** | 없음 | guide/03_이력.md:1310 · guide/07_밀린일대장.md:16 |
| `S46-281` | 이름만 있는 옵션도 받는가 | fatal | `validate/v0_guide.py:7505` | **★ 없음** | 없음 | guide/03_이력.md:1311 · chapters/11-store/a-key.md:83 |
| `S46-282` | 사이트별 매핑표가 있는가 | fatal | `validate/v0_guide.py:7532` | **★ 없음** | 없음 | guide/03_이력.md:1312 · guide/03_이력.md:1314 · guide/07_밀린일대장.md:15 |
| `S46-283` | 축 점수가 표에 실제로 차 있는가 | fatal | `validate/v0_guide.py:7028` | **★ 없음** | 없음 | RECOMMEND_SCREEN.md:140 · RECOMMEND_SCREEN.md:243 · guide/03_이력.md:1320 |
| `S46-284` | 작업 지시가 읽히는 꼴인가 | fatal | `validate/v0_guide.py:7610` | **★ 없음** | 없음 | guide/03_이력.md:1324 · guide/03_이력.md:1328 · guide/03_이력.md:1331 |
| `S46-285` | 마스터 대상 차종의 상세가 채워졌는가 | fatal | `validate/v0_guide.py:7676` | **★ 없음** | 없음 | guide/03_이력.md:1325 |
| `S46-286` | 취향 축 합이 165 인가 | fatal | `validate/v0_guide.py:7708` | **★ 없음** | 없음 | guide/03_이력.md:1329 |
| `S46-287` | 차종별 취향 고정값이 있는가 | fatal | `validate/v0_guide.py:7741` | **★ 없음** | 없음 | guide/03_이력.md:1329 · guide/03_이력.md:1333 · guide/03_이력.md:1334 |
| `S46-288` | 미분류를 다시 묻지 않는가 | fatal | `validate/v0_guide.py:7777` | **★ 없음** | 없음 | guide/03_이력.md:1335 · guide/03_이력.md:1336 · guide/03_이력.md:1359 |
| `S46-289` | 차종 표가 분류의 정본인가 | fatal | `validate/v0_guide.py:7828` | **★ 없음** | 없음 | guide/03_이력.md:1336 |
| `S46-290` | 마스터 회선으로 받는 길이 있는가 | fatal | `validate/v0_guide.py:7857` | **★ 없음** | 없음 | guide/03_이력.md:1350 · guide/03_이력.md:1355 |
| `S46-291` | 시안 CSS 가 app.css 에 옮겨졌는가 | fatal | `validate/v0_guide.py:7899` | **★ 없음** | 없음 | guide/03_이력.md:1351 · guide/03_이력.md:1360 |
| `S46-292` | 탭 3 이 마스터의 차종만 내는가 | fatal | `validate/v0_guide.py:7955` | **★ 없음** | 없음 | guide/03_이력.md:1353 |
| `S46-293` | 탭 3 거를 조건이 설정에 있는가 | fatal | `validate/v0_guide.py:7983` | **★ 없음** | 없음 | guide/03_이력.md:1354 |
| `S46-294` | 추천4 규격이 설정에 있는가 | fatal | `validate/v0_guide.py:8012` | **★ 없음** | 없음 | guide/03_이력.md:1356 |
...
| `V1-08` | 동일 코드 실패율 100% 인 엔드포인트 없음 | run | `validate/v1_collect.py:55` | **★ 없음** | 없음 | ROADMAP_20260830.md:61 · ROADMAP_20260830.md:75 · guide/00_인수인계.md:132 |
...
| `V1-22` | 사이트가 주는 것을 받아 쓰는가 | fatal | `validate/v0_guide.py:6239` | **★ 없음** | 없음 | trace/05-score.md:47 · guide/01_요구사항.md:159 · guide/01_요구사항.md:275 |
...
| `V1-27` | 확인 안 됨을 ①②③④ 로 가른 표가 있음 | run | `validate/v1_collect.py:88` | **★ 없음** | 없음 | guide/03_이력.md:454 · chapters/30-score/f-table.md:513 |
...
| `V2-08` | 값 종류 1인 컬럼 | run | `validate/v2_load.py:133` | **★ 없음** | 없음 | chapters/20-verify/b-v1v2.md:112 · chapters/20-verify/b-v1v2.md:148 · chapters/20-verify/b-v1v2.md:153 |
...
| `V2-11` | plate_hash 가 전건 16자 hex | run | `validate/v2_load.py:130` | **★ 없음** | 없음 | DEDUP_CROSS_SITE.md:26 · trace/11-store.md:50 · chapters/11-store/b-core.md:446 |
...
| `V2-14` | 참조되는 5종 PK 가 단일 INTEGER | run | `validate/v2_load.py:121` | **★ 없음** | 없음 | chapters/11-store/a-key.md:248 · chapters/11-store/a-key.md:588 · chapters/60-admin/00-intro.md:147 |
| `V2-15` | 자연키가 UNIQUE 로 걸려 있음 | run | `validate/v2_load.py:124` | **★ 없음** | 없음 | chapters/20-verify/b-v1v2.md:134 |
| `V2-16` | PK·FK 컬럼에 개인정보 없음 | run | `validate/v2_load.py:127` | **★ 없음** | 없음 | chapters/60-admin/00-intro.md:147 · chapters/20-verify/b-v1v2.md:135 |
...
| `V2-18` | parse_rule 재처리 후 전 봉투가 현재 parse_version | run | `validate/v2_load.py:117` | **★ 없음** | 없음 | trace/RULES.md:226 · guide/03_이력.md:136 · chapters/13-pipeline.md:454 |
| `V2-19` | 원문 유래 컬럼에 NOT NULL 없음 | run | `validate/v2_load.py:114` | **★ 없음** | 없음 | guide/01_요구사항.md:910 · guide/01_요구사항.md:919 · guide/01_요구사항.md:920 |
| `V2-20` | 원문이 ok 인데 DB 가 「못 받았다」인 줄 없음 | run | `validate/v2_load.py:109` | **★ 없음** | 없음 | guide/01_요구사항.md:923 · guide/01_요구사항.md:932 · guide/01_요구사항.md:933 |
...
| `V2-30` | 전 파서가 row_status 를 냄 | run | `validate/v2_load.py:146` | **★ 없음** | 없음 | guide/03_이력.md:289 · chapters/20-verify/b-v1v2.md:124 · chapters/10-collect/b-parse.md:96 |
| `V2-31` | target_key NULL 이 판정에 들어가지 않음 | run | `validate/v2_load.py:136` | **★ 없음** | 없음 | trace/11-store.md:70 · trace/11-store.md:71 · trace/RULES.md:197 |
| `V2-32` | NULL 매물의 모델명이 화면에서 보임 | run | `validate/v2_load.py:141` | **★ 없음** | 없음 | trace/11-store.md:71 · trace/11-store.md:72 · trace/RULES.md:197 |
...
| `V3-72` | SOH 가점이 곡선대로 붙음 | run | `validate/v3_logic.py:151` | **★ 없음** | 없음 | guide/03_이력.md:399 · chapters/30-score/f-table.md:942 |
...
| `V3-76` | ⑤ 의 하위 축 합이 갈래 표기와 같음 | run | `validate/v3_logic.py:256` | **★ 없음** | 없음 | guide/03_이력.md:412 · chapters/30-score/f-table.md:1355 |
| `V3-77` | 갈래마다 하위 축 합 = 갈래 표기 (전 갈래) | run | `validate/v3_logic.py:262` | **★ 없음** | 없음 | ROADMAP_20260830.md:64 · guide/03_이력.md:412 · guide/03_이력.md:431 |
| `V3-78` | 「그 밖」으로 옮긴 값이 축을 덮지 않음 | run | `validate/v3_logic.py:267` | **★ 없음** | 없음 | guide/03_이력.md:418 |
| `V3-79` | 어긋난 매물에 ②-2·②-3 만점이 없음 | run | `validate/v3_logic.py:216` | **★ 없음** | 없음 | guide/03_이력.md:434 · chapters/30-score/f-table.md:1002 |
| `V3-80` | ②-1 회수가 max(보험, 성능부) 임 | run | `validate/v3_logic.py:222` | **★ 없음** | 없음 | guide/03_이력.md:434 · chapters/30-score/f-table.md:1003 |
| `V3-81` | 셋 중 하나만 null 인데 확인 안 됨이 아님 | run | `validate/v3_logic.py:228` | **★ 없음** | 없음 | guide/03_이력.md:435 · chapters/30-score/f-table.md:1073 |
| `V3-82` | 시세 점수가 계단값만 나오지 않음 | run | `validate/v3_logic.py:234` | **★ 없음** | 없음 | guide/03_이력.md:439 · chapters/30-score/f-table.md:768 |
| `V3-83` | 시세보다 비싼 매물에 음수 점수가 붙음 | run | `validate/v3_logic.py:240` | **★ 없음** | 없음 | chapters/30-score/f-table.md:769 |
| `V3-84` | 신차가 곡선이 규격의 앵커와 같음 | run | `validate/v3_logic.py:246` | **★ 없음** | 없음 | guide/03_이력.md:439 · chapters/30-score/f-table.md:812 |
| `V3-85` | 옵션 보정 없이 원 중앙값으로 견준 매물 | run | `validate/v3_logic.py:251` | **★ 없음** | 없음 | guide/03_이력.md:441 |
| `V3-86` | 축 점수가 배점을 넘지 않음 | run | `validate/v3_logic.py:205` | **★ 없음** | 없음 | guide/03_이력.md:448 · chapters/30-score/f-table.md:553 |
| `V3-87` | 사이트 검증이 단계임 (더하지 않음) | run | `validate/v3_logic.py:211` | **★ 없음** | 없음 | guide/03_이력.md:448 · chapters/30-score/f-table.md:554 · chapters/30-score/f-table.md:1440 |
...
| `V3-91` | 가이드 검산 일곱 줄이 표대로 나옴 | run | `validate/v3_logic.py:199` | **★ 없음** | 없음 | guide/03_이력.md:451 · chapters/30-score/f-table.md:535 · chapters/30-score/f-table.md:1440 |
| `V3-92` | 트림 만점이 개별 취향 축보다 큼 | run | `validate/v3_logic.py:178` | **★ 없음** | 없음 | guide/03_이력.md:452 · chapters/30-score/f-table.md:384 |
| `V3-93` | 제외 매물에 등급 문자가 안 붙음 | run | `validate/v3_logic.py:184` | **★ 없음** | 없음 | guide/03_이력.md:453 · chapters/30-score/f-table.md:345 |
| `V3-94` | 등급 컷이 규격의 8단계임 | run | `validate/v3_logic.py:189` | **★ 없음** | 없음 | guide/03_이력.md:453 · chapters/30-score/f-table.md:331 · chapters/30-score/f-table.md:346 |
| `V3-95` | 화면이 source='missing' 을 「없음」으로 안 냄 | run | `validate/v3_logic.py:166` | **★ 없음** | 없음 | guide/03_이력.md:455 · guide/07_밀린일대장.md:660 · chapters/30-score/f-table.md:433 |
| `V3-96` | value IS NULL 과 source 모름 건수 차 | run | `validate/v3_logic.py:172` | **★ 없음** | 없음 | guide/03_이력.md:455 · guide/07_밀린일대장.md:660 · chapters/30-score/f-table.md:434 |
...
| `V7-01` | watch_track 에 버전 4종 전건 있음 | run | `validate/v7_watch.py:45` | **★ 없음** | 없음 | guide/03_이력.md:159 · chapters/42-watch.md:618 |
| `V7-02` | cause != 'listing' 인 이벤트가 알림되지 않음 | run | `validate/v7_watch.py:49` | **★ 없음** | 없음 | chapters/42-watch.md:624 |
| `V7-04` | 같은 이벤트 중복 발송 0건 | run | `validate/v7_watch.py:53` | **★ 없음** | 없음 | trace/50-multisite.md:26 · chapters/42-watch.md:626 · chapters/50-multisite.md:126 |
| `V7-05` | gone 매물이 목록에서 삭제되지 않음 | run | `validate/v7_watch.py:55` | **★ 없음** | 없음 | chapters/42-watch.md:627 |
| `V7-06` | 검증 실패 실행에서 알림이 나가지 않음 | run | `validate/v7_watch.py:58` | **★ 없음** | 없음 | trace/50-multisite.md:23 · trace/RULES.md:293 · chapters/42-watch.md:628 |
| `V7-07` | relist 결합에 identity_kind 기록 | run | `validate/v7_watch.py:62` | **★ 없음** | 없음 | chapters/42-watch.md:629 |
| `V7-08` | 구매 체크리스트가 점수·등급에 반영되지 않음 | run | `validate/v7_watch.py:77` | **★ 없음** | 없음 | chapters/42-watch.md:630 |
| `V7-09` | 실구매가·총소유비용이 점수에 반영되지 않음 | run | `validate/v7_watch.py:93` | **★ 없음** | 없음 | chapters/42-watch.md:631 |
| `V7-10` | 발송 시도 대비 성공률 | run | `validate/v7_watch.py:65` | **★ 없음** | 없음 | trace/50-multisite.md:24 · trace/RULES.md:291 · trace/RULES.md:292 |
| `V7-11` | closed_reason 이 CHECK 안의 값 | run | `validate/v7_watch.py:73` | **★ 없음** | 없음 | trace/42-watch.md:37 · trace/42-watch.md:46 · trace/42-watch.md:47 |
| `V7-12` | 남의 관심 항목을 고치지 못함 | run | `validate/v7_watch.py:69` | **★ 없음** | 없음 | trace/14-web.md:113 · trace/42-watch.md:38 · trace/42-watch.md:39 |
| `V7-14` | 재등록 횟수가 화면에 나옴 | run | `validate/v7_watch.py:81` | **★ 없음** | 없음 | trace/42-watch.md:30 · guide/03_이력.md:374 · guide/03_이력.md:430 |
| `V7-15` | 진행 메모를 자유롭게 적을 수 있음 | run | `validate/v7_watch.py:86` | **★ 없음** | 없음 | trace/42-watch.md:68 · trace/42-watch.md:69 · trace/42-watch.md:70 |
...
| `V10-17` | admin 수가 0 이 되는 변경이 거부됨 | run | `validate/v10_admin.py:78` | **★ 없음** | 없음 | guide/03_이력.md:178 · guide/03_이력.md:215 · chapters/61-web.md:2000 |
...
| `V11-01` | web/ 에 SQL 문자열이 없음 | run | `validate/v11_web.py:40` | **★ 없음** | 없음 | guide/03_이력.md:161 · chapters/61-web.md:36 · chapters/61-web.md:1566 |
| `V11-02` | 기본 바인딩이 127.0.0.1 | run | `validate/v11_web.py:43` | **★ 없음** | 없음 | chapters/61-web.md:107 · chapters/61-web.md:2067 · chapters/61-web.md:2136 |
| `V11-03` | 전 Route 에 role 이 지정됨 | run | `validate/v11_web.py:47` | **★ 없음** | 없음 | chapters/61-web.md:175 · chapters/61-web.md:2137 |
| `V11-04` | 템플릿에 산술 연산이 없음 | run | `validate/v11_web.py:49` | **★ 없음** | 없음 | trace/RULES.md:163 · chapters/61-web.md:296 · chapters/61-web.md:2112 |
| `V11-05` | {{! }} 사용처가 화이트리스트에 있음 | run | `validate/v11_web.py:52` | **★ 없음** | 없음 | trace/RULES.md:163 · chapters/61-web.md:313 · chapters/61-web.md:2139 |
| `V11-06` | 정적 경로 탈출이 거부됨 | run | `validate/v11_web.py:57` | **★ 없음** | 없음 | trace/RULES.md:165 · trace/RULES.md:278 · chapters/61-web.md:418 |
| `V11-07` | 쿠키에 role 문자열이 없음 | run | `validate/v11_web.py:59` | **★ 없음** | 없음 | chapters/61-web.md:1365 · chapters/61-web.md:2141 |
| `V11-08` | 상태 변경이 GET 경로에 없음 | run | `validate/v11_web.py:61` | **★ 없음** | 없음 | chapters/61-web.md:1401 · chapters/61-web.md:2142 |
| `V11-09` | 미리보기 없이 저장이 안 됨 | run | `validate/v11_web.py:64` | **★ 없음** | 없음 | trace/RULES.md:68 · chapters/61-web.md:1429 · chapters/61-web.md:1920 |
| `V11-10` | 오류 화면에 스택 트레이스가 없음 | run | `validate/v11_web.py:66` | **★ 없음** | 없음 | chapters/61-web.md:1463 · chapters/61-web.md:2144 |
| `V11-11` | result_* 가 비었을 때 안내가 나옴 | run | `validate/v11_web.py:70` | **★ 없음** | 없음 | chapters/61-web.md:1492 · chapters/61-web.md:2145 |
...
| `V11-14` | 숫자 셀에 mono 가 걸려 있음 | run | `validate/v11_web.py:96` | **★ 없음** | 없음 | chapters/61-web.md:493 · chapters/61-web.md:2148 |
| `V11-15` | 화면이 빌드 산출물에 의존하지 않음 | run | `validate/v11_web.py:99` | **★ 없음** | 없음 | chapters/61-web.md:1308 · chapters/61-web.md:2149 |
| `V11-16` | /why 가 전 Component 를 냄 | run | `validate/v11_web.py:102` | **★ 없음** | 없음 | chapters/61-web.md:1514 · chapters/61-web.md:1589 · chapters/61-web.md:2150 |
| `V11-17` | /why 가 조회 상태 절을 냄 | run | `validate/v11_web.py:105` | **★ 없음** | 없음 | chapters/61-web.md:1589 · chapters/61-web.md:1643 · chapters/61-web.md:2151 |
| `V11-18` | 축 태그가 전건 필터 링크임 | run | `validate/v11_web.py:108` | **★ 없음** | 없음 | chapters/61-web.md:1687 · chapters/61-web.md:2152 |
| `V11-19` | 폴링 실패 시 화면이 안 깨짐 | run | `validate/v11_web.py:111` | **★ 없음** | 없음 | chapters/61-web.md:1707 · chapters/61-web.md:2153 |
| `V11-20` | 분모 표시가 있음 | run | `validate/v11_web.py:114` | **★ 없음** | 없음 | guide/03_이력.md:237 · chapters/61-web.md:1733 · chapters/61-web.md:2154 |
| `V11-21` | 행동 요청 파라미터가 현재 필터와 일치 | run | `validate/v11_web.py:117` | **★ 없음** | 없음 | chapters/61-web.md:1787 · chapters/61-web.md:2155 |
| `V11-22` | excluded 축이 「—/N」 으로 표시됨 | run | `validate/v11_web.py:120` | **★ 없음** | 없음 | chapters/61-web.md:1829 · chapters/61-web.md:2156 |
| `V11-23` | 비로그인 관심 POST 가 유도 화면을 냄 | run | `validate/v11_web.py:123` | **★ 없음** | 없음 | guide/03_이력.md:238 · chapters/61-web.md:1859 · chapters/61-web.md:2157 |
| `V11-24` | 메뉴 분류가 잠금 단위와 일치 | run | `validate/v11_web.py:126` | **★ 없음** | 없음 | chapters/61-web.md:1893 · chapters/61-web.md:2158 |
| `V11-25` | 사유 없이 설정이 저장되지 않음 | run | `validate/v11_web.py:130` | **★ 없음** | 없음 | chapters/61-web.md:1920 · chapters/61-web.md:2159 |
| `V11-26` | 되돌릴 수 없는 행동에 확인이 있음 | run | `validate/v11_web.py:133` | **★ 없음** | 없음 | chapters/61-web.md:1964 · chapters/61-web.md:2160 |
| `V11-27` | 가입 정책에 따라 화면이 바뀜 | run | `validate/v11_web.py:136` | **★ 없음** | 없음 | chapters/61-web.md:2021 · chapters/61-web.md:2161 |
| `V11-28` | 응답 헤더에 비 ASCII 없음 | run | `validate/v11_web.py:73` | **★ 없음** | 없음 | guide/03_이력.md:188 · chapters/61-web.md:1442 · chapters/61-web.md:2162 |
| `V11-29` | 렌더된 폼의 csrf_token 이 비어 있지 않음 | run | `validate/v11_web.py:77` | **★ 없음** | 없음 | guide/03_이력.md:189 · chapters/61-web.md:403 · chapters/61-web.md:2163 |
| `V11-30` | 시안 ↔ 템플릿 대조 통과 | run | `validate/v11_web.py:81` | **★ 없음** | 없음 | guide/03_이력.md:190 · chapters/61-web.md:358 · chapters/61-web.md:1542 |
| `V11-31` | must_change_secret=1 에서 /password 가 200 | run | `validate/v11_web.py:84` | **★ 없음** | 없음 | chapters/61-web.md:1386 · chapters/61-web.md:2165 |
| `V11-32` | known_issues 의 키가 전부 targets 에 있음 | run | `validate/v11_web.py:89` | **★ 없음** | 없음 | ref/B-config.md:377 · guide/03_이력.md:196 · chapters/61-web.md:2166 |
| `V11-33` | POST 가 저장 없이 성공 메시지를 내지 않음 | run | `validate/v11_web.py:139` | **★ 없음** | 없음 | guide/03_이력.md:220 · chapters/61-web.md:2045 · chapters/61-web.md:2167 |
| `V11-34` | 화면이 요청당 쿼리 상한을 넘지 않음 | run | `validate/v11_web.py:145` | **★ 없음** | 없음 | trace/41-view.md:22 · trace/41-view.md:70 · trace/RULES.md:164 |
| `V11-35` | 중첩 if 가 안쪽부터 닫힘 | run | `validate/v11_web.py:142` | **★ 없음** | 없음 | guide/03_이력.md:233 · chapters/61-web.md:1341 · chapters/61-web.md:2169 |
| `V11-36` | 잘못된 쿼리 파라미터가 500 을 내지 않음 | run | `validate/v11_web.py:149` | **★ 없음** | 없음 | guide/03_이력.md:235 · chapters/61-web.md:1350 · chapters/61-web.md:2170 |
...
| `V11-41` | 반입 뒤 S5~S10 이 이어서 돎 | run | `validate/v11_web.py:176` | **★ 없음** | 없음 | guide/03_이력.md:263 · chapters/61-web.md:2172 · chapters/60-admin/c-tools.md:213 |
| `V11-42` | S4 완료 행의 actual 이 'import' 임 | run | `validate/v11_web.py:627` | **★ 없음** | 없음 | guide/03_이력.md:264 · chapters/61-web.md:2173 · chapters/60-admin/c-tools.md:295 |
...
| `V11-55` | 목록에 전체 건수와 쪽이 표시됨 | run | `validate/v11_web.py:202` | **★ 없음** | 없음 | trace/14-web.md:62 · trace/41-view.md:63 · chapters/61-web.md:2185 |
| `V11-56` | 대표 사진 경로가 저장됨 | run | `validate/v11_web.py:207` | **★ 없음** | 없음 | chapters/61-web.md:554 · chapters/61-web.md:2186 |
| `V11-57` | 사진 없는 매물이 화면을 무너뜨리지 않음 | run | `validate/v11_web.py:211` | **★ 없음** | 없음 | guide/03_이력.md:293 · chapters/61-web.md:555 · chapters/61-web.md:2187 |
...
| `V11-61` | 이어질 수 있는 값이 링크임 | run | `validate/v11_web.py:228` | **★ 없음** | 없음 | trace/14-web.md:57 · guide/03_이력.md:295 · chapters/61-web.md:1209 |
| `V11-62` | 코드·줄임말에 title 이 있음 | run | `validate/v11_web.py:232` | **★ 없음** | 없음 | trace/14-web.md:58 · trace/14-web.md:126 · chapters/61-web.md:1210 |
| `V11-63` | 매물 화면에 원문 링크가 있음 | run | `validate/v11_web.py:236` | **★ 없음** | 없음 | trace/14-web.md:59 · guide/03_이력.md:481 · guide/03_이력.md:847 |
| `V11-64` | 고를 수 있는 값이 목록으로 제공됨 | run | `validate/v11_web.py:240` | **★ 없음** | 없음 | trace/14-web.md:123 · chapters/61-web.md:1248 · chapters/61-web.md:2193 |
| `V11-65` | 기본 정렬이 규격대로임 | run | `validate/v11_web.py:245` | **★ 없음** | 없음 | trace/14-web.md:61 · chapters/61-web.md:1269 · chapters/61-web.md:2194 |
| `V11-66` | 필터가 목록 위에 있음 | run | `validate/v11_web.py:249` | **★ 없음** | 없음 | trace/14-web.md:60 · chapters/61-web.md:1290 · chapters/61-web.md:2195 |
| `V11-67` | 단추가 켜짐·꺼짐을 오감 | run | `validate/v11_web.py:252` | **★ 없음** | 없음 | guide/03_이력.md:295 · chapters/61-web.md:1291 · chapters/61-web.md:2196 |
...
| `V11-96` | ♡ 가 제목 줄에 있음 | run | `validate/v11_web.py:423` | **★ 없음** | 없음 | trace/14-web.md:56 · guide/03_이력.md:324 · chapters/61-web.md:815 |
...
| `V11-102` | 비교가 옵션 차이만 냄 | run | `validate/v11_web.py:386` | **★ 없음** | 없음 | trace/14-web.md:115 · guide/03_이력.md:332 · chapters/61-web.md:727 |
...
| `V11-150` | 메뉴 라벨이 경로가 아님 | run | `validate/v11_web.py:521` | **★ 없음** | 없음 | guide/03_이력.md:416 · chapters/61-web.md:274 |
...
| `V11-157` | 상단 메뉴가 다섯을 넘지 않음 | run | `validate/v11_web.py:493` | **★ 없음** | 없음 | UI_REVIEW.md:1983 · UI_REVIEW.md:1986 · UI_REVIEW.md:1989 |
| `V11-158` | 내린 화면이 열리고 ★ 들어가는 문이 있음 | run | `validate/v11_web.py:499` | **★ 없음** | 없음 | UI_REVIEW.md:562 · UI_REVIEW.md:855 · guide/03_이력.md:565 |
| `V11-159` | 상세 11개 절이 규격 순서로 있음 | run | `validate/v11_web.py:452` | **★ 없음** | 없음 | CROSS_SITE_COMPARE.md:195 · ROADMAP_20260830.md:38 · UI_REVIEW.md:88 |
...
- `S46-171` 잣대가 화면을 적었는가 — `validate/v0_guide.py`
...
- `S46-181` 받아 둔 조사를 먼저 보는가 — `validate/v0_guide.py`
- `S46-182` 「전 사이트」를 사이트별로 열고 말했는가 — `validate/v0_guide.py`
- `S46-183` 「마스터 몫」 전에 내가 열었는가 — `validate/v0_guide.py`
- `S46-184` 「미조회」를 「없다」로 옮기지 않는가 — `validate/v0_guide.py`
- `S46-185` 원문 파일을 지우지 않는가 — `validate/v0_guide.py`
...
- `S46-213` 추천에 판매완료가 없는가 — `validate/v0_guide.py`
...
- `S46-227` 밝힌 없음에 안 준 것이 없는가 — `validate/v0_guide.py`
- `S46-229` recommend 로 거르는가 — `validate/v0_guide.py`
...
- `S46-240` DDL 색인이 DB 에 다 있는가 — `validate/v0_guide.py`
- `S46-241` 배포에서 재판정이 살아 있는가 — `validate/v0_guide.py`
- `S46-242` 시안에 「반드시 있는 것」 머리가 있는가 — `validate/v0_guide.py`
...
- `S46-260` 빈 쪽이 아니라 끝 신호로 멈추는가 — `validate/v0_guide.py`
...
- `S46-273` 엔카 배너가 마스터가 받은 것을 세는가 — `validate/v0_guide.py`
...
- `S46-296` 안 도는 파서가 없는가 — `validate/v0_guide.py`
- `S46-297` 한 판이 스스로 도는가 — `validate/v0_guide.py`
...
- `V0-01` 버전이 이력의 마지막 개정과 같은가 — `validate/v0_guide.py`
- `V0-02` 폐기 표시가 이력에 있는가 — `validate/v0_guide.py`
- `V0-03` 배점 숫자가 부록 F 밖에 있는가 — `validate/v0_guide.py`
...
- `V1-22` 사이트가 주는 것을 받아 쓰는가 — `validate/v0_guide.py`
...
- `V2-20` 원문이 ok 인데 DB 가 「못 받았다」인 줄 없음 — `validate/v2_load.py`
