...
| `S46-54` | 짝 중 등급이 두 칸 갈린 것 | warn | `validate/v0_guide.py:2152` | **★ 없음** | 없음 | CROSS_SITE_COMPARE.md:7 · CROSS_SITE_COMPARE.md:288 · CROSS_SITE_COMPARE.md:456 |
| `S46-55` | 짝 중 값이 30% 갈린 것 | warn | `validate/v0_guide.py:2177` | **★ 없음** | 없음 | CROSS_SITE_COMPARE.md:7 · CROSS_SITE_COMPARE.md:289 |
| `S46-56` | 짝 중 사고 판정이 갈린 것 | warn | `validate/v0_guide.py:2203` | **★ 없음** | 없음 | CROSS_SITE_COMPARE.md:7 · CROSS_SITE_COMPARE.md:290 |
...
| `S46-77` | KB 는 우리 20종만 받는가 | fatal | `validate/v0_guide.py:1860` | **★ 없음** | 없음 | guide/03_이력.md:1187 |
| `S46-78` | 엔카 전용 경로가 좁혀 있는가 | fatal | `validate/v0_guide.py:1916` | **★ 없음** | 없음 | guide/03_이력.md:771 |
| `S46-87` | 부른 주소가 그 매물의 사이트인가 | fatal | `validate/v0_guide.py:1958` | **★ 없음** | 없음 | guide/03_이력.md:772 · guide/03_이력.md:773 · guide/03_이력.md:855 |
| `S46-88` | 엔카가 막히면 화면이 까닭을 말하는가 | fatal | `validate/v0_guide.py:2035` | **★ 없음** | 없음 | guide/03_이력.md:773 |
| `S46-90` | 근거가 절반도 없는데 등급을 매기지 않는가 | fatal | `validate/v0_guide.py:2243` | **★ 없음** | 없음 | UI_REVIEW.md:1083 · guide/03_이력.md:780 |
| `S46-91` | 받은 원문이 저장까지 갔는가 | fatal | `validate/v0_guide.py:2350` | **★ 없음** | 없음 | guide/03_이력.md:781 · guide/06_오판대장.md:226 |
| `S46-92` | 브라우저 수집이 0건을 받았는가 | warn | `validate/v0_guide.py:3140` | **★ 없음** | 없음 | guide/03_이력.md:783 · guide/03_이력.md:784 |
| `S46-94` | 원문 문이 그 매물의 사이트로 가는가 | fatal | `validate/v0_guide.py:2306` | **★ 없음** | 없음 | guide/03_이력.md:787 · guide/06_오판대장.md:229 |
| `S46-95` | 배포된 화면이 다 열리는가 | fatal | `validate/v0_guide.py:3005` | **★ 없음** | 없음 | guide/03_이력.md:788 · guide/03_이력.md:789 · guide/03_이력.md:792 |
| `S46-96` | 사이트가 파는 차종인데 코드가 없는가 | warn | `validate/v0_guide.py:3061` | **★ 없음** | 없음 | ROADMAP_20260830.md:95 · guide/00_인수인계.md:154 · guide/03_이력.md:791 |
| `S46-97` | 원문이 source_id 로 매물에 이어지는가 | fatal | `validate/v0_guide.py:2422` | **★ 없음** | 없음 | guide/00_인수인계.md:134 · guide/03_이력.md:792 · guide/03_이력.md:879 |
...
| `S46-117` | 목록을 받는 수집기가 팔린 차를 거르는가 | fatal | `validate/v0_guide.py:1811` | **★ 없음** | 없음 | KCAR_API.md:151 · guide/03_이력.md:851 · guide/03_이력.md:855 |
...
| `S46-122` | 머리·발이 한 곳에만 있는가 | fatal | `validate/v0_guide.py:1605` | **★ 없음** | 없음 | UI_REVIEW.md:1546 · guide/03_이력.md:863 · guide/09_설계뒤에할것_20260829.md:101 |
| `S46-123` | 토스 표에 없는 색이 없는가 | fatal | `validate/v0_guide.py:1553` | **★ 없음** | 없음 | UI_REVIEW.md:1610 · guide/03_이력.md:863 · guide/03_이력.md:1368 |
| `S46-124` | DB 를 PRAGMA 없이 열지 않는가 | fatal | `validate/v0_guide.py:1741` | **★ 없음** | 없음 | VOLVO_SELEKT_API.md:513 · guide/03_이력.md:866 |
| `S46-125` | 고른 정렬 축이 정말 먹는가 | fatal | `validate/v0_guide.py:1397` | **★ 없음** | 없음 | guide/03_이력.md:868 |
| `S46-126` | 수집기가 통신·sleep 을 트랜잭션 밖에서 하는가 | fatal | `validate/v0_guide.py:1777` | **★ 없음** | 없음 | guide/03_이력.md:870 · guide/03_이력.md:935 · guide/06_오판대장.md:283 |
| `S46-127` | 수집기마다 화면이나 타이머가 있는가 | fatal | `validate/v0_guide.py:1693` | **★ 없음** | 없음 | guide/03_이력.md:1067 · guide/06_오판대장.md:259 · guide/07_밀린일대장.md:382 |
| `S46-128` | 묶어 쓰는 단계가 다른 쓰기에 창을 주는가 | fatal | `validate/v0_guide.py:1649` | **★ 없음** | 없음 | guide/06_오판대장.md:260 |
| `S46-129` | 표의 합이 맞는가 | fatal | `validate/v0_guide.py:3390` | **★ 없음** | 없음 | guide/03_이력.md:977 · guide/03_이력.md:987 · guide/06_오판대장.md:261 |
| `S46-130` | 합계표가 문서마다 하나인가 | fatal | `validate/v0_guide.py:3650` | **★ 없음** | 없음 | guide/03_이력.md:1001 · guide/06_오판대장.md:262 |
| `S46-131` | 「쪽넘김이 없다」에 실측이 있는가 | fatal | `validate/v0_guide.py:3534` | **★ 없음** | 없음 | guide/06_오판대장.md:263 · guide/07_밀린일대장.md:342 |
| `S46-132` | 인계문이 다시 재라고 적는가 | fatal | `validate/v0_guide.py:3422` | **★ 없음** | 없음 | guide/06_오판대장.md:264 |
| `S46-133` | 검사 구멍이 밀린일에 있는가 | fatal | `validate/v0_guide.py:3789` | **★ 없음** | 없음 | guide/06_오판대장.md:265 |
| `S46-134` | 질의와 규격이 어긋나지 않는가 | fatal | `validate/v0_guide.py:3667` | **★ 없음** | 없음 | guide/06_오판대장.md:266 |
| `S46-135` | 일반화에 표본이 있는가 | fatal | `validate/v0_guide.py:3556` | **★ 없음** | 없음 | guide/06_오판대장.md:267 |
| `S46-136` | 규격의 warn 수가 지금 값과 같은가 | fatal | `validate/v0_guide.py:3807` | **★ 없음** | 없음 | guide/06_오판대장.md:268 · guide/07_밀린일대장.md:343 |
| `S46-137` | 질의 열쇠를 읽는 코드가 있는가 | fatal | `validate/v0_guide.py:3829` | **★ 없음** | 없음 | guide/06_오판대장.md:269 |
| `S46-138` | 「전량」에 세는 법이 있는가 | fatal | `validate/v0_guide.py:3573` | **★ 없음** | 없음 | guide/03_이력.md:999 · guide/06_오판대장.md:270 |
| `S46-139` | 「칸이 비었다」에 전수가 있는가 | fatal | `validate/v0_guide.py:3858` | **★ 없음** | 없음 | guide/06_오판대장.md:271 |
| `S46-140` | 쓰는 호스트가 robots 문서에 있는가 | fatal | `validate/v0_guide.py:3436` | **★ 없음** | 없음 | guide/06_오판대장.md:272 · guide/07_밀린일대장.md:342 |
| `S46-141` | 거르개 판정에 실측이 있는가 | fatal | `validate/v0_guide.py:3693` | **★ 없음** | 없음 | guide/06_오판대장.md:273 |
| `S46-142` | 「N 사이트」가 config 와 같은가 | fatal | `validate/v0_guide.py:3455` | **★ 없음** | 없음 | guide/03_이력.md:1213 · guide/03_이력.md:1215 · guide/06_오판대장.md:274 |
| `S46-143` | 마스터께 올릴 것이 세어졌는가 | fatal | `validate/v0_guide.py:3710` | **★ 없음** | 없음 | guide/03_이력.md:1001 · guide/06_오판대장.md:275 |
| `S46-144` | 「비었다」가 ⑤·⑥·⑦ 로 갈렸는가 | fatal | `validate/v0_guide.py:3949` | **★ 없음** | 없음 | guide/03_이력.md:983 · guide/06_오판대장.md:276 · guide/12_남은것_20260829.md:15 |
| `S46-145` | 마스터께 드리는 표에 수의 뜻이 있는가 | fatal | `validate/v0_guide.py:3288` | **★ 없음** | 없음 | guide/03_이력.md:985 · guide/06_오판대장.md:277 |
| `S46-146` | 「안 준다」를 쓰며 파서를 봤는가 | fatal | `validate/v0_guide.py:3490` | **★ 없음** | 없음 | guide/03_이력.md:997 · guide/06_오판대장.md:278 |
| `S46-147` | 「안 준다」의 표본이 열 건인가 | fatal | `validate/v0_guide.py:3745` | **★ 없음** | 없음 | guide/05_가이드역할.md:1500 · guide/06_오판대장.md:279 · evidence/absence_20260829.md:6 |
| `S46-148` | 「축이 빈다」가 칼럼·파서를 짚는가 | fatal | `validate/v0_guide.py:3875` | **★ 없음** | 없음 | guide/03_이력.md:1001 · guide/03_이력.md:1215 · guide/06_오판대장.md:280 |
| `S46-149` | 자백이 닫혔는가 | fatal | `validate/v0_guide.py:3597` | **★ 없음** | 없음 | guide/06_오판대장.md:281 · guide/07_밀린일대장.md:343 |
| `S46-150` | 규격의 칼럼이 DDL 에 있는가 | fatal | `validate/v0_guide.py:3767` | **★ 없음** | 없음 | ROADMAP_20260830.md:65 · guide/06_오판대장.md:282 |
| `S46-152` | 마지막 개발 회차를 읽었는가 | fatal | `validate/v0_guide.py:3893` | **★ 없음** | 없음 | guide/03_이력.md:991 · guide/03_이력.md:1007 · guide/03_이력.md:1009 |
| `S46-153` | 「마스터 몫」이 진짜 마스터 몫인가 | fatal | `validate/v0_guide.py:3966` | **★ 없음** | 없음 | guide/03_이력.md:1007 · guide/03_이력.md:1009 · guide/06_오판대장.md:285 |
| `S46-154` | 마스터 말씀이 요구 추적표에 있는가 | fatal | `validate/v0_guide.py:3512` | **★ 없음** | 없음 | guide/01_요구사항.md:49 · guide/03_이력.md:1005 · guide/06_오판대장.md:286 |
| `S46-155` | 화면 규격마다 시안이 있는가 | fatal | `validate/v0_guide.py:3317` | **★ 없음** | 없음 | guide/03_이력.md:985 · guide/03_이력.md:1003 · guide/06_오판대장.md:287 |
| `S46-156` | 개발측 물음의 답이 규격에 있는가 | fatal | `validate/v0_guide.py:3624` | **★ 없음** | 없음 | guide/06_오판대장.md:288 |
| `S46-157` | 성능 판정에 시간이 있는가 | fatal | `validate/v0_guide.py:3998` | **★ 없음** | 없음 | guide/06_오판대장.md:289 |
| `S46-158` | 용량 판정에 수가 있는가 | fatal | `validate/v0_guide.py:4016` | **★ 없음** | 없음 | guide/06_오판대장.md:290 |
| `S46-159` | 설계도가 할 수 있는 것만 시키는가 | fatal | `validate/v0_guide.py:3930` | **★ 없음** | 없음 | guide/06_오판대장.md:291 · guide/07_밀린일대장.md:343 |
| `S46-160` | 전기차 누유가 만점·분모 910 인가 | fatal | `validate/v0_guide.py:4034` | **★ 없음** | 없음 | guide/03_이력.md:971 · guide/06_오판대장.md:292 · guide/06_오판대장.md:293 |
| `S46-161` | 「사이트가 안 준다」에 증거가 있는가 | fatal | `validate/v0_guide.py:3209` | **★ 없음** | 없음 | guide/03_이력.md:975 · guide/03_이력.md:977 · guide/03_이력.md:979 |
| `S46-162` | 오판이 약속한 검사가 실제로 있는가 | fatal | `validate/v0_guide.py:3258` | **★ 없음** | 없음 | guide/03_이력.md:977 · guide/03_이력.md:979 · guide/03_이력.md:985 |
| `S46-163` | 시안마다 라우팅 표에 주소가 있는가 | fatal | `validate/v0_guide.py:3350` | **★ 없음** | 없음 | guide/03_이력.md:985 · guide/03_이력.md:1003 · guide/03_이력.md:1243 |
| `S46-164` | 개발 회차의 「마스터 몫」에 답을 냈는가 | fatal | `validate/v0_guide.py:4051` | **★ 없음** | 없음 | guide/03_이력.md:991 · guide/06_오판대장.md:296 · guide/14_누가할것_20260829.md:39 |
| `S46-165` | 「못 잰다」가 진짜인가 | fatal | `validate/v0_guide.py:4085` | **★ 없음** | 없음 | guide/03_이력.md:1011 · guide/06_오판대장.md:297 · guide/06_오판대장.md:298 |
| `S46-166` | 마스터 확정이 장 규격에 닿았는가 | fatal | `validate/v0_guide.py:4126` | **★ 없음** | 없음 | ARCHITECTURE_20260830.md:8 · guide/03_이력.md:1017 · guide/06_오판대장.md:299 |
| `S46-168` | 검사가 예외를 수로 내는가 | fatal | `validate/v0_guide.py:4156` | **★ 없음** | 없음 | guide/03_이력.md:1037 · guide/03_이력.md:1067 · guide/03_이력.md:1240 |
| `S46-169` | 「왜 죽었는지」가 규격에 있는가 | fatal | `validate/v0_guide.py:4195` | **★ 없음** | 없음 | ARCHITECTURE_20260830.md:8 · ARCHITECTURE_20260830.md:148 · guide/03_이력.md:1045 |
| `S46-170` | 설계도가 하나인가 | fatal | `validate/v0_guide.py:4212` | **★ 없음** | 없음 | ARCHITECTURE_20260830.md:301 · guide/03_이력.md:1057 |
| `S46-171` | 잣대가 화면을 적었는가 | fatal | `validate/v0_guide.py:4230` | **★ 없음** | 없음 | guide/03_이력.md:1061 · guide/06_오판대장.md:301 |
| `S46-172` | 「없다」를 본문 낱말로 쟀는가 | fatal | `validate/v0_guide.py:4249` | **★ 없음** | 없음 | guide/03_이력.md:1075 · guide/06_오판대장.md:302 |
| `S46-173` | 규격이 창구를 적었는가 | fatal | `validate/v0_guide.py:4273` | **★ 없음** | 없음 | guide/03_이력.md:1077 · guide/06_오판대장.md:303 |
| `S46-174` | 「창구가 없다」를 열어 보고 적었는가 | fatal | `validate/v0_guide.py:4298` | **★ 없음** | 없음 | guide/03_이력.md:1081 · guide/06_오판대장.md:304 |
| `S46-175` | 점수를 「나머지 N」으로 뭉개지 않는가 | fatal | `validate/v0_guide.py:4325` | **★ 없음** | 없음 | guide/03_이력.md:1083 · guide/03_이력.md:1127 · guide/06_오판대장.md:305 |
| `S46-176` | 사이트 두드리기를 넘기지 않는가 | fatal | `validate/v0_guide.py:4358` | **★ 없음** | 없음 | guide/03_이력.md:1085 · guide/03_이력.md:1241 · guide/06_오판대장.md:306 |
| `S46-177` | 카탈로그를 site 로 가두지 않는가 | fatal | `validate/v0_guide.py:4386` | **★ 없음** | 없음 | guide/03_이력.md:1101 · chapters/30-score/f-table.md:1808 |
| `S46-178` | 목록이 주는 칸이 파서에 있는가 | fatal | `validate/v0_guide.py:4411` | **★ 없음** | 없음 | guide/03_이력.md:1101 · chapters/30-score/f-table.md:1832 |
| `S46-179` | 못 받은 축에 감점이 없는가 | fatal | `validate/v0_guide.py:4436` | **★ 없음** | 없음 | guide/03_이력.md:1111 · chapters/30-score/f-table.md:1955 |
| `S46-180` | 코드 표가 사이트마다 있는가 | fatal | `validate/v0_guide.py:4450` | **★ 없음** | 없음 | guide/03_이력.md:1113 · guide/03_이력.md:1127 · guide/06_오판대장.md:308 |
| `S46-181` | 받아 둔 조사를 먼저 보는가 | fatal | `validate/v0_guide.py:4477` | **★ 없음** | 없음 | CROSS_SITE_COMPARE.md:1076 · guide/03_이력.md:1115 · guide/06_오판대장.md:309 |
| `S46-182` | 「전 사이트」를 사이트별로 열고 말했는가 | fatal | `validate/v0_guide.py:4496` | **★ 없음** | 없음 | guide/03_이력.md:1123 · guide/06_오판대장.md:310 |
| `S46-183` | 「마스터 몫」 전에 내가 열었는가 | fatal | `validate/v0_guide.py:4524` | **★ 없음** | 없음 | guide/03_이력.md:1127 · guide/03_이력.md:1215 · guide/03_이력.md:1233 |
| `S46-184` | 「미조회」를 「없다」로 옮기지 않는가 | fatal | `validate/v0_guide.py:4553` | **★ 없음** | 없음 | guide/03_이력.md:1131 · guide/03_이력.md:1348 · guide/06_오판대장.md:312 |
| `S46-185` | 원문 파일을 지우지 않는가 | fatal | `validate/v0_guide.py:4586` | **★ 없음** | 없음 | ARCHITECTURE_20260830.md:386 · guide/03_이력.md:1133 · guide/03_이력.md:1274 |
| `S46-186` | 등급 분포를 보고 있는가 | fatal | `validate/v0_guide.py:4616` | **★ 없음** | 없음 | guide/06_오판대장.md:313 |
| `S46-187` | 값 곡선이 쌀수록 높은가 | fatal | `validate/v0_guide.py:4630` | **★ 없음** | 없음 | guide/03_이력.md:1141 · guide/06_오판대장.md:314 |
| `S46-188` | 「화면에 없다」를 열어 보고 적었는가 | fatal | `validate/v0_guide.py:4657` | **★ 없음** | 없음 | guide/06_오판대장.md:315 |
| `S46-191` | 차종별 예산이 원칙대로인가 | fatal | `validate/v0_guide.py:4681` | **★ 없음** | 없음 | guide/03_이력.md:1164 · guide/03_이력.md:1184 · guide/03_이력.md:1185 |
| `S46-192` | 선호차종이 등록부에 다 있는가 | fatal | `validate/v0_guide.py:4727` | **★ 없음** | 없음 | guide/03_이력.md:1166 |
| `S46-202` | 안 풀린 틀 문법이 없는가 | fatal | `validate/v0_guide.py:4752` | **★ 없음** | 없음 | RECOMMEND_SCREEN.md:399 · guide/03_이력.md:1186 |
| `S46-203` | 넣으라 한 사이트에 차종 열쇠가 있는가 | fatal | `validate/v0_guide.py:4862` | **★ 없음** | 없음 | guide/06_오판대장.md:317 |
| `S46-204` | 받기가 파일에 쓰는가 | fatal | `validate/v0_guide.py:4894` | **★ 없음** | 없음 | guide/03_이력.md:1189 · guide/03_이력.md:1270 · guide/06_오판대장.md:347 |
| `S46-205` | raw_response 에 넣으라 하지 않는가 | fatal | `validate/v0_guide.py:4922` | **★ 없음** | 없음 | guide/03_이력.md:1190 · guide/03_이력.md:1274 · guide/03_이력.md:1287 |
| `S46-206` | PDF 를 받아 두라 하지 않는가 | fatal | `validate/v0_guide.py:4957` | **★ 없음** | 없음 | guide/03_이력.md:1191 · guide/06_오판대장.md:320 · chapters/10-collect/d-policy.md:186 |
| `S46-207` | 커밋 제목이 사실을 말하는가 | fatal | `validate/v0_guide.py:5023` | **★ 없음** | 없음 | ROADMAP_20260830.md:66 · guide/03_이력.md:1193 · guide/03_이력.md:1215 |
| `S46-208` | 시세 축이 음수를 내지 않는가 | fatal | `validate/v0_guide.py:5061` | **★ 없음** | 없음 | guide/03_이력.md:1195 · guide/06_오판대장.md:321 · chapters/30-score/f-table.md:2673 |
| `S46-213` | 추천에 판매완료가 없는가 | fatal | `validate/v0_guide.py:4816` | **★ 없음** | 없음 | RECOMMEND_SCREEN.md:558 · guide/03_이력.md:1207 |
| `S46-214` | 사진 밑에 빈칸이 없는가 | fatal | `validate/v0_guide.py:5080` | **★ 없음** | 없음 | RECOMMEND_SCREEN.md:746 · UI_REVIEW.md:2035 · guide/03_이력.md:1210 |
| `S46-215` | 수집기가 active 를 보는가 | fatal | `validate/v0_guide.py:5105` | **★ 없음** | 없음 | guide/03_이력.md:1219 · guide/03_이력.md:1233 · chapters/10-collect/00-intro.md:651 |
| `S46-227` | 밝힌 없음에 안 준 것이 없는가 | fatal | `validate/v0_guide.py:4765` | **★ 없음** | 없음 | guide/03_이력.md:1228 · chapters/11-store/a-key.md:1109 |
| `S46-229` | recommend 로 거르는가 | fatal | `validate/v0_guide.py:5131` | **★ 없음** | 없음 | RECOMMEND_SCREEN.md:786 · guide/03_이력.md:1232 · guide/03_이력.md:1233 |
| `S46-230` | ④ 셈이 같은 판 안만 세는가 | fatal | `validate/v0_guide.py:5159` | **★ 없음** | 없음 | guide/03_이력.md:1234 · guide/03_이력.md:1240 · guide/07_밀린일대장.md:272 |
| `S46-231` | 매물 있는 사이트가 거르개에 다 있는가 | fatal | `validate/v0_guide.py:5189` | **★ 없음** | 없음 | guide/03_이력.md:1234 · guide/03_이력.md:1240 · guide/06_오판대장.md:330 |
| `S46-232` | 예산 곡선이 한계에서 0 인가 | fatal | `validate/v0_guide.py:5216` | **★ 없음** | 없음 | guide/03_이력.md:1235 |
| `S46-233` | 크기 축이 0점을 안 주는가 | fatal | `validate/v0_guide.py:5260` | **★ 없음** | 없음 | guide/03_이력.md:1235 · guide/03_이력.md:1239 · guide/06_오판대장.md:337 |
| `S46-234` | 매물 최다 사이트가 gone 을 매기는가 | fatal | `validate/v0_guide.py:5299` | **★ 없음** | 없음 | — |
| `S46-235` | 화면이 안 파는 것을 감추는가 | fatal | `validate/v0_guide.py:5331` | **★ 없음** | 없음 | — |
| `S46-236` | 내장색 축이 있고 기피가 0이 아닌가 | fatal | `validate/v0_guide.py:5464` | **★ 없음** | 없음 | guide/03_이력.md:1236 · guide/03_이력.md:1237 · guide/06_오판대장.md:334 |
| `S46-237` | 추천이 예산 안인가 | fatal | `validate/v0_guide.py:5432` | **★ 없음** | 없음 | — |
| `S46-238` | 트림이 신차가를 두 번 안 세는가 | fatal | `validate/v0_guide.py:5499` | **★ 없음** | 없음 | guide/03_이력.md:1236 |
| `S46-240` | DDL 색인이 DB 에 다 있는가 | fatal | `validate/v0_guide.py:5391` | **★ 없음** | 없음 | guide/03_이력.md:1238 |
| `S46-241` | 배포에서 재판정이 살아 있는가 | fatal | `validate/v0_guide.py:5522` | **★ 없음** | 없음 | guide/03_이력.md:1240 · guide/03_이력.md:1263 · guide/03_이력.md:1272 |
| `S46-242` | 시안에 「반드시 있는 것」 머리가 있는가 | fatal | `validate/v0_guide.py:5617` | **★ 없음** | 없음 | guide/03_이력.md:1241 |
| `S46-243` | 비는 자리가 까닭을 내는가 | fatal | `validate/v0_guide.py:5641` | **★ 없음** | 없음 | guide/03_이력.md:1241 |
| `S46-244` | 실패 응답도 원문으로 남는가 | fatal | `validate/v0_guide.py:5671` | **★ 없음** | 없음 | guide/03_이력.md:1242 |
| `S46-245` | 화면마다 그 화면에 드는 것이 있는가 | fatal | `validate/v0_guide.py:5691` | **★ 없음** | 없음 | guide/03_이력.md:1243 · guide/06_오판대장.md:338 · guide/07_밀린일대장.md:106 |
| `S46-246` | 화면마다 시안이 있는가 | fatal | `validate/v0_guide.py:5726` | **★ 없음** | 없음 | guide/03_이력.md:1243 · guide/06_오판대장.md:338 |
| `S46-247` | 사이트에 있는 것을 얼마나 받았나 | fatal | `validate/v0_guide.py:5832` | **★ 없음** | 없음 | guide/03_이력.md:1245 · guide/03_이력.md:1262 · guide/03_이력.md:1287 |
| `S46-248` | 등급이 현실을 가르는가 | fatal | `validate/v0_guide.py:5898` | **★ 없음** | 없음 | guide/03_이력.md:1244 |
| `S46-249` | 마스터 예산이 그대로인가 | fatal | `validate/v0_guide.py:5932` | **★ 없음** | 없음 | guide/03_이력.md:1244 |
| `S46-250` | 시안이 모양을 갖췄는가 | fatal | `validate/v0_guide.py:5961` | **★ 없음** | 없음 | guide/03_이력.md:1245 |
| `S46-251` | 사이트마다 차량 키가 붙는가 | fatal | `validate/v0_guide.py:5994` | **★ 없음** | 없음 | guide/03_이력.md:1247 |
| `S46-252` | 관리 쓰기가 정말 저장되는가 | fatal | `validate/v0_guide.py:6024` | **★ 없음** | 없음 | guide/03_이력.md:1248 · guide/03_이력.md:1274 · guide/03_이력.md:1371 |
| `S46-253` | 1부를 브라우저로 봤는가 | fatal | `validate/v0_guide.py:6056` | **★ 없음** | 없음 | — |
| `S46-254` | 짝지어진 차를 순위로 올리지 않는가 | fatal | `validate/v0_guide.py:6099` | **★ 없음** | 없음 | CROSS_SITE_COMPARE.md:188 · guide/03_이력.md:1250 · guide/03_이력.md:1251 |
| `S46-255` | 시험자 번호가 낱개로 있는가 | fatal | `validate/v0_guide.py:6133` | **★ 없음** | 없음 | guide/03_이력.md:1251 · guide/07_밀린일대장.md:179 |
| `S46-256` | 막혔다를 증거 없이 쓰지 않는가 | fatal | `validate/v0_guide.py:6434` | **★ 없음** | 없음 | guide/03_이력.md:1252 · guide/06_오판대장.md:341 · chapters/13-pipeline.md:290 |
| `S46-257` | 파이프라인이 엔카만 돌지 않는가 | fatal | `validate/v0_guide.py:6465` | **★ 없음** | 없음 | guide/03_이력.md:1253 · guide/03_이력.md:1274 · guide/06_오판대장.md:356 |
| `S46-258` | 판정 축 사전이 정해졌는가 | fatal | `validate/v0_guide.py:6587` | **★ 없음** | 없음 | guide/03_이력.md:1255 |
| `S46-259` | 마스터 차종 이름이 그대로인가 | fatal | `validate/v0_guide.py:6619` | **★ 없음** | 없음 | guide/03_이력.md:1256 · guide/03_이력.md:1257 · guide/06_오판대장.md:342 |
| `S46-260` | 빈 쪽이 아니라 끝 신호로 멈추는가 | fatal | `validate/v0_guide.py:6677` | **★ 없음** | 없음 | guide/03_이력.md:1258 · chapters/13-pipeline.md:334 |
| `S46-261` | 회차의 수와 배포의 수가 같은가 | fatal | `validate/v0_guide.py:6334` | **★ 없음** | 없음 | — |
| `S46-262` | 개발측 「여쭐 것」이 물렸는가 | fatal | `validate/v0_guide.py:6702` | **★ 없음** | 없음 | guide/03_이력.md:1261 · guide/03_이력.md:1262 · guide/03_이력.md:1333 |
| `S46-263` | 네 갈래 로직이 규격에 있는가 | fatal | `validate/v0_guide.py:6734` | **★ 없음** | 없음 | guide/03_이력.md:1265 · guide/03_이력.md:1266 · guide/03_이력.md:1267 |
| `S46-264` | 배포가 열려 있는가 | fatal | `validate/v0_guide.py:6773` | **★ 없음** | 없음 | guide/03_이력.md:1268 · guide/03_이력.md:1269 · guide/06_오판대장.md:346 |
| `S46-265` | 적재 뒤 raw_response 를 지우는가 | fatal | `validate/v0_guide.py:6816` | **★ 없음** | 없음 | guide/03_이력.md:1270 · guide/06_오판대장.md:347 · guide/07_밀린일대장.md:101 |
| `S46-266` | 이미 받은 상세를 다시 안 받는가 | fatal | `validate/v0_guide.py:6853` | **★ 없음** | 없음 | guide/03_이력.md:1271 · guide/07_밀린일대장.md:103 · chapters/10-collect/00-intro.md:516 |
| `S46-267` | 팔린 것을 대조하고 치우는가 | fatal | `validate/v0_guide.py:6875` | **★ 없음** | 없음 | guide/03_이력.md:1271 · guide/07_밀린일대장.md:105 · chapters/10-collect/00-intro.md:553 |
| `S46-268` | 지시문이 한 벌이고 지금 판인가 | fatal | `validate/v0_guide.py:6900` | **★ 없음** | 없음 | guide/03_이력.md:1273 · guide/03_이력.md:1317 · guide/03_이력.md:1359 |
| `S46-269` | 추천 차종과 단추 크기가 확정대로인가 | fatal | `validate/v0_guide.py:6955` | **★ 없음** | 없음 | guide/03_이력.md:1276 · guide/03_이력.md:1277 · guide/06_오판대장.md:355 |
| `S46-270` | 가려진 글자를 세는 자가 있는가 | fatal | `validate/v0_guide.py:7006` | **★ 없음** | 없음 | guide/03_이력.md:1279 · guide/06_오판대장.md:348 |
| `S46-271` | 화면을 브라우저로 열어 재는가 | fatal | `validate/v0_guide.py:7094` | **★ 없음** | 없음 | guide/03_이력.md:1280 · guide/03_이력.md:1281 · guide/03_이력.md:1287 |
| `S46-272` | 사진을 URL 로만 스무 장까지 두는가 | fatal | `validate/v0_guide.py:7154` | **★ 없음** | 없음 | guide/03_이력.md:1298 · chapters/10-collect/00-intro.md:495 |
| `S46-273` | 엔카 배너가 마스터가 받은 것을 세는가 | fatal | `validate/v0_guide.py:7184` | **★ 없음** | 없음 | guide/03_이력.md:1300 |
| `S46-274` | 기본 차례가 등급 > 값 > 추천인가 | fatal | `validate/v0_guide.py:7212` | **★ 없음** | 없음 | RECOMMEND_SCREEN.md:292 · guide/03_이력.md:1301 · guide/03_이력.md:1319 |
| `S46-275` | 축 점수를 저장하는가 | fatal | `validate/v0_guide.py:7258` | **★ 없음** | 없음 | guide/03_이력.md:1302 · guide/03_이력.md:1317 · guide/06_오판대장.md:350 |
| `S46-276` | 엔카 수집에 구멍이 없는가 | fatal | `validate/v0_guide.py:7288` | **★ 없음** | 없음 | guide/03_이력.md:1306 · guide/07_밀린일대장.md:13 |
| `S46-277` | 관리 질의가 조회를 막지 않는가 | fatal | `validate/v0_guide.py:7344` | **★ 없음** | 없음 | guide/03_이력.md:1307 · guide/03_이력.md:1315 · guide/07_밀린일대장.md:12 |
| `S46-278` | KB 가 막힌 응답도 남기는가 | fatal | `validate/v0_guide.py:7369` | **★ 없음** | 없음 | guide/03_이력.md:1309 · guide/07_밀린일대장.md:11 |
| `S46-279` | KB 값·항목·사진이 찼는가 | fatal | `validate/v0_guide.py:7408` | **★ 없음** | 없음 | guide/03_이력.md:1309 · guide/07_밀린일대장.md:14 |
| `S46-280` | 열두 사이트에 같은 구멍이 없는가 | fatal | `validate/v0_guide.py:7458` | **★ 없음** | 없음 | guide/03_이력.md:1310 · guide/07_밀린일대장.md:16 |
| `S46-281` | 이름만 있는 옵션도 받는가 | fatal | `validate/v0_guide.py:7515` | **★ 없음** | 없음 | guide/03_이력.md:1311 · chapters/11-store/a-key.md:83 |
| `S46-282` | 사이트별 매핑표가 있는가 | fatal | `validate/v0_guide.py:7542` | **★ 없음** | 없음 | guide/03_이력.md:1312 · guide/03_이력.md:1314 · guide/07_밀린일대장.md:15 |
| `S46-283` | 축 점수가 표에 실제로 차 있는가 | fatal | `validate/v0_guide.py:7038` | **★ 없음** | 없음 | RECOMMEND_SCREEN.md:140 · RECOMMEND_SCREEN.md:243 · guide/03_이력.md:1320 |
| `S46-284` | 작업 지시가 읽히는 꼴인가 | fatal | `validate/v0_guide.py:7620` | **★ 없음** | 없음 | guide/03_이력.md:1324 · guide/03_이력.md:1328 · guide/03_이력.md:1331 |
| `S46-285` | 마스터 대상 차종의 상세가 채워졌는가 | fatal | `validate/v0_guide.py:7686` | **★ 없음** | 없음 | guide/03_이력.md:1325 · guide/03_이력.md:1371 |
| `S46-286` | 취향 축 합이 165 인가 | fatal | `validate/v0_guide.py:7718` | **★ 없음** | 없음 | guide/03_이력.md:1329 |
| `S46-287` | 차종별 취향 고정값이 있는가 | fatal | `validate/v0_guide.py:7751` | **★ 없음** | 없음 | guide/03_이력.md:1329 · guide/03_이력.md:1333 · guide/03_이력.md:1334 |
...
| `S46-295` | 정비이력 하체 낱말이 다 있는가 | fatal | `validate/v0_guide.py:8048` | **★ 없음** | 없음 | guide/03_이력.md:1356 |
...
| `S46-299` | :root 변수가 값을 가지는가 | fatal | `validate/v0_guide.py:8211` | **★ 없음** | 없음 | guide/03_이력.md:1368 · guide/03_이력.md:1369 · guide/03_이력.md:1380 |
| `S46-300` | 첫 화면이 목록인가 | fatal | `validate/v0_guide.py:8263` | **★ 없음** | 없음 | guide/03_이력.md:1370 |
| `S46-301` | 탭 4 거르개가 설정에 있는가 | fatal | `validate/v0_guide.py:8283` | **★ 없음** | 없음 | — |
...
| `V1-22` | 사이트가 주는 것을 받아 쓰는가 | fatal | `validate/v0_guide.py:6249` | **★ 없음** | 없음 | trace/05-score.md:47 · guide/01_요구사항.md:159 · guide/01_요구사항.md:275 |
...
| `V10-17` | admin 수가 0 이 되는 변경이 거부됨 | run | `validate/v10_admin.py:78` | **★ 없음** | 없음 | guide/03_이력.md:178 · guide/03_이력.md:215 · chapters/61-web.md:2001 |
...
| `V11-01` | web/ 에 SQL 문자열이 없음 | run | `validate/v11_web.py:40` | **★ 없음** | 없음 | guide/03_이력.md:161 · chapters/61-web.md:36 · chapters/61-web.md:1567 |
| `V11-02` | 기본 바인딩이 127.0.0.1 | run | `validate/v11_web.py:43` | **★ 없음** | 없음 | chapters/61-web.md:107 · chapters/61-web.md:2068 · chapters/61-web.md:2137 |
| `V11-03` | 전 Route 에 role 이 지정됨 | run | `validate/v11_web.py:47` | **★ 없음** | 없음 | chapters/61-web.md:175 · chapters/61-web.md:2138 |
| `V11-04` | 템플릿에 산술 연산이 없음 | run | `validate/v11_web.py:49` | **★ 없음** | 없음 | trace/RULES.md:163 · chapters/61-web.md:297 · chapters/61-web.md:2113 |
| `V11-05` | {{! }} 사용처가 화이트리스트에 있음 | run | `validate/v11_web.py:52` | **★ 없음** | 없음 | trace/RULES.md:163 · chapters/61-web.md:314 · chapters/61-web.md:2140 |
| `V11-06` | 정적 경로 탈출이 거부됨 | run | `validate/v11_web.py:57` | **★ 없음** | 없음 | trace/RULES.md:165 · trace/RULES.md:278 · chapters/61-web.md:419 |
| `V11-07` | 쿠키에 role 문자열이 없음 | run | `validate/v11_web.py:59` | **★ 없음** | 없음 | chapters/61-web.md:1366 · chapters/61-web.md:2142 |
| `V11-08` | 상태 변경이 GET 경로에 없음 | run | `validate/v11_web.py:61` | **★ 없음** | 없음 | chapters/61-web.md:1402 · chapters/61-web.md:2143 |
| `V11-09` | 미리보기 없이 저장이 안 됨 | run | `validate/v11_web.py:64` | **★ 없음** | 없음 | trace/RULES.md:68 · chapters/61-web.md:1430 · chapters/61-web.md:1921 |
| `V11-10` | 오류 화면에 스택 트레이스가 없음 | run | `validate/v11_web.py:66` | **★ 없음** | 없음 | chapters/61-web.md:1464 · chapters/61-web.md:2145 |
| `V11-11` | result_* 가 비었을 때 안내가 나옴 | run | `validate/v11_web.py:70` | **★ 없음** | 없음 | chapters/61-web.md:1493 · chapters/61-web.md:2146 |
...
| `V11-14` | 숫자 셀에 mono 가 걸려 있음 | run | `validate/v11_web.py:96` | **★ 없음** | 없음 | chapters/61-web.md:494 · chapters/61-web.md:2149 |
| `V11-15` | 화면이 빌드 산출물에 의존하지 않음 | run | `validate/v11_web.py:99` | **★ 없음** | 없음 | chapters/61-web.md:1309 · chapters/61-web.md:2150 |
| `V11-16` | /why 가 전 Component 를 냄 | run | `validate/v11_web.py:102` | **★ 없음** | 없음 | chapters/61-web.md:1515 · chapters/61-web.md:1590 · chapters/61-web.md:2151 |
| `V11-17` | /why 가 조회 상태 절을 냄 | run | `validate/v11_web.py:105` | **★ 없음** | 없음 | chapters/61-web.md:1590 · chapters/61-web.md:1644 · chapters/61-web.md:2152 |
| `V11-18` | 축 태그가 전건 필터 링크임 | run | `validate/v11_web.py:108` | **★ 없음** | 없음 | chapters/61-web.md:1688 · chapters/61-web.md:2153 |
| `V11-19` | 폴링 실패 시 화면이 안 깨짐 | run | `validate/v11_web.py:111` | **★ 없음** | 없음 | chapters/61-web.md:1708 · chapters/61-web.md:2154 |
| `V11-20` | 분모 표시가 있음 | run | `validate/v11_web.py:114` | **★ 없음** | 없음 | guide/03_이력.md:237 · chapters/61-web.md:1734 · chapters/61-web.md:2155 |
| `V11-21` | 행동 요청 파라미터가 현재 필터와 일치 | run | `validate/v11_web.py:117` | **★ 없음** | 없음 | chapters/61-web.md:1788 · chapters/61-web.md:2156 |
| `V11-22` | excluded 축이 「—/N」 으로 표시됨 | run | `validate/v11_web.py:120` | **★ 없음** | 없음 | chapters/61-web.md:1830 · chapters/61-web.md:2157 |
| `V11-23` | 비로그인 관심 POST 가 유도 화면을 냄 | run | `validate/v11_web.py:123` | **★ 없음** | 없음 | guide/03_이력.md:238 · chapters/61-web.md:1860 · chapters/61-web.md:2158 |
| `V11-24` | 메뉴 분류가 잠금 단위와 일치 | run | `validate/v11_web.py:126` | **★ 없음** | 없음 | chapters/61-web.md:1894 · chapters/61-web.md:2159 |
| `V11-25` | 사유 없이 설정이 저장되지 않음 | run | `validate/v11_web.py:130` | **★ 없음** | 없음 | chapters/61-web.md:1921 · chapters/61-web.md:2160 |
| `V11-26` | 되돌릴 수 없는 행동에 확인이 있음 | run | `validate/v11_web.py:133` | **★ 없음** | 없음 | chapters/61-web.md:1965 · chapters/61-web.md:2161 |
| `V11-27` | 가입 정책에 따라 화면이 바뀜 | run | `validate/v11_web.py:136` | **★ 없음** | 없음 | chapters/61-web.md:2022 · chapters/61-web.md:2162 |
| `V11-28` | 응답 헤더에 비 ASCII 없음 | run | `validate/v11_web.py:73` | **★ 없음** | 없음 | guide/03_이력.md:188 · chapters/61-web.md:1443 · chapters/61-web.md:2163 |
| `V11-29` | 렌더된 폼의 csrf_token 이 비어 있지 않음 | run | `validate/v11_web.py:77` | **★ 없음** | 없음 | guide/03_이력.md:189 · chapters/61-web.md:404 · chapters/61-web.md:2164 |
| `V11-30` | 시안 ↔ 템플릿 대조 통과 | run | `validate/v11_web.py:81` | **★ 없음** | 없음 | guide/03_이력.md:190 · chapters/61-web.md:359 · chapters/61-web.md:1543 |
| `V11-31` | must_change_secret=1 에서 /password 가 200 | run | `validate/v11_web.py:84` | **★ 없음** | 없음 | chapters/61-web.md:1387 · chapters/61-web.md:2166 |
| `V11-32` | known_issues 의 키가 전부 targets 에 있음 | run | `validate/v11_web.py:89` | **★ 없음** | 없음 | ref/B-config.md:377 · guide/03_이력.md:196 · chapters/61-web.md:2167 |
| `V11-33` | POST 가 저장 없이 성공 메시지를 내지 않음 | run | `validate/v11_web.py:139` | **★ 없음** | 없음 | guide/03_이력.md:220 · chapters/61-web.md:2046 · chapters/61-web.md:2168 |
| `V11-34` | 화면이 요청당 쿼리 상한을 넘지 않음 | run | `validate/v11_web.py:145` | **★ 없음** | 없음 | trace/41-view.md:22 · trace/41-view.md:70 · trace/RULES.md:164 |
| `V11-35` | 중첩 if 가 안쪽부터 닫힘 | run | `validate/v11_web.py:142` | **★ 없음** | 없음 | guide/03_이력.md:233 · chapters/61-web.md:1342 · chapters/61-web.md:2170 |
| `V11-36` | 잘못된 쿼리 파라미터가 500 을 내지 않음 | run | `validate/v11_web.py:149` | **★ 없음** | 없음 | guide/03_이력.md:235 · chapters/61-web.md:1351 · chapters/61-web.md:2171 |
...
| `V11-41` | 반입 뒤 S5~S10 이 이어서 돎 | run | `validate/v11_web.py:176` | **★ 없음** | 없음 | guide/03_이력.md:263 · chapters/61-web.md:2173 · chapters/60-admin/c-tools.md:213 |
| `V11-42` | S4 완료 행의 actual 이 'import' 임 | run | `validate/v11_web.py:627` | **★ 없음** | 없음 | guide/03_이력.md:264 · chapters/61-web.md:2174 · chapters/60-admin/c-tools.md:295 |
...
| `V11-55` | 목록에 전체 건수와 쪽이 표시됨 | run | `validate/v11_web.py:202` | **★ 없음** | 없음 | trace/14-web.md:62 · trace/41-view.md:63 · chapters/61-web.md:2186 |
| `V11-56` | 대표 사진 경로가 저장됨 | run | `validate/v11_web.py:207` | **★ 없음** | 없음 | chapters/61-web.md:555 · chapters/61-web.md:2187 |
| `V11-57` | 사진 없는 매물이 화면을 무너뜨리지 않음 | run | `validate/v11_web.py:211` | **★ 없음** | 없음 | guide/03_이력.md:293 · chapters/61-web.md:556 · chapters/61-web.md:2188 |
...
| `V11-61` | 이어질 수 있는 값이 링크임 | run | `validate/v11_web.py:228` | **★ 없음** | 없음 | trace/14-web.md:57 · guide/03_이력.md:295 · chapters/61-web.md:1210 |
| `V11-62` | 코드·줄임말에 title 이 있음 | run | `validate/v11_web.py:232` | **★ 없음** | 없음 | trace/14-web.md:58 · trace/14-web.md:126 · chapters/61-web.md:1211 |
| `V11-63` | 매물 화면에 원문 링크가 있음 | run | `validate/v11_web.py:236` | **★ 없음** | 없음 | trace/14-web.md:59 · guide/03_이력.md:481 · guide/03_이력.md:847 |
| `V11-64` | 고를 수 있는 값이 목록으로 제공됨 | run | `validate/v11_web.py:240` | **★ 없음** | 없음 | trace/14-web.md:123 · chapters/61-web.md:1249 · chapters/61-web.md:2194 |
| `V11-65` | 기본 정렬이 규격대로임 | run | `validate/v11_web.py:245` | **★ 없음** | 없음 | trace/14-web.md:61 · chapters/61-web.md:1270 · chapters/61-web.md:2195 |
| `V11-66` | 필터가 목록 위에 있음 | run | `validate/v11_web.py:249` | **★ 없음** | 없음 | trace/14-web.md:60 · chapters/61-web.md:1291 · chapters/61-web.md:2196 |
| `V11-67` | 단추가 켜짐·꺼짐을 오감 | run | `validate/v11_web.py:252` | **★ 없음** | 없음 | guide/03_이력.md:295 · chapters/61-web.md:1292 · chapters/61-web.md:2197 |
...
| `V11-96` | ♡ 가 제목 줄에 있음 | run | `validate/v11_web.py:423` | **★ 없음** | 없음 | trace/14-web.md:56 · guide/03_이력.md:324 · chapters/61-web.md:816 |
...
| `V11-102` | 비교가 옵션 차이만 냄 | run | `validate/v11_web.py:386` | **★ 없음** | 없음 | trace/14-web.md:115 · guide/03_이력.md:332 · chapters/61-web.md:728 |
...
| `V11-150` | 메뉴 라벨이 경로가 아님 | run | `validate/v11_web.py:521` | **★ 없음** | 없음 | guide/03_이력.md:416 · chapters/61-web.md:275 |
...
- `S46-299` :root 변수가 값을 가지는가 — `validate/v0_guide.py`
- `S46-30` INDEX 가 docs 를 다 가리키는가 — `validate/v0_guide.py`
- `S46-300` 첫 화면이 목록인가 — `validate/v0_guide.py`
