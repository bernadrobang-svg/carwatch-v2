...
| `S44-4` | 명령서에 수집 범위가 있는가 | fatal | `validate/v0_guide.py:70` | **★ 없음** | 없음 | guide/03_이력.md:557 · guide/03_이력.md:558 · guide/06_오판대장.md:143 |
...
| `S46-40` | 「진행」인 요구의 문서가 바뀌었는가 | warn | `validate/v0_guide.py:833` | **★ 없음** | 없음 | guide/01_요구사항.md:67 · guide/03_이력.md:682 · guide/06_오판대장.md:180 |
| `S46-41` | 사이트 status 가 규격의 셋 안인가 | fatal | `validate/v0_guide.py:864` | **★ 없음** | 없음 | guide/06_오판대장.md:181 |
...
| `S46-54` | 짝 중 등급이 두 칸 갈린 것 | warn | `validate/v0_guide.py:1717` | **★ 없음** | 없음 | CROSS_SITE_COMPARE.md:7 · CROSS_SITE_COMPARE.md:254 |
| `S46-55` | 짝 중 값이 30% 갈린 것 | warn | `validate/v0_guide.py:1742` | **★ 없음** | 없음 | CROSS_SITE_COMPARE.md:7 · CROSS_SITE_COMPARE.md:255 |
| `S46-56` | 짝 중 사고 판정이 갈린 것 | warn | `validate/v0_guide.py:1768` | **★ 없음** | 없음 | CROSS_SITE_COMPARE.md:7 · CROSS_SITE_COMPARE.md:256 |
...
| `S46-75` | v4m 여덟 장 공통 규칙 | fatal | `validate/v0_guide.py:1206` | **★ 없음** | 없음 | guide/01_요구사항.md:114 · guide/03_이력.md:766 · guide/06_오판대장.md:217 |
| `S46-76` | 수집기가 원문을 남기는가 | fatal | `validate/v0_guide.py:1246` | **★ 없음** | 없음 | guide/01_요구사항.md:116 · guide/03_이력.md:770 · guide/03_이력.md:771 |
| `S46-77` | KB 는 우리 20종만 받는가 | fatal | `validate/v0_guide.py:1434` | **★ 없음** | 없음 | — |
| `S46-78` | 엔카 전용 경로가 좁혀 있는가 | fatal | `validate/v0_guide.py:1489` | **★ 없음** | 없음 | guide/03_이력.md:771 |
| `S46-87` | 부른 주소가 그 매물의 사이트인가 | fatal | `validate/v0_guide.py:1531` | **★ 없음** | 없음 | guide/03_이력.md:772 · guide/03_이력.md:773 · guide/03_이력.md:855 |
| `S46-88` | 엔카가 막히면 화면이 까닭을 말하는가 | fatal | `validate/v0_guide.py:1600` | **★ 없음** | 없음 | guide/03_이력.md:773 |
| `S46-90` | 근거가 절반도 없는데 등급을 매기지 않는가 | fatal | `validate/v0_guide.py:1808` | **★ 없음** | 없음 | UI_REVIEW.md:1082 · guide/03_이력.md:780 |
| `S46-91` | 받은 원문이 저장까지 갔는가 | fatal | `validate/v0_guide.py:1915` | **★ 없음** | 없음 | guide/03_이력.md:781 · guide/06_오판대장.md:224 |
| `S46-92` | 브라우저 수집이 0건을 받았는가 | warn | `validate/v0_guide.py:2654` | **★ 없음** | 없음 | guide/03_이력.md:783 · guide/03_이력.md:784 |
| `S46-94` | 원문 문이 그 매물의 사이트로 가는가 | fatal | `validate/v0_guide.py:1871` | **★ 없음** | 없음 | guide/03_이력.md:787 · guide/06_오판대장.md:227 |
| `S46-95` | 배포된 화면이 다 열리는가 | fatal | `validate/v0_guide.py:2558` | **★ 없음** | 없음 | guide/03_이력.md:788 · guide/03_이력.md:789 · guide/03_이력.md:792 |
| `S46-96` | 사이트가 파는 차종인데 코드가 없는가 | warn | `validate/v0_guide.py:2614` | **★ 없음** | 없음 | guide/03_이력.md:791 · guide/03_이력.md:860 · guide/04_질의.md:718 |
| `S46-97` | 원문이 source_id 로 매물에 이어지는가 | fatal | `validate/v0_guide.py:1987` | **★ 없음** | 없음 | guide/03_이력.md:792 · guide/09_인계_20260829.md:30 |
| `S46-98` | 시안의 낱말이 화면에 있는가 | fatal | `validate/v0_guide.py:2452` | **★ 없음** | 없음 | guide/03_이력.md:793 · guide/03_이력.md:794 · guide/03_이력.md:796 |
| `S46-99` | 로그인하면 관심·관리가 열리는가 | fatal | `validate/v0_guide.py:2055` | **★ 없음** | 없음 | guide/03_이력.md:794 |
| `S46-100` | 시안의 낱말 차례가 화면과 같은가 | fatal | `validate/v0_guide.py:2222` | **★ 없음** | 없음 | guide/03_이력.md:804 · guide/06_오판대장.md:236 |
| `S46-102` | 「전기만」에 전기 아닌 것이 없는가 | fatal | `validate/v0_guide.py:2359` | **★ 없음** | 없음 | UI_REVIEW.md:1133 · guide/03_이력.md:814 · guide/06_오판대장.md:238 |
| `S46-103` | 시안의 크기·자리 값을 담았는가 | fatal | `validate/v0_guide.py:2411` | **★ 없음** | 없음 | guide/03_이력.md:819 · guide/03_이력.md:847 · guide/06_오판대장.md:240 |
| `S46-115` | 시키는 화면이 스스로 안 바뀌는가 | fatal | `validate/v0_guide.py:1274` | **★ 없음** | 없음 | UI_REVIEW.md:1338 · guide/03_이력.md:850 |
| `S46-116` | 사유에 쉬운 말이 있는가 | fatal | `validate/v0_guide.py:1303` | **★ 없음** | 없음 | UI_REVIEW.md:1374 · guide/03_이력.md:850 |
| `S46-117` | 목록을 받는 수집기가 팔린 차를 거르는가 | fatal | `validate/v0_guide.py:1400` | **★ 없음** | 없음 | guide/03_이력.md:851 · guide/03_이력.md:855 · chapters/11-store/a-key.md:147 |
| `S46-120` | 등록부의 감사 열쇠가 목록 열쇠와 같은가 | fatal | `validate/v0_guide.py:1330` | **★ 없음** | 없음 | guide/03_이력.md:854 |
| `S46-126` | 수집기가 통신·sleep 을 트랜잭션 밖에서 하는가 | fatal | `validate/v0_guide.py:1366` | **★ 없음** | 없음 | guide/03_이력.md:870 · chapters/11-store/a-key.md:639 |
...
| `V2-01` | ok 원문 수 == CORE 행 수 | run | `validate/v2_load.py:26` | **★ 없음** | 없음 | trace/11-store.md:80 · guide/09_인계_20260829.md:30 · chapters/00-standard.md:362 |
...
| `V3-95` | 화면이 source='missing' 을 「없음」으로 안 냄 | run | `validate/v3_logic.py:166` | **★ 없음** | 없음 | guide/03_이력.md:455 · guide/07_밀린일대장.md:214 · chapters/30-score/f-table.md:424 |
| `V3-96` | value IS NULL 과 source 모름 건수 차 | run | `validate/v3_logic.py:172` | **★ 없음** | 없음 | guide/03_이력.md:455 · guide/07_밀린일대장.md:214 · chapters/30-score/f-table.md:425 |
