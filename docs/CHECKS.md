...
| `S7` | 매직 넘버 (V4-13) | fatal | `tools/check_src.py:448` | **★ 없음** | 없음 | ref/E-attach.md:67 · guide/03_이력.md:734 · guide/03_이력.md:1360 |
...
| `S46-54` | 짝 중 등급이 두 칸 갈린 것 | warn | `validate/v0_guide.py:2107` | **★ 없음** | 없음 | CROSS_SITE_COMPARE.md:7 · CROSS_SITE_COMPARE.md:288 · CROSS_SITE_COMPARE.md:456 |
| `S46-55` | 짝 중 값이 30% 갈린 것 | warn | `validate/v0_guide.py:2132` | **★ 없음** | 없음 | CROSS_SITE_COMPARE.md:7 · CROSS_SITE_COMPARE.md:289 |
| `S46-56` | 짝 중 사고 판정이 갈린 것 | warn | `validate/v0_guide.py:2158` | **★ 없음** | 없음 | CROSS_SITE_COMPARE.md:7 · CROSS_SITE_COMPARE.md:290 |
...
| `S46-68` | 관심이 모바일 기준 카드인가 | fatal | `validate/v0_guide.py:1155` | **★ 없음** | 없음 | UI_REVIEW.md:999 · guide/01_요구사항.md:111 · guide/03_이력.md:754 |
| `S46-74` | 한 쪽 장 수가 규격과 같은가 | fatal | `validate/v0_guide.py:1209` | **★ 없음** | 없음 | UI_REVIEW.md:1033 · guide/01_요구사항.md:114 · guide/03_이력.md:761 |
| `S46-75` | v4m 여덟 장 공통 규칙 | fatal | `validate/v0_guide.py:1255` | **★ 없음** | 없음 | guide/01_요구사항.md:116 · guide/03_이력.md:766 · guide/06_오판대장.md:219 |
| `S46-76` | 수집기가 원문을 남기는가 | fatal | `validate/v0_guide.py:1295` | **★ 없음** | 없음 | guide/01_요구사항.md:118 · guide/03_이력.md:770 · guide/03_이력.md:771 |
| `S46-77` | KB 는 우리 20종만 받는가 | fatal | `validate/v0_guide.py:1815` | **★ 없음** | 없음 | guide/03_이력.md:1241 |
| `S46-78` | 엔카 전용 경로가 좁혀 있는가 | fatal | `validate/v0_guide.py:1871` | **★ 없음** | 없음 | guide/03_이력.md:771 |
| `S46-87` | 부른 주소가 그 매물의 사이트인가 | fatal | `validate/v0_guide.py:1913` | **★ 없음** | 없음 | guide/03_이력.md:772 · guide/03_이력.md:773 · guide/03_이력.md:855 |
| `S46-88` | 엔카가 막히면 화면이 까닭을 말하는가 | fatal | `validate/v0_guide.py:1990` | **★ 없음** | 없음 | guide/03_이력.md:773 |
| `S46-90` | 근거가 절반도 없는데 등급을 매기지 않는가 | fatal | `validate/v0_guide.py:2198` | **★ 없음** | 없음 | UI_REVIEW.md:1083 · guide/03_이력.md:780 |
| `S46-91` | 받은 원문이 저장까지 갔는가 | fatal | `validate/v0_guide.py:2305` | **★ 없음** | 없음 | guide/03_이력.md:781 · guide/06_오판대장.md:226 |
| `S46-92` | 브라우저 수집이 0건을 받았는가 | warn | `validate/v0_guide.py:3095` | **★ 없음** | 없음 | guide/03_이력.md:783 · guide/03_이력.md:784 |
| `S46-94` | 원문 문이 그 매물의 사이트로 가는가 | fatal | `validate/v0_guide.py:2261` | **★ 없음** | 없음 | guide/03_이력.md:787 · guide/06_오판대장.md:229 |
| `S46-95` | 배포된 화면이 다 열리는가 | fatal | `validate/v0_guide.py:2960` | **★ 없음** | 없음 | guide/03_이력.md:788 · guide/03_이력.md:789 · guide/03_이력.md:792 |
| `S46-96` | 사이트가 파는 차종인데 코드가 없는가 | warn | `validate/v0_guide.py:3016` | **★ 없음** | 없음 | ROADMAP_20260830.md:95 · guide/00_인수인계.md:154 · guide/03_이력.md:791 |
| `S46-97` | 원문이 source_id 로 매물에 이어지는가 | fatal | `validate/v0_guide.py:2377` | **★ 없음** | 없음 | guide/00_인수인계.md:134 · guide/03_이력.md:792 · guide/03_이력.md:879 |
| `S46-98` | 시안의 낱말이 화면에 있는가 | fatal | `validate/v0_guide.py:2842` | **★ 없음** | 없음 | RECOMMEND_SCREEN.md:358 · UI_REVIEW.md:1881 · guide/03_이력.md:793 |
| `S46-99` | 로그인하면 관심·관리가 열리는가 | fatal | `validate/v0_guide.py:2445` | **★ 없음** | 없음 | guide/03_이력.md:794 · guide/03_이력.md:879 · guide/03_이력.md:1009 |
| `S46-100` | 시안의 낱말 차례가 화면과 같은가 | fatal | `validate/v0_guide.py:2612` | **★ 없음** | 없음 | RECOMMEND_SCREEN.md:358 · guide/03_이력.md:804 · guide/03_이력.md:879 |
| `S46-102` | 「전기만」에 전기 아닌 것이 없는가 | fatal | `validate/v0_guide.py:2749` | **★ 없음** | 없음 | UI_REVIEW.md:1134 · guide/03_이력.md:814 · guide/06_오판대장.md:240 |
| `S46-103` | 시안의 크기·자리 값을 담았는가 | fatal | `validate/v0_guide.py:2801` | **★ 없음** | 없음 | guide/03_이력.md:819 · guide/03_이력.md:847 · guide/06_오판대장.md:242 |
| `S46-115` | 시키는 화면이 스스로 안 바뀌는가 | fatal | `validate/v0_guide.py:1333` | **★ 없음** | 없음 | UI_REVIEW.md:1339 · guide/03_이력.md:850 |
| `S46-116` | 사유에 쉬운 말이 있는가 | fatal | `validate/v0_guide.py:1455` | **★ 없음** | 없음 | UI_REVIEW.md:1375 · guide/03_이력.md:850 |
| `S46-117` | 목록을 받는 수집기가 팔린 차를 거르는가 | fatal | `validate/v0_guide.py:1766` | **★ 없음** | 없음 | KCAR_API.md:151 · guide/03_이력.md:851 · guide/03_이력.md:855 |
| `S46-118` | 하트가 자기 카드 안에 앉는가 | fatal | `validate/v0_guide.py:1393` | **★ 없음** | 없음 | UI_REVIEW.md:1430 · guide/03_이력.md:852 |
| `S46-120` | 등록부의 감사 열쇠가 목록 열쇠와 같은가 | fatal | `validate/v0_guide.py:1482` | **★ 없음** | 없음 | guide/03_이력.md:854 |
| `S46-121` | 머리띠 규칙이 한 곳에만 있는가 | fatal | `validate/v0_guide.py:1433` | **★ 없음** | 없음 | UI_REVIEW.md:1511 · guide/03_이력.md:862 · guide/09_설계뒤에할것_20260829.md:102 |
| `S46-122` | 머리·발이 한 곳에만 있는가 | fatal | `validate/v0_guide.py:1560` | **★ 없음** | 없음 | UI_REVIEW.md:1546 · guide/03_이력.md:863 · guide/09_설계뒤에할것_20260829.md:101 |
| `S46-123` | 토스 표에 없는 색이 없는가 | fatal | `validate/v0_guide.py:1518` | **★ 없음** | 없음 | UI_REVIEW.md:1610 · guide/03_이력.md:863 · guide/03_이력.md:1394 |
| `S46-124` | DB 를 PRAGMA 없이 열지 않는가 | fatal | `validate/v0_guide.py:1696` | **★ 없음** | 없음 | VOLVO_SELEKT_API.md:513 · guide/03_이력.md:866 |
| `S46-125` | 고른 정렬 축이 정말 먹는가 | fatal | `validate/v0_guide.py:1362` | **★ 없음** | 없음 | guide/03_이력.md:868 |
| `S46-126` | 수집기가 통신·sleep 을 트랜잭션 밖에서 하는가 | fatal | `validate/v0_guide.py:1732` | **★ 없음** | 없음 | guide/03_이력.md:870 · guide/03_이력.md:935 · guide/06_오판대장.md:283 |
| `S46-127` | 수집기마다 화면이나 타이머가 있는가 | fatal | `validate/v0_guide.py:1648` | **★ 없음** | 없음 | guide/03_이력.md:1067 · guide/06_오판대장.md:259 · guide/07_밀린일대장.md:382 |
| `S46-128` | 묶어 쓰는 단계가 다른 쓰기에 창을 주는가 | fatal | `validate/v0_guide.py:1604` | **★ 없음** | 없음 | guide/06_오판대장.md:260 |
| `S46-129` | 표의 합이 맞는가 | fatal | `validate/v0_guide.py:3345` | **★ 없음** | 없음 | guide/03_이력.md:977 · guide/03_이력.md:987 · guide/06_오판대장.md:261 |
| `S46-130` | 합계표가 문서마다 하나인가 | fatal | `validate/v0_guide.py:3605` | **★ 없음** | 없음 | guide/03_이력.md:1001 · guide/06_오판대장.md:262 |
| `S46-131` | 「쪽넘김이 없다」에 실측이 있는가 | fatal | `validate/v0_guide.py:3489` | **★ 없음** | 없음 | guide/06_오판대장.md:263 · guide/07_밀린일대장.md:342 |
| `S46-132` | 인계문이 다시 재라고 적는가 | fatal | `validate/v0_guide.py:3377` | **★ 없음** | 없음 | guide/06_오판대장.md:264 |
| `S46-133` | 검사 구멍이 밀린일에 있는가 | fatal | `validate/v0_guide.py:3744` | **★ 없음** | 없음 | guide/06_오판대장.md:265 |
| `S46-134` | 질의와 규격이 어긋나지 않는가 | fatal | `validate/v0_guide.py:3622` | **★ 없음** | 없음 | guide/06_오판대장.md:266 |
| `S46-135` | 일반화에 표본이 있는가 | fatal | `validate/v0_guide.py:3511` | **★ 없음** | 없음 | guide/06_오판대장.md:267 |
| `S46-136` | 규격의 warn 수가 지금 값과 같은가 | fatal | `validate/v0_guide.py:3762` | **★ 없음** | 없음 | guide/06_오판대장.md:268 · guide/07_밀린일대장.md:343 |
| `S46-137` | 질의 열쇠를 읽는 코드가 있는가 | fatal | `validate/v0_guide.py:3784` | **★ 없음** | 없음 | guide/06_오판대장.md:269 |
| `S46-138` | 「전량」에 세는 법이 있는가 | fatal | `validate/v0_guide.py:3528` | **★ 없음** | 없음 | guide/03_이력.md:999 · guide/06_오판대장.md:270 |
| `S46-139` | 「칸이 비었다」에 전수가 있는가 | fatal | `validate/v0_guide.py:3813` | **★ 없음** | 없음 | guide/06_오판대장.md:271 |
| `S46-140` | 쓰는 호스트가 robots 문서에 있는가 | fatal | `validate/v0_guide.py:3391` | **★ 없음** | 없음 | guide/06_오판대장.md:272 · guide/07_밀린일대장.md:342 |
| `S46-141` | 거르개 판정에 실측이 있는가 | fatal | `validate/v0_guide.py:3648` | **★ 없음** | 없음 | guide/06_오판대장.md:273 |
| `S46-142` | 「N 사이트」가 config 와 같은가 | fatal | `validate/v0_guide.py:3410` | **★ 없음** | 없음 | guide/03_이력.md:1299 · guide/03_이력.md:1303 · guide/06_오판대장.md:274 |
| `S46-143` | 마스터께 올릴 것이 세어졌는가 | fatal | `validate/v0_guide.py:3665` | **★ 없음** | 없음 | guide/03_이력.md:1001 · guide/06_오판대장.md:275 |
| `S46-144` | 「비었다」가 ⑤·⑥·⑦ 로 갈렸는가 | fatal | `validate/v0_guide.py:3900` | **★ 없음** | 없음 | guide/03_이력.md:983 · guide/06_오판대장.md:276 · guide/12_남은것_20260829.md:15 |
| `S46-145` | 마스터께 드리는 표에 수의 뜻이 있는가 | fatal | `validate/v0_guide.py:3243` | **★ 없음** | 없음 | guide/03_이력.md:985 · guide/06_오판대장.md:277 |
| `S46-146` | 「안 준다」를 쓰며 파서를 봤는가 | fatal | `validate/v0_guide.py:3445` | **★ 없음** | 없음 | guide/03_이력.md:997 · guide/06_오판대장.md:278 |
| `S46-147` | 「안 준다」의 표본이 열 건인가 | fatal | `validate/v0_guide.py:3700` | **★ 없음** | 없음 | guide/05_가이드역할.md:1500 · guide/06_오판대장.md:279 · evidence/absence_20260829.md:6 |
| `S46-148` | 「축이 빈다」가 칼럼·파서를 짚는가 | fatal | `validate/v0_guide.py:3830` | **★ 없음** | 없음 | guide/03_이력.md:1001 · guide/03_이력.md:1303 · guide/06_오판대장.md:280 |
| `S46-149` | 자백이 닫혔는가 | fatal | `validate/v0_guide.py:3552` | **★ 없음** | 없음 | guide/06_오판대장.md:281 · guide/07_밀린일대장.md:343 |
| `S46-150` | 규격의 칼럼이 DDL 에 있는가 | fatal | `validate/v0_guide.py:3722` | **★ 없음** | 없음 | ROADMAP_20260830.md:65 · guide/06_오판대장.md:282 |
| `S46-152` | 마지막 개발 회차를 읽었는가 | fatal | `validate/v0_guide.py:3848` | **★ 없음** | 없음 | guide/03_이력.md:991 · guide/03_이력.md:1007 · guide/03_이력.md:1009 |
| `S46-153` | 「마스터 몫」이 진짜 마스터 몫인가 | fatal | `validate/v0_guide.py:3917` | **★ 없음** | 없음 | guide/03_이력.md:1007 · guide/03_이력.md:1009 · guide/06_오판대장.md:285 |
| `S46-154` | 마스터 말씀이 요구 추적표에 있는가 | fatal | `validate/v0_guide.py:3467` | **★ 없음** | 없음 | guide/01_요구사항.md:49 · guide/03_이력.md:1005 · guide/06_오판대장.md:286 |
| `S46-155` | 화면 규격마다 시안이 있는가 | fatal | `validate/v0_guide.py:3272` | **★ 없음** | 없음 | guide/03_이력.md:985 · guide/03_이력.md:1003 · guide/06_오판대장.md:287 |
| `S46-156` | 개발측 물음의 답이 규격에 있는가 | fatal | `validate/v0_guide.py:3579` | **★ 없음** | 없음 | guide/06_오판대장.md:288 |
| `S46-157` | 성능 판정에 시간이 있는가 | fatal | `validate/v0_guide.py:3949` | **★ 없음** | 없음 | guide/06_오판대장.md:289 |
| `S46-158` | 용량 판정에 수가 있는가 | fatal | `validate/v0_guide.py:3967` | **★ 없음** | 없음 | guide/06_오판대장.md:290 |
| `S46-159` | 설계도가 할 수 있는 것만 시키는가 | fatal | `validate/v0_guide.py:3881` | **★ 없음** | 없음 | guide/06_오판대장.md:291 · guide/07_밀린일대장.md:343 |
| `S46-160` | 전기차 누유가 만점·분모 910 인가 | fatal | `validate/v0_guide.py:3985` | **★ 없음** | 없음 | guide/03_이력.md:971 · guide/06_오판대장.md:292 · guide/06_오판대장.md:293 |
| `S46-161` | 「사이트가 안 준다」에 증거가 있는가 | fatal | `validate/v0_guide.py:3164` | **★ 없음** | 없음 | guide/03_이력.md:975 · guide/03_이력.md:977 · guide/03_이력.md:979 |
| `S46-162` | 오판이 약속한 검사가 실제로 있는가 | fatal | `validate/v0_guide.py:3213` | **★ 없음** | 없음 | guide/03_이력.md:977 · guide/03_이력.md:979 · guide/03_이력.md:985 |
| `S46-163` | 시안마다 라우팅 표에 주소가 있는가 | fatal | `validate/v0_guide.py:3305` | **★ 없음** | 없음 | guide/03_이력.md:985 · guide/03_이력.md:1003 · guide/03_이력.md:1349 |
| `S46-164` | 개발 회차의 「마스터 몫」에 답을 냈는가 | fatal | `validate/v0_guide.py:4002` | **★ 없음** | 없음 | guide/03_이력.md:991 · guide/06_오판대장.md:296 · guide/14_누가할것_20260829.md:39 |
| `S46-165` | 「못 잰다」가 진짜인가 | fatal | `validate/v0_guide.py:4036` | **★ 없음** | 없음 | guide/03_이력.md:1011 · guide/06_오판대장.md:297 · guide/06_오판대장.md:298 |
| `S46-166` | 마스터 확정이 장 규격에 닿았는가 | fatal | `validate/v0_guide.py:4077` | **★ 없음** | 없음 | ARCHITECTURE_20260830.md:8 · guide/03_이력.md:1017 · guide/06_오판대장.md:299 |
| `S46-168` | 검사가 예외를 수로 내는가 | fatal | `validate/v0_guide.py:4107` | **★ 없음** | 없음 | guide/03_이력.md:1037 · guide/03_이력.md:1067 · guide/03_이력.md:1346 |
| `S46-169` | 「왜 죽었는지」가 규격에 있는가 | fatal | `validate/v0_guide.py:4146` | **★ 없음** | 없음 | ARCHITECTURE_20260830.md:8 · ARCHITECTURE_20260830.md:148 · guide/03_이력.md:1045 |
| `S46-170` | 설계도가 하나인가 | fatal | `validate/v0_guide.py:4163` | **★ 없음** | 없음 | ARCHITECTURE_20260830.md:301 · guide/03_이력.md:1057 |
| `S46-171` | 잣대가 화면을 적었는가 | fatal | `validate/v0_guide.py:4181` | **★ 없음** | 없음 | guide/03_이력.md:1061 · guide/06_오판대장.md:301 |
| `S46-172` | 「없다」를 본문 낱말로 쟀는가 | fatal | `validate/v0_guide.py:4200` | **★ 없음** | 없음 | guide/03_이력.md:1075 · guide/06_오판대장.md:302 |
| `S46-173` | 규격이 창구를 적었는가 | fatal | `validate/v0_guide.py:4224` | **★ 없음** | 없음 | guide/03_이력.md:1077 · guide/06_오판대장.md:303 |
| `S46-174` | 「창구가 없다」를 열어 보고 적었는가 | fatal | `validate/v0_guide.py:4249` | **★ 없음** | 없음 | guide/03_이력.md:1081 · guide/06_오판대장.md:304 |
| `S46-175` | 점수를 「나머지 N」으로 뭉개지 않는가 | fatal | `validate/v0_guide.py:4276` | **★ 없음** | 없음 | guide/03_이력.md:1083 · guide/03_이력.md:1127 · guide/06_오판대장.md:305 |
| `S46-176` | 사이트 두드리기를 넘기지 않는가 | fatal | `validate/v0_guide.py:4309` | **★ 없음** | 없음 | guide/03_이력.md:1085 · guide/03_이력.md:1347 · guide/06_오판대장.md:306 |
| `S46-177` | 카탈로그를 site 로 가두지 않는가 | fatal | `validate/v0_guide.py:4337` | **★ 없음** | 없음 | guide/03_이력.md:1101 · chapters/30-score/f-table.md:1808 |
| `S46-178` | 목록이 주는 칸이 파서에 있는가 | fatal | `validate/v0_guide.py:4362` | **★ 없음** | 없음 | guide/03_이력.md:1101 · chapters/30-score/f-table.md:1832 |
| `S46-179` | 못 받은 축에 감점이 없는가 | fatal | `validate/v0_guide.py:4387` | **★ 없음** | 없음 | guide/03_이력.md:1111 · chapters/30-score/f-table.md:1955 |
| `S46-180` | 코드 표가 사이트마다 있는가 | fatal | `validate/v0_guide.py:4401` | **★ 없음** | 없음 | guide/03_이력.md:1113 · guide/03_이력.md:1127 · guide/06_오판대장.md:308 |
| `S46-181` | 받아 둔 조사를 먼저 보는가 | fatal | `validate/v0_guide.py:4428` | **★ 없음** | 없음 | CROSS_SITE_COMPARE.md:1076 · guide/03_이력.md:1115 · guide/06_오판대장.md:309 |
| `S46-182` | 「전 사이트」를 사이트별로 열고 말했는가 | fatal | `validate/v0_guide.py:4447` | **★ 없음** | 없음 | guide/03_이력.md:1123 · guide/06_오판대장.md:310 |
| `S46-183` | 「마스터 몫」 전에 내가 열었는가 | fatal | `validate/v0_guide.py:4475` | **★ 없음** | 없음 | guide/03_이력.md:1127 · guide/03_이력.md:1303 · guide/03_이력.md:1339 |
| `S46-184` | 「미조회」를 「없다」로 옮기지 않는가 | fatal | `validate/v0_guide.py:4504` | **★ 없음** | 없음 | guide/03_이력.md:1131 · guide/03_이력.md:1200 · guide/06_오판대장.md:312 |
| `S46-185` | 원문 파일을 지우지 않는가 | fatal | `validate/v0_guide.py:4537` | **★ 없음** | 없음 | ARCHITECTURE_20260830.md:386 · guide/03_이력.md:1133 · guide/03_이력.md:1380 |
| `S46-186` | 등급 분포를 보고 있는가 | fatal | `validate/v0_guide.py:4567` | **★ 없음** | 없음 | guide/06_오판대장.md:313 |
| `S46-187` | 값 곡선이 쌀수록 높은가 | fatal | `validate/v0_guide.py:4581` | **★ 없음** | 없음 | guide/03_이력.md:1141 · guide/06_오판대장.md:314 |
| `S46-188` | 「화면에 없다」를 열어 보고 적었는가 | fatal | `validate/v0_guide.py:4608` | **★ 없음** | 없음 | guide/06_오판대장.md:315 |
| `S46-191` | 차종별 예산이 원칙대로인가 | fatal | `validate/v0_guide.py:4632` | **★ 없음** | 없음 | guide/03_이력.md:1175 · guide/03_이력.md:1235 · guide/03_이력.md:1237 |
| `S46-192` | 선호차종이 등록부에 다 있는가 | fatal | `validate/v0_guide.py:4678` | **★ 없음** | 없음 | guide/03_이력.md:1179 |
| `S46-202` | 안 풀린 틀 문법이 없는가 | fatal | `validate/v0_guide.py:4703` | **★ 없음** | 없음 | RECOMMEND_SCREEN.md:399 · guide/03_이력.md:1239 |
| `S46-203` | 넣으라 한 사이트에 차종 열쇠가 있는가 | fatal | `validate/v0_guide.py:4813` | **★ 없음** | 없음 | guide/03_이력.md:1243 · guide/06_오판대장.md:317 |
| `S46-204` | 받기가 파일에 쓰는가 | fatal | `validate/v0_guide.py:4845` | **★ 없음** | 없음 | guide/03_이력.md:1247 · guide/03_이력.md:1376 · guide/06_오판대장.md:347 |
| `S46-205` | raw_response 에 넣으라 하지 않는가 | fatal | `validate/v0_guide.py:4873` | **★ 없음** | 없음 | guide/03_이력.md:1249 · guide/03_이력.md:1380 · guide/03_이력.md:1393 |
| `S46-206` | PDF 를 받아 두라 하지 않는가 | fatal | `validate/v0_guide.py:4908` | **★ 없음** | 없음 | guide/03_이력.md:1251 · guide/06_오판대장.md:320 · chapters/10-collect/d-policy.md:186 |
| `S46-207` | 커밋 제목이 사실을 말하는가 | fatal | `validate/v0_guide.py:4974` | **★ 없음** | 없음 | ROADMAP_20260830.md:66 · guide/03_이력.md:1255 · guide/03_이력.md:1257 |
| `S46-208` | 시세 축이 음수를 내지 않는가 | fatal | `validate/v0_guide.py:5012` | **★ 없음** | 없음 | guide/03_이력.md:1263 · guide/06_오판대장.md:321 · chapters/30-score/f-table.md:2673 |
| `S46-213` | 추천에 판매완료가 없는가 | fatal | `validate/v0_guide.py:4767` | **★ 없음** | 없음 | RECOMMEND_SCREEN.md:558 · guide/03_이력.md:1287 |
| `S46-214` | 사진 밑에 빈칸이 없는가 | fatal | `validate/v0_guide.py:5031` | **★ 없음** | 없음 | RECOMMEND_SCREEN.md:746 · UI_REVIEW.md:2035 · guide/03_이력.md:1293 |
| `S46-215` | 수집기가 active 를 보는가 | fatal | `validate/v0_guide.py:5056` | **★ 없음** | 없음 | guide/03_이력.md:1311 · guide/03_이력.md:1339 · chapters/10-collect/00-intro.md:651 |
| `S46-227` | 밝힌 없음에 안 준 것이 없는가 | fatal | `validate/v0_guide.py:4716` | **★ 없음** | 없음 | guide/03_이력.md:1329 · chapters/11-store/a-key.md:1109 |
| `S46-229` | recommend 로 거르는가 | fatal | `validate/v0_guide.py:5082` | **★ 없음** | 없음 | RECOMMEND_SCREEN.md:786 · guide/03_이력.md:1337 · guide/03_이력.md:1339 |
| `S46-230` | ④ 셈이 같은 판 안만 세는가 | fatal | `validate/v0_guide.py:5110` | **★ 없음** | 없음 | guide/03_이력.md:1340 · guide/03_이력.md:1346 · guide/07_밀린일대장.md:272 |
| `S46-231` | 매물 있는 사이트가 거르개에 다 있는가 | fatal | `validate/v0_guide.py:5140` | **★ 없음** | 없음 | guide/03_이력.md:1340 · guide/03_이력.md:1346 · guide/06_오판대장.md:330 |
| `S46-232` | 예산 곡선이 한계에서 0 인가 | fatal | `validate/v0_guide.py:5167` | **★ 없음** | 없음 | guide/03_이력.md:1341 |
| `S46-233` | 크기 축이 0점을 안 주는가 | fatal | `validate/v0_guide.py:5211` | **★ 없음** | 없음 | guide/03_이력.md:1341 · guide/03_이력.md:1345 · guide/06_오판대장.md:337 |
| `S46-234` | 매물 최다 사이트가 gone 을 매기는가 | fatal | `validate/v0_guide.py:5250` | **★ 없음** | 없음 | — |
| `S46-235` | 화면이 안 파는 것을 감추는가 | fatal | `validate/v0_guide.py:5282` | **★ 없음** | 없음 | — |
| `S46-236` | 내장색 축이 있고 기피가 0이 아닌가 | fatal | `validate/v0_guide.py:5415` | **★ 없음** | 없음 | guide/03_이력.md:1342 · guide/03_이력.md:1343 · guide/06_오판대장.md:334 |
| `S46-237` | 추천이 예산 안인가 | fatal | `validate/v0_guide.py:5383` | **★ 없음** | 없음 | — |
| `S46-238` | 트림이 신차가를 두 번 안 세는가 | fatal | `validate/v0_guide.py:5450` | **★ 없음** | 없음 | guide/03_이력.md:1342 |
| `S46-240` | DDL 색인이 DB 에 다 있는가 | fatal | `validate/v0_guide.py:5342` | **★ 없음** | 없음 | guide/03_이력.md:1344 |
| `S46-241` | 배포에서 재판정이 살아 있는가 | fatal | `validate/v0_guide.py:5473` | **★ 없음** | 없음 | guide/03_이력.md:1346 · guide/03_이력.md:1369 · guide/03_이력.md:1378 |
| `S46-242` | 시안에 「반드시 있는 것」 머리가 있는가 | fatal | `validate/v0_guide.py:5568` | **★ 없음** | 없음 | guide/03_이력.md:1347 |
| `S46-243` | 비는 자리가 까닭을 내는가 | fatal | `validate/v0_guide.py:5592` | **★ 없음** | 없음 | guide/03_이력.md:1347 |
| `S46-244` | 실패 응답도 원문으로 남는가 | fatal | `validate/v0_guide.py:5622` | **★ 없음** | 없음 | guide/03_이력.md:1348 |
| `S46-245` | 화면마다 그 화면에 드는 것이 있는가 | fatal | `validate/v0_guide.py:5642` | **★ 없음** | 없음 | guide/03_이력.md:1349 · guide/06_오판대장.md:338 · guide/07_밀린일대장.md:106 |
| `S46-246` | 화면마다 시안이 있는가 | fatal | `validate/v0_guide.py:5677` | **★ 없음** | 없음 | guide/03_이력.md:1349 · guide/06_오판대장.md:338 |
| `S46-247` | 사이트에 있는 것을 얼마나 받았나 | fatal | `validate/v0_guide.py:5783` | **★ 없음** | 없음 | guide/03_이력.md:1351 · guide/03_이력.md:1368 · guide/03_이력.md:1393 |
| `S46-248` | 등급이 현실을 가르는가 | fatal | `validate/v0_guide.py:5849` | **★ 없음** | 없음 | guide/03_이력.md:1350 |
| `S46-249` | 마스터 예산이 그대로인가 | fatal | `validate/v0_guide.py:5883` | **★ 없음** | 없음 | guide/03_이력.md:1350 |
| `S46-250` | 시안이 모양을 갖췄는가 | fatal | `validate/v0_guide.py:5912` | **★ 없음** | 없음 | guide/03_이력.md:1351 |
| `S46-251` | 사이트마다 차량 키가 붙는가 | fatal | `validate/v0_guide.py:5945` | **★ 없음** | 없음 | guide/03_이력.md:1353 |
| `S46-252` | 관리 쓰기가 정말 저장되는가 | fatal | `validate/v0_guide.py:5975` | **★ 없음** | 없음 | guide/03_이력.md:1354 · guide/03_이력.md:1380 |
| `S46-253` | 1부를 브라우저로 봤는가 | fatal | `validate/v0_guide.py:6007` | **★ 없음** | 없음 | — |
| `S46-254` | 짝지어진 차를 순위로 올리지 않는가 | fatal | `validate/v0_guide.py:6050` | **★ 없음** | 없음 | CROSS_SITE_COMPARE.md:188 · guide/03_이력.md:1356 · guide/03_이력.md:1357 |
| `S46-255` | 시험자 번호가 낱개로 있는가 | fatal | `validate/v0_guide.py:6084` | **★ 없음** | 없음 | guide/03_이력.md:1357 · guide/07_밀린일대장.md:179 |
| `S46-256` | 막혔다를 증거 없이 쓰지 않는가 | fatal | `validate/v0_guide.py:6385` | **★ 없음** | 없음 | guide/03_이력.md:1358 · guide/06_오판대장.md:341 · chapters/13-pipeline.md:290 |
| `S46-257` | 파이프라인이 엔카만 돌지 않는가 | fatal | `validate/v0_guide.py:6416` | **★ 없음** | 없음 | guide/03_이력.md:1359 · guide/03_이력.md:1380 · guide/06_오판대장.md:356 |
| `S46-258` | 판정 축 사전이 정해졌는가 | fatal | `validate/v0_guide.py:6538` | **★ 없음** | 없음 | guide/03_이력.md:1361 |
| `S46-259` | 마스터 차종 이름이 그대로인가 | fatal | `validate/v0_guide.py:6570` | **★ 없음** | 없음 | guide/03_이력.md:1362 · guide/03_이력.md:1363 · guide/06_오판대장.md:342 |
| `S46-260` | 빈 쪽이 아니라 끝 신호로 멈추는가 | fatal | `validate/v0_guide.py:6628` | **★ 없음** | 없음 | guide/03_이력.md:1364 · chapters/13-pipeline.md:334 |
| `S46-261` | 회차의 수와 배포의 수가 같은가 | fatal | `validate/v0_guide.py:6285` | **★ 없음** | 없음 | — |
| `S46-262` | 개발측 「여쭐 것」이 물렸는가 | fatal | `validate/v0_guide.py:6653` | **★ 없음** | 없음 | guide/03_이력.md:1367 · guide/03_이력.md:1368 · guide/03_이력.md:1441 |
| `S46-263` | 네 갈래 로직이 규격에 있는가 | fatal | `validate/v0_guide.py:6685` | **★ 없음** | 없음 | guide/03_이력.md:1371 · guide/03_이력.md:1372 · guide/03_이력.md:1373 |
| `S46-264` | 배포가 열려 있는가 | fatal | `validate/v0_guide.py:6724` | **★ 없음** | 없음 | guide/03_이력.md:1374 · guide/03_이력.md:1375 · guide/06_오판대장.md:346 |
| `S46-265` | 적재 뒤 raw_response 를 지우는가 | fatal | `validate/v0_guide.py:6767` | **★ 없음** | 없음 | guide/03_이력.md:1376 · guide/06_오판대장.md:347 · guide/07_밀린일대장.md:101 |
| `S46-266` | 이미 받은 상세를 다시 안 받는가 | fatal | `validate/v0_guide.py:6804` | **★ 없음** | 없음 | guide/03_이력.md:1377 · guide/07_밀린일대장.md:103 · chapters/10-collect/00-intro.md:516 |
| `S46-267` | 팔린 것을 대조하고 치우는가 | fatal | `validate/v0_guide.py:6826` | **★ 없음** | 없음 | guide/03_이력.md:1377 · guide/07_밀린일대장.md:105 · chapters/10-collect/00-intro.md:553 |
| `S46-268` | 지시문이 한 벌이고 지금 판인가 | fatal | `validate/v0_guide.py:6851` | **★ 없음** | 없음 | guide/03_이력.md:1379 · guide/03_이력.md:1394 · guide/03_이력.md:1425 |
| `S46-269` | 추천 차종과 단추 크기가 확정대로인가 | fatal | `validate/v0_guide.py:6906` | **★ 없음** | 없음 | guide/03_이력.md:1382 · guide/03_이력.md:1383 · guide/03_이력.md:1444 |
| `S46-270` | 가려진 글자를 세는 자가 있는가 | fatal | `validate/v0_guide.py:6957` | **★ 없음** | 없음 | guide/03_이력.md:1385 · guide/06_오판대장.md:348 |
| `S46-271` | 화면을 브라우저로 열어 재는가 | fatal | `validate/v0_guide.py:7045` | **★ 없음** | 없음 | guide/03_이력.md:1386 · guide/03_이력.md:1387 · guide/03_이력.md:1393 |
| `S46-272` | 사진을 URL 로만 스무 장까지 두는가 | fatal | `validate/v0_guide.py:7105` | **★ 없음** | 없음 | guide/03_이력.md:1405 · chapters/10-collect/00-intro.md:495 |
| `S46-273` | 엔카 배너가 마스터가 받은 것을 세는가 | fatal | `validate/v0_guide.py:7135` | **★ 없음** | 없음 | guide/03_이력.md:1407 |
| `S46-274` | 기본 차례가 등급 > 값 > 추천인가 | fatal | `validate/v0_guide.py:7163` | **★ 없음** | 없음 | RECOMMEND_SCREEN.md:292 · guide/03_이력.md:1408 · guide/03_이력.md:1427 |
| `S46-275` | 축 점수를 저장하는가 | fatal | `validate/v0_guide.py:7209` | **★ 없음** | 없음 | guide/03_이력.md:1409 · guide/03_이력.md:1425 · guide/06_오판대장.md:350 |
| `S46-276` | 엔카 수집에 구멍이 없는가 | fatal | `validate/v0_guide.py:7239` | **★ 없음** | 없음 | guide/03_이력.md:1414 · guide/07_밀린일대장.md:13 |
| `S46-277` | 관리 질의가 조회를 막지 않는가 | fatal | `validate/v0_guide.py:7295` | **★ 없음** | 없음 | guide/03_이력.md:1415 · guide/03_이력.md:1423 · guide/07_밀린일대장.md:12 |
| `S46-278` | KB 가 막힌 응답도 남기는가 | fatal | `validate/v0_guide.py:7320` | **★ 없음** | 없음 | guide/03_이력.md:1417 · guide/07_밀린일대장.md:11 |
| `S46-279` | KB 값·항목·사진이 찼는가 | fatal | `validate/v0_guide.py:7359` | **★ 없음** | 없음 | guide/03_이력.md:1417 · guide/07_밀린일대장.md:14 |
| `S46-280` | 열두 사이트에 같은 구멍이 없는가 | fatal | `validate/v0_guide.py:7409` | **★ 없음** | 없음 | guide/03_이력.md:1418 · guide/07_밀린일대장.md:16 |
| `S46-281` | 이름만 있는 옵션도 받는가 | fatal | `validate/v0_guide.py:7466` | **★ 없음** | 없음 | guide/03_이력.md:1419 · chapters/11-store/a-key.md:83 |
| `S46-282` | 사이트별 매핑표가 있는가 | fatal | `validate/v0_guide.py:7493` | **★ 없음** | 없음 | guide/03_이력.md:1420 · guide/03_이력.md:1422 · guide/07_밀린일대장.md:15 |
| `S46-283` | 축 점수가 표에 실제로 차 있는가 | fatal | `validate/v0_guide.py:6989` | **★ 없음** | 없음 | RECOMMEND_SCREEN.md:140 · RECOMMEND_SCREEN.md:243 · guide/03_이력.md:1428 |
| `S46-284` | 작업 지시가 읽히는 꼴인가 | fatal | `validate/v0_guide.py:7571` | **★ 없음** | 없음 | guide/03_이력.md:1432 · guide/03_이력.md:1436 · guide/03_이력.md:1439 |
| `S46-285` | 마스터 대상 차종의 상세가 채워졌는가 | fatal | `validate/v0_guide.py:7637` | **★ 없음** | 없음 | guide/03_이력.md:1433 |
| `S46-286` | 취향 축 합이 165 인가 | fatal | `validate/v0_guide.py:7669` | **★ 없음** | 없음 | guide/03_이력.md:1437 |
| `S46-287` | 차종별 취향 고정값이 있는가 | fatal | `validate/v0_guide.py:7702` | **★ 없음** | 없음 | guide/03_이력.md:1437 · guide/03_이력.md:1441 · guide/03_이력.md:1442 |
| `S46-288` | 미분류를 다시 묻지 않는가 | fatal | `validate/v0_guide.py:7738` | **★ 없음** | 없음 | guide/03_이력.md:1411 · guide/03_이력.md:1443 · guide/06_오판대장.md:354 |
| `S46-289` | 차종 표가 분류의 정본인가 | fatal | `validate/v0_guide.py:7771` | **★ 없음** | 없음 | guide/03_이력.md:1411 |
| `S46-290` | 마스터 회선으로 받는 길이 있는가 | fatal | `validate/v0_guide.py:7800` | **★ 없음** | 없음 | guide/03_이력.md:1193 · guide/03_이력.md:1198 |
| `S46-291` | 시안 CSS 가 app.css 에 옮겨졌는가 | fatal | `validate/v0_guide.py:7842` | **★ 없음** | 없음 | guide/03_이력.md:1197 |
...
| `V0-01` | 버전이 이력의 마지막 개정과 같은가 | fatal | `validate/v0_guide.py:6106` | **★ 없음** | 없음 | guide/00_버전.md:26 · guide/03_이력.md:349 · guide/03_이력.md:413 |
| `V0-02` | 폐기 표시가 이력에 있는가 | fatal | `validate/v0_guide.py:6132` | **★ 없음** | 없음 | guide/00_버전.md:56 · guide/03_이력.md:666 |
| `V0-03` | 배점 숫자가 부록 F 밖에 있는가 | fatal | `validate/v0_guide.py:6158` | **★ 없음** | 없음 | guide/00_버전.md:78 · guide/03_이력.md:349 · guide/03_이력.md:413 |
...
| `V1-22` | 사이트가 주는 것을 받아 쓰는가 | fatal | `validate/v0_guide.py:6200` | **★ 없음** | 없음 | trace/05-score.md:47 · guide/01_요구사항.md:159 · guide/01_요구사항.md:275 |
