...
| `S46-301` | 탭 4 거르개가 설정에 있는가 | fatal | `validate/v0_guide.py:8283` | **★ 없음** | 없음 | guide/03_이력.md:1382 |
| `S46-302` | 옛 거르개 문구가 남아 있지 않은가 | fatal | `validate/v0_guide.py:8323` | **★ 없음** | 없음 | guide/03_이력.md:1381 |
