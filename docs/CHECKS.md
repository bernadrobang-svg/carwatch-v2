...
| `S46-40` | 「진행」인 요구의 문서가 바뀌었는가 | warn | `validate/v0_guide.py:849` | **★ 없음** | 없음 | guide/01_요구사항.md:69 · guide/03_이력.md:682 · guide/06_오판대장.md:181 |
| `S46-41` | 사이트 status 가 규격의 셋 안인가 | fatal | `validate/v0_guide.py:880` | **★ 없음** | 없음 | guide/06_오판대장.md:182 |
...
| `S46-75` | v4m 여덟 장 공통 규칙 | fatal | `validate/v0_guide.py:1222` | **★ 없음** | 없음 | guide/01_요구사항.md:116 · guide/03_이력.md:766 · guide/06_오판대장.md:218 |
...
| `S46-91` | 받은 원문이 저장까지 갔는가 | fatal | `validate/v0_guide.py:2263` | **★ 없음** | 없음 | guide/03_이력.md:781 · guide/06_오판대장.md:225 |
...
| `S46-102` | 「전기만」에 전기 아닌 것이 없는가 | fatal | `validate/v0_guide.py:2707` | **★ 없음** | 없음 | UI_REVIEW.md:1133 · guide/03_이력.md:814 · guide/06_오판대장.md:239 |
| `S46-103` | 시안의 크기·자리 값을 담았는가 | fatal | `validate/v0_guide.py:2759` | **★ 없음** | 없음 | guide/03_이력.md:819 · guide/03_이력.md:847 · guide/06_오판대장.md:241 |
...
| `S46-126` | 수집기가 통신·sleep 을 트랜잭션 밖에서 하는가 | fatal | `validate/v0_guide.py:1699` | **★ 없음** | 없음 | guide/03_이력.md:870 · guide/03_이력.md:935 · guide/06_오판대장.md:282 |
| `S46-127` | 수집기마다 화면이나 타이머가 있는가 | fatal | `validate/v0_guide.py:1615` | **★ 없음** | 없음 | guide/03_이력.md:1067 · guide/06_오판대장.md:258 · guide/07_밀린일대장.md:79 |
| `S46-128` | 묶어 쓰는 단계가 다른 쓰기에 창을 주는가 | fatal | `validate/v0_guide.py:1571` | **★ 없음** | 없음 | guide/06_오판대장.md:259 |
| `S46-129` | 표의 합이 맞는가 | fatal | `validate/v0_guide.py:3256` | **★ 없음** | 없음 | guide/03_이력.md:977 · guide/03_이력.md:987 · guide/06_오판대장.md:260 |
| `S46-130` | 합계표가 문서마다 하나인가 | fatal | `validate/v0_guide.py:3516` | **★ 없음** | 없음 | guide/03_이력.md:1001 · guide/06_오판대장.md:261 |
| `S46-131` | 「쪽넘김이 없다」에 실측이 있는가 | fatal | `validate/v0_guide.py:3400` | **★ 없음** | 없음 | guide/06_오판대장.md:262 · guide/07_밀린일대장.md:39 |
| `S46-132` | 인계문이 다시 재라고 적는가 | fatal | `validate/v0_guide.py:3288` | **★ 없음** | 없음 | guide/06_오판대장.md:263 |
| `S46-133` | 검사 구멍이 밀린일에 있는가 | fatal | `validate/v0_guide.py:3655` | **★ 없음** | 없음 | guide/06_오판대장.md:264 |
| `S46-134` | 질의와 규격이 어긋나지 않는가 | fatal | `validate/v0_guide.py:3533` | **★ 없음** | 없음 | guide/06_오판대장.md:265 |
| `S46-135` | 일반화에 표본이 있는가 | fatal | `validate/v0_guide.py:3422` | **★ 없음** | 없음 | guide/06_오판대장.md:266 |
| `S46-136` | 규격의 warn 수가 지금 값과 같은가 | fatal | `validate/v0_guide.py:3673` | **★ 없음** | 없음 | guide/06_오판대장.md:267 · guide/07_밀린일대장.md:40 |
| `S46-137` | 질의 열쇠를 읽는 코드가 있는가 | fatal | `validate/v0_guide.py:3695` | **★ 없음** | 없음 | guide/06_오판대장.md:268 |
| `S46-138` | 「전량」에 세는 법이 있는가 | fatal | `validate/v0_guide.py:3439` | **★ 없음** | 없음 | guide/03_이력.md:999 · guide/06_오판대장.md:269 |
| `S46-139` | 「칸이 비었다」에 전수가 있는가 | fatal | `validate/v0_guide.py:3724` | **★ 없음** | 없음 | guide/06_오판대장.md:270 |
| `S46-140` | 쓰는 호스트가 robots 문서에 있는가 | fatal | `validate/v0_guide.py:3302` | **★ 없음** | 없음 | guide/06_오판대장.md:271 · guide/07_밀린일대장.md:39 |
| `S46-141` | 거르개 판정에 실측이 있는가 | fatal | `validate/v0_guide.py:3559` | **★ 없음** | 없음 | guide/06_오판대장.md:272 |
| `S46-142` | 「N 사이트」가 config 와 같은가 | fatal | `validate/v0_guide.py:3321` | **★ 없음** | 없음 | guide/03_이력.md:1279 · guide/03_이력.md:1283 · guide/06_오판대장.md:273 |
| `S46-143` | 마스터께 올릴 것이 세어졌는가 | fatal | `validate/v0_guide.py:3576` | **★ 없음** | 없음 | guide/03_이력.md:1001 · guide/06_오판대장.md:274 |
| `S46-144` | 「비었다」가 ⑤·⑥·⑦ 로 갈렸는가 | fatal | `validate/v0_guide.py:3811` | **★ 없음** | 없음 | guide/03_이력.md:983 · guide/06_오판대장.md:275 · guide/12_남은것_20260829.md:15 |
| `S46-145` | 마스터께 드리는 표에 수의 뜻이 있는가 | fatal | `validate/v0_guide.py:3154` | **★ 없음** | 없음 | guide/03_이력.md:985 · guide/06_오판대장.md:276 |
| `S46-146` | 「안 준다」를 쓰며 파서를 봤는가 | fatal | `validate/v0_guide.py:3356` | **★ 없음** | 없음 | guide/03_이력.md:997 · guide/06_오판대장.md:277 |
| `S46-147` | 「안 준다」의 표본이 열 건인가 | fatal | `validate/v0_guide.py:3611` | **★ 없음** | 없음 | guide/05_가이드역할.md:1500 · guide/06_오판대장.md:278 · evidence/absence_20260829.md:6 |
| `S46-148` | 「축이 빈다」가 칼럼·파서를 짚는가 | fatal | `validate/v0_guide.py:3741` | **★ 없음** | 없음 | guide/03_이력.md:1001 · guide/03_이력.md:1283 · guide/06_오판대장.md:279 |
| `S46-149` | 자백이 닫혔는가 | fatal | `validate/v0_guide.py:3463` | **★ 없음** | 없음 | guide/06_오판대장.md:280 · guide/07_밀린일대장.md:40 |
| `S46-150` | 규격의 칼럼이 DDL 에 있는가 | fatal | `validate/v0_guide.py:3633` | **★ 없음** | 없음 | ROADMAP_20260830.md:65 · guide/06_오판대장.md:281 |
| `S46-152` | 마지막 개발 회차를 읽었는가 | fatal | `validate/v0_guide.py:3759` | **★ 없음** | 없음 | guide/03_이력.md:991 · guide/03_이력.md:1007 · guide/03_이력.md:1009 |
| `S46-153` | 「마스터 몫」이 진짜 마스터 몫인가 | fatal | `validate/v0_guide.py:3828` | **★ 없음** | 없음 | guide/03_이력.md:1007 · guide/03_이력.md:1009 · guide/06_오판대장.md:284 |
| `S46-154` | 마스터 말씀이 요구 추적표에 있는가 | fatal | `validate/v0_guide.py:3378` | **★ 없음** | 없음 | guide/01_요구사항.md:49 · guide/03_이력.md:1005 · guide/06_오판대장.md:285 |
| `S46-155` | 화면 규격마다 시안이 있는가 | fatal | `validate/v0_guide.py:3183` | **★ 없음** | 없음 | guide/03_이력.md:985 · guide/03_이력.md:1003 · guide/06_오판대장.md:286 |
| `S46-156` | 개발측 물음의 답이 규격에 있는가 | fatal | `validate/v0_guide.py:3490` | **★ 없음** | 없음 | guide/06_오판대장.md:287 |
| `S46-157` | 성능 판정에 시간이 있는가 | fatal | `validate/v0_guide.py:3860` | **★ 없음** | 없음 | guide/06_오판대장.md:288 |
| `S46-158` | 용량 판정에 수가 있는가 | fatal | `validate/v0_guide.py:3878` | **★ 없음** | 없음 | guide/06_오판대장.md:289 |
| `S46-159` | 설계도가 할 수 있는 것만 시키는가 | fatal | `validate/v0_guide.py:3792` | **★ 없음** | 없음 | guide/06_오판대장.md:290 · guide/07_밀린일대장.md:40 |
| `S46-160` | 전기차 누유가 만점·분모 910 인가 | fatal | `validate/v0_guide.py:3896` | **★ 없음** | 없음 | guide/03_이력.md:971 · guide/06_오판대장.md:291 · guide/06_오판대장.md:292 |
...
| `S46-163` | 시안마다 라우팅 표에 주소가 있는가 | fatal | `validate/v0_guide.py:3216` | **★ 없음** | 없음 | guide/03_이력.md:985 · guide/03_이력.md:1003 · guide/06_오판대장.md:294 |
| `S46-164` | 개발 회차의 「마스터 몫」에 답을 냈는가 | fatal | `validate/v0_guide.py:3913` | **★ 없음** | 없음 | guide/03_이력.md:991 · guide/06_오판대장.md:295 · guide/14_누가할것_20260829.md:39 |
| `S46-165` | 「못 잰다」가 진짜인가 | fatal | `validate/v0_guide.py:3947` | **★ 없음** | 없음 | guide/03_이력.md:1011 · guide/06_오판대장.md:296 · guide/06_오판대장.md:297 |
| `S46-166` | 마스터 확정이 장 규격에 닿았는가 | fatal | `validate/v0_guide.py:3988` | **★ 없음** | 없음 | ARCHITECTURE_20260830.md:8 · guide/03_이력.md:1017 · guide/06_오판대장.md:298 |
| `S46-168` | 검사가 예외를 수로 내는가 | fatal | `validate/v0_guide.py:4018` | **★ 없음** | 없음 | guide/03_이력.md:1037 · guide/03_이력.md:1067 · guide/06_오판대장.md:299 |
| `S46-169` | 「왜 죽었는지」가 규격에 있는가 | fatal | `validate/v0_guide.py:4052` | **★ 없음** | 없음 | ARCHITECTURE_20260830.md:8 · ARCHITECTURE_20260830.md:148 · guide/03_이력.md:1045 |
| `S46-170` | 설계도가 하나인가 | fatal | `validate/v0_guide.py:4069` | **★ 없음** | 없음 | ARCHITECTURE_20260830.md:301 · guide/03_이력.md:1057 |
| `S46-171` | 잣대가 화면을 적었는가 | fatal | `validate/v0_guide.py:4087` | **★ 없음** | 없음 | guide/03_이력.md:1061 · guide/06_오판대장.md:300 |
| `S46-172` | 「없다」를 본문 낱말로 쟀는가 | fatal | `validate/v0_guide.py:4106` | **★ 없음** | 없음 | guide/03_이력.md:1075 · guide/06_오판대장.md:301 |
| `S46-173` | 규격이 창구를 적었는가 | fatal | `validate/v0_guide.py:4130` | **★ 없음** | 없음 | guide/03_이력.md:1077 · guide/06_오판대장.md:302 |
| `S46-174` | 「창구가 없다」를 열어 보고 적었는가 | fatal | `validate/v0_guide.py:4155` | **★ 없음** | 없음 | guide/03_이력.md:1081 · guide/06_오판대장.md:303 |
| `S46-175` | 점수를 「나머지 N」으로 뭉개지 않는가 | fatal | `validate/v0_guide.py:4182` | **★ 없음** | 없음 | guide/03_이력.md:1083 · guide/03_이력.md:1127 · guide/06_오판대장.md:304 |
| `S46-176` | 사이트 두드리기를 넘기지 않는가 | fatal | `validate/v0_guide.py:4215` | **★ 없음** | 없음 | guide/03_이력.md:1085 · guide/06_오판대장.md:305 |
| `S46-177` | 카탈로그를 site 로 가두지 않는가 | fatal | `validate/v0_guide.py:4243` | **★ 없음** | 없음 | guide/03_이력.md:1101 · chapters/30-score/f-table.md:1785 |
| `S46-178` | 목록이 주는 칸이 파서에 있는가 | fatal | `validate/v0_guide.py:4268` | **★ 없음** | 없음 | guide/03_이력.md:1101 · chapters/30-score/f-table.md:1809 |
| `S46-179` | 못 받은 축에 감점이 없는가 | fatal | `validate/v0_guide.py:4293` | **★ 없음** | 없음 | guide/03_이력.md:1111 · chapters/30-score/f-table.md:1932 |
| `S46-180` | 코드 표가 사이트마다 있는가 | fatal | `validate/v0_guide.py:4307` | **★ 없음** | 없음 | guide/03_이력.md:1113 · guide/03_이력.md:1127 · guide/06_오판대장.md:307 |
| `S46-181` | 받아 둔 조사를 먼저 보는가 | fatal | `validate/v0_guide.py:4334` | **★ 없음** | 없음 | CROSS_SITE_COMPARE.md:1042 · guide/03_이력.md:1115 · guide/06_오판대장.md:308 |
| `S46-182` | 「전 사이트」를 사이트별로 열고 말했는가 | fatal | `validate/v0_guide.py:4353` | **★ 없음** | 없음 | guide/03_이력.md:1123 · guide/06_오판대장.md:309 |
| `S46-183` | 「마스터 몫」 전에 내가 열었는가 | fatal | `validate/v0_guide.py:4381` | **★ 없음** | 없음 | guide/03_이력.md:1127 · guide/03_이력.md:1283 · guide/03_이력.md:1319 |
| `S46-184` | 「미조회」를 「없다」로 옮기지 않는가 | fatal | `validate/v0_guide.py:4410` | **★ 없음** | 없음 | guide/03_이력.md:1131 · guide/06_오판대장.md:311 |
| `S46-185` | 원문 파일을 지우지 않는가 | fatal | `validate/v0_guide.py:4438` | **★ 없음** | 없음 | ARCHITECTURE_20260830.md:386 · guide/03_이력.md:1133 |
| `S46-186` | 등급 분포를 보고 있는가 | fatal | `validate/v0_guide.py:4468` | **★ 없음** | 없음 | guide/06_오판대장.md:312 |
| `S46-187` | 값 곡선이 쌀수록 높은가 | fatal | `validate/v0_guide.py:4482` | **★ 없음** | 없음 | guide/03_이력.md:1141 · guide/06_오판대장.md:313 |
| `S46-188` | 「화면에 없다」를 열어 보고 적었는가 | fatal | `validate/v0_guide.py:4509` | **★ 없음** | 없음 | guide/06_오판대장.md:314 |
| `S46-191` | 차종별 예산이 원칙대로인가 | fatal | `validate/v0_guide.py:4533` | **★ 없음** | 없음 | guide/03_이력.md:1175 · guide/03_이력.md:1215 · guide/03_이력.md:1217 |
| `S46-192` | 선호차종이 등록부에 다 있는가 | fatal | `validate/v0_guide.py:4569` | **★ 없음** | 없음 | guide/03_이력.md:1179 |
| `S46-202` | 안 풀린 틀 문법이 없는가 | fatal | `validate/v0_guide.py:4594` | **★ 없음** | 없음 | RECOMMEND_SCREEN.md:138 · guide/03_이력.md:1219 |
| `S46-203` | 넣으라 한 사이트에 차종 열쇠가 있는가 | fatal | `validate/v0_guide.py:4707` | **★ 없음** | 없음 | guide/03_이력.md:1223 · guide/06_오판대장.md:316 |
| `S46-204` | 받기가 파일에 쓰는가 | fatal | `validate/v0_guide.py:4739` | **★ 없음** | 없음 | guide/03_이력.md:1227 |
| `S46-205` | raw_response 에 넣으라 하지 않는가 | fatal | `validate/v0_guide.py:4766` | **★ 없음** | 없음 | guide/03_이력.md:1229 · guide/06_오판대장.md:318 |
| `S46-206` | PDF 를 받아 두라 하지 않는가 | fatal | `validate/v0_guide.py:4801` | **★ 없음** | 없음 | guide/03_이력.md:1231 · guide/06_오판대장.md:319 · chapters/10-collect/d-policy.md:186 |
| `S46-207` | 커밋 제목이 사실을 말하는가 | fatal | `validate/v0_guide.py:4867` | **★ 없음** | 없음 | ROADMAP_20260830.md:66 · guide/03_이력.md:1235 · guide/03_이력.md:1237 |
| `S46-208` | 시세 축이 음수를 내지 않는가 | fatal | `validate/v0_guide.py:4905` | **★ 없음** | 없음 | guide/03_이력.md:1243 · guide/06_오판대장.md:320 · chapters/30-score/f-table.md:2650 |
| `S46-213` | 추천에 판매완료가 없는가 | fatal | `validate/v0_guide.py:4658` | **★ 없음** | 없음 | RECOMMEND_SCREEN.md:297 · guide/03_이력.md:1267 |
| `S46-214` | 사진 밑에 빈칸이 없는가 | fatal | `validate/v0_guide.py:4924` | **★ 없음** | 없음 | RECOMMEND_SCREEN.md:485 · UI_REVIEW.md:2034 · guide/03_이력.md:1273 |
| `S46-215` | 수집기가 active 를 보는가 | fatal | `validate/v0_guide.py:4948` | **★ 없음** | 없음 | guide/03_이력.md:1291 · guide/03_이력.md:1319 · chapters/10-collect/00-intro.md:493 |
| `S46-227` | 밝힌 없음에 안 준 것이 없는가 | fatal | `validate/v0_guide.py:4607` | **★ 없음** | 없음 | guide/03_이력.md:1309 · chapters/11-store/a-key.md:935 |
| `S46-229` | recommend 로 거르는가 | fatal | `validate/v0_guide.py:4973` | **★ 없음** | 없음 | RECOMMEND_SCREEN.md:525 · guide/03_이력.md:1317 · guide/03_이력.md:1319 |
...
| `V1-27` | 확인 안 됨을 ①②③④ 로 가른 표가 있음 | run | `validate/v1_collect.py:88` | **★ 없음** | 없음 | guide/03_이력.md:454 · chapters/30-score/f-table.md:511 |
| `V1-28` | ② ③ 건수가 지난번보다 안 늘었음 | run | `validate/v1_collect.py:95` | **★ 없음** | 없음 | guide/03_이력.md:454 · chapters/30-score/f-table.md:512 |
...
| `V3-72` | SOH 가점이 곡선대로 붙음 | run | `validate/v3_logic.py:151` | **★ 없음** | 없음 | guide/03_이력.md:399 · chapters/30-score/f-table.md:940 |
...
| `V3-76` | ⑤ 의 하위 축 합이 갈래 표기와 같음 | run | `validate/v3_logic.py:256` | **★ 없음** | 없음 | guide/03_이력.md:412 · chapters/30-score/f-table.md:1332 |
...
| `V3-79` | 어긋난 매물에 ②-2·②-3 만점이 없음 | run | `validate/v3_logic.py:216` | **★ 없음** | 없음 | guide/03_이력.md:434 · chapters/30-score/f-table.md:1000 |
| `V3-80` | ②-1 회수가 max(보험, 성능부) 임 | run | `validate/v3_logic.py:222` | **★ 없음** | 없음 | guide/03_이력.md:434 · chapters/30-score/f-table.md:1001 |
| `V3-81` | 셋 중 하나만 null 인데 확인 안 됨이 아님 | run | `validate/v3_logic.py:228` | **★ 없음** | 없음 | guide/03_이력.md:435 · chapters/30-score/f-table.md:1071 |
| `V3-82` | 시세 점수가 계단값만 나오지 않음 | run | `validate/v3_logic.py:234` | **★ 없음** | 없음 | guide/03_이력.md:439 · chapters/30-score/f-table.md:766 |
| `V3-83` | 시세보다 비싼 매물에 음수 점수가 붙음 | run | `validate/v3_logic.py:240` | **★ 없음** | 없음 | chapters/30-score/f-table.md:767 |
| `V3-84` | 신차가 곡선이 규격의 앵커와 같음 | run | `validate/v3_logic.py:246` | **★ 없음** | 없음 | guide/03_이력.md:439 · chapters/30-score/f-table.md:810 |
| `V3-85` | 옵션 보정 없이 원 중앙값으로 견준 매물 | run | `validate/v3_logic.py:251` | **★ 없음** | 없음 | guide/03_이력.md:441 |
| `V3-86` | 축 점수가 배점을 넘지 않음 | run | `validate/v3_logic.py:205` | **★ 없음** | 없음 | guide/03_이력.md:448 · chapters/30-score/f-table.md:551 |
| `V3-87` | 사이트 검증이 단계임 (더하지 않음) | run | `validate/v3_logic.py:211` | **★ 없음** | 없음 | guide/03_이력.md:448 · chapters/30-score/f-table.md:552 · chapters/30-score/f-table.md:1417 |
...
| `V3-91` | 가이드 검산 일곱 줄이 표대로 나옴 | run | `validate/v3_logic.py:199` | **★ 없음** | 없음 | guide/03_이력.md:451 · chapters/30-score/f-table.md:533 · chapters/30-score/f-table.md:1417 |
| `V3-92` | 트림 만점이 개별 취향 축보다 큼 | run | `validate/v3_logic.py:178` | **★ 없음** | 없음 | guide/03_이력.md:452 · chapters/30-score/f-table.md:382 |
| `V3-93` | 제외 매물에 등급 문자가 안 붙음 | run | `validate/v3_logic.py:184` | **★ 없음** | 없음 | guide/03_이력.md:453 · chapters/30-score/f-table.md:343 |
| `V3-94` | 등급 컷이 규격의 8단계임 | run | `validate/v3_logic.py:189` | **★ 없음** | 없음 | guide/03_이력.md:453 · chapters/30-score/f-table.md:329 · chapters/30-score/f-table.md:344 |
| `V3-95` | 화면이 source='missing' 을 「없음」으로 안 냄 | run | `validate/v3_logic.py:166` | **★ 없음** | 없음 | guide/03_이력.md:455 · guide/07_밀린일대장.md:357 · chapters/30-score/f-table.md:431 |
| `V3-96` | value IS NULL 과 source 모름 건수 차 | run | `validate/v3_logic.py:172` | **★ 없음** | 없음 | guide/03_이력.md:455 · guide/07_밀린일대장.md:357 · chapters/30-score/f-table.md:432 |
