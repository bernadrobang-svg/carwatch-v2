...
| `S44-4` | 명령서에 수집 범위가 있는가 | fatal | `validate/v0_guide.py:69` | **★ 없음** | 없음 | guide/03_이력.md:557 · guide/03_이력.md:558 · guide/06_오판대장.md:137 |
| `S44-5` | 명령서이 사이트를 한 가지로 적는가 | fatal | `validate/v0_guide.py:101` | **★ 없음** | 없음 | guide/03_이력.md:557 · guide/06_오판대장.md:138 |
...
| `S46-40` | 「진행」인 요구의 문서가 바뀌었는가 | warn | `validate/v0_guide.py:832` | **★ 없음** | 없음 | guide/01_요구사항.md:67 · guide/03_이력.md:682 · guide/06_오판대장.md:174 |
| `S46-41` | 사이트 status 가 규격의 셋 안인가 | fatal | `validate/v0_guide.py:863` | **★ 없음** | 없음 | guide/06_오판대장.md:175 |
...
| `S46-67` | 시안 이름이 app.css 와 안 겹치는가 | fatal | `validate/v0_guide.py:1042` | **★ 없음** | 없음 | guide/03_이력.md:749 · guide/06_오판대장.md:200 |
...
| `S46-76` | 수집기가 원문을 남기는가 | fatal | `validate/v0_guide.py:1245` | **★ 없음** | 없음 | guide/01_요구사항.md:116 · guide/03_이력.md:770 · guide/03_이력.md:771 |
| `S46-77` | KB 는 우리 20종만 받는가 | fatal | `validate/v0_guide.py:1273` | **★ 없음** | 없음 | — |
| `S46-78` | 엔카 전용 경로가 좁혀 있는가 | fatal | `validate/v0_guide.py:1328` | **★ 없음** | 없음 | guide/03_이력.md:771 |
| `S46-87` | 부른 주소가 그 매물의 사이트인가 | fatal | `validate/v0_guide.py:1370` | **★ 없음** | 없음 | guide/03_이력.md:772 · guide/03_이력.md:773 · guide/06_오판대장.md:215 |
| `S46-88` | 엔카가 막히면 화면이 까닭을 말하는가 | fatal | `validate/v0_guide.py:1439` | **★ 없음** | 없음 | guide/03_이력.md:773 |
...
| `V10-17` | admin 수가 0 이 되는 변경이 거부됨 | run | `validate/v10_admin.py:78` | **★ 없음** | 없음 | guide/03_이력.md:178 · guide/03_이력.md:215 · chapters/61-web.md:1990 |
...
| `V11-02` | 기본 바인딩이 127.0.0.1 | run | `validate/v11_web.py:43` | **★ 없음** | 없음 | chapters/61-web.md:107 · chapters/61-web.md:2057 · chapters/61-web.md:2126 |
| `V11-03` | 전 Route 에 role 이 지정됨 | run | `validate/v11_web.py:47` | **★ 없음** | 없음 | chapters/61-web.md:175 · chapters/61-web.md:2127 |
| `V11-04` | 템플릿에 산술 연산이 없음 | run | `validate/v11_web.py:49` | **★ 없음** | 없음 | trace/RULES.md:163 · chapters/61-web.md:287 · chapters/61-web.md:2102 |
| `V11-05` | {{! }} 사용처가 화이트리스트에 있음 | run | `validate/v11_web.py:52` | **★ 없음** | 없음 | trace/RULES.md:163 · chapters/61-web.md:304 · chapters/61-web.md:2129 |
| `V11-06` | 정적 경로 탈출이 거부됨 | run | `validate/v11_web.py:57` | **★ 없음** | 없음 | trace/RULES.md:165 · trace/RULES.md:278 · chapters/61-web.md:409 |
| `V11-07` | 쿠키에 role 문자열이 없음 | run | `validate/v11_web.py:59` | **★ 없음** | 없음 | chapters/61-web.md:1356 · chapters/61-web.md:2131 |
| `V11-08` | 상태 변경이 GET 경로에 없음 | run | `validate/v11_web.py:61` | **★ 없음** | 없음 | chapters/61-web.md:1392 · chapters/61-web.md:2132 |
| `V11-09` | 미리보기 없이 저장이 안 됨 | run | `validate/v11_web.py:64` | **★ 없음** | 없음 | trace/RULES.md:68 · chapters/61-web.md:1420 · chapters/61-web.md:1910 |
| `V11-10` | 오류 화면에 스택 트레이스가 없음 | run | `validate/v11_web.py:66` | **★ 없음** | 없음 | chapters/61-web.md:1454 · chapters/61-web.md:2134 |
| `V11-11` | result_* 가 비었을 때 안내가 나옴 | run | `validate/v11_web.py:70` | **★ 없음** | 없음 | chapters/61-web.md:1483 · chapters/61-web.md:2135 |
...
| `V11-14` | 숫자 셀에 mono 가 걸려 있음 | run | `validate/v11_web.py:96` | **★ 없음** | 없음 | chapters/61-web.md:484 · chapters/61-web.md:2138 |
| `V11-15` | 화면이 빌드 산출물에 의존하지 않음 | run | `validate/v11_web.py:99` | **★ 없음** | 없음 | chapters/61-web.md:1299 · chapters/61-web.md:2139 |
| `V11-16` | /why 가 전 Component 를 냄 | run | `validate/v11_web.py:102` | **★ 없음** | 없음 | chapters/61-web.md:1505 · chapters/61-web.md:1580 · chapters/61-web.md:2140 |
| `V11-17` | /why 가 조회 상태 절을 냄 | run | `validate/v11_web.py:105` | **★ 없음** | 없음 | chapters/61-web.md:1580 · chapters/61-web.md:1634 · chapters/61-web.md:2141 |
| `V11-18` | 축 태그가 전건 필터 링크임 | run | `validate/v11_web.py:108` | **★ 없음** | 없음 | chapters/61-web.md:1678 · chapters/61-web.md:2142 |
| `V11-19` | 폴링 실패 시 화면이 안 깨짐 | run | `validate/v11_web.py:111` | **★ 없음** | 없음 | chapters/61-web.md:1698 · chapters/61-web.md:2143 |
| `V11-20` | 분모 표시가 있음 | run | `validate/v11_web.py:114` | **★ 없음** | 없음 | guide/03_이력.md:237 · chapters/61-web.md:1724 · chapters/61-web.md:2144 |
| `V11-21` | 행동 요청 파라미터가 현재 필터와 일치 | run | `validate/v11_web.py:117` | **★ 없음** | 없음 | chapters/61-web.md:1778 · chapters/61-web.md:2145 |
| `V11-22` | excluded 축이 「—/N」 으로 표시됨 | run | `validate/v11_web.py:120` | **★ 없음** | 없음 | chapters/61-web.md:1820 · chapters/61-web.md:2146 |
| `V11-23` | 비로그인 관심 POST 가 유도 화면을 냄 | run | `validate/v11_web.py:123` | **★ 없음** | 없음 | guide/03_이력.md:238 · chapters/61-web.md:1850 · chapters/61-web.md:2147 |
| `V11-24` | 메뉴 분류가 잠금 단위와 일치 | run | `validate/v11_web.py:126` | **★ 없음** | 없음 | chapters/61-web.md:1884 · chapters/61-web.md:2148 |
| `V11-25` | 사유 없이 설정이 저장되지 않음 | run | `validate/v11_web.py:129` | **★ 없음** | 없음 | chapters/61-web.md:1910 · chapters/61-web.md:2149 |
| `V11-26` | 되돌릴 수 없는 행동에 확인이 있음 | run | `validate/v11_web.py:132` | **★ 없음** | 없음 | chapters/61-web.md:1954 · chapters/61-web.md:2150 |
| `V11-27` | 가입 정책에 따라 화면이 바뀜 | run | `validate/v11_web.py:135` | **★ 없음** | 없음 | chapters/61-web.md:2011 · chapters/61-web.md:2151 |
| `V11-28` | 응답 헤더에 비 ASCII 없음 | run | `validate/v11_web.py:73` | **★ 없음** | 없음 | guide/03_이력.md:188 · chapters/61-web.md:1433 · chapters/61-web.md:2152 |
| `V11-29` | 렌더된 폼의 csrf_token 이 비어 있지 않음 | run | `validate/v11_web.py:77` | **★ 없음** | 없음 | guide/03_이력.md:189 · chapters/61-web.md:394 · chapters/61-web.md:2153 |
| `V11-30` | 시안 ↔ 템플릿 대조 통과 | run | `validate/v11_web.py:81` | **★ 없음** | 없음 | guide/03_이력.md:190 · chapters/61-web.md:349 · chapters/61-web.md:1533 |
| `V11-31` | must_change_secret=1 에서 /password 가 200 | run | `validate/v11_web.py:84` | **★ 없음** | 없음 | chapters/61-web.md:1377 · chapters/61-web.md:2155 |
| `V11-32` | known_issues 의 키가 전부 targets 에 있음 | run | `validate/v11_web.py:89` | **★ 없음** | 없음 | ref/B-config.md:377 · guide/03_이력.md:196 · chapters/61-web.md:2156 |
| `V11-33` | POST 가 저장 없이 성공 메시지를 내지 않음 | run | `validate/v11_web.py:138` | **★ 없음** | 없음 | guide/03_이력.md:220 · chapters/61-web.md:2035 · chapters/61-web.md:2157 |
| `V11-34` | 화면이 요청당 쿼리 상한을 넘지 않음 | run | `validate/v11_web.py:144` | **★ 없음** | 없음 | trace/41-view.md:22 · trace/41-view.md:70 · trace/RULES.md:164 |
| `V11-35` | 중첩 if 가 안쪽부터 닫힘 | run | `validate/v11_web.py:141` | **★ 없음** | 없음 | guide/03_이력.md:233 · chapters/61-web.md:1332 · chapters/61-web.md:2159 |
| `V11-36` | 잘못된 쿼리 파라미터가 500 을 내지 않음 | run | `validate/v11_web.py:148` | **★ 없음** | 없음 | guide/03_이력.md:235 · chapters/61-web.md:1341 · chapters/61-web.md:2160 |
...
| `V11-41` | 반입 뒤 S5~S10 이 이어서 돎 | run | `validate/v11_web.py:175` | **★ 없음** | 없음 | guide/03_이력.md:263 · chapters/61-web.md:2162 · chapters/60-admin/c-tools.md:213 |
| `V11-42` | S4 완료 행의 actual 이 'import' 임 | run | `validate/v11_web.py:626` | **★ 없음** | 없음 | guide/03_이력.md:264 · chapters/61-web.md:2163 · chapters/60-admin/c-tools.md:295 |
...
| `V11-55` | 목록에 전체 건수와 쪽이 표시됨 | run | `validate/v11_web.py:201` | **★ 없음** | 없음 | trace/14-web.md:62 · trace/41-view.md:63 · chapters/61-web.md:2175 |
| `V11-56` | 대표 사진 경로가 저장됨 | run | `validate/v11_web.py:206` | **★ 없음** | 없음 | chapters/61-web.md:545 · chapters/61-web.md:2176 |
| `V11-57` | 사진 없는 매물이 화면을 무너뜨리지 않음 | run | `validate/v11_web.py:210` | **★ 없음** | 없음 | guide/03_이력.md:293 · chapters/61-web.md:546 · chapters/61-web.md:2177 |
...
| `V11-61` | 이어질 수 있는 값이 링크임 | run | `validate/v11_web.py:227` | **★ 없음** | 없음 | trace/14-web.md:57 · guide/03_이력.md:295 · chapters/61-web.md:1200 |
| `V11-62` | 코드·줄임말에 title 이 있음 | run | `validate/v11_web.py:231` | **★ 없음** | 없음 | trace/14-web.md:58 · trace/14-web.md:126 · chapters/61-web.md:1201 |
| `V11-63` | 매물 화면에 원문 링크가 있음 | run | `validate/v11_web.py:235` | **★ 없음** | 없음 | trace/14-web.md:59 · guide/03_이력.md:481 · chapters/61-web.md:1217 |
| `V11-64` | 고를 수 있는 값이 목록으로 제공됨 | run | `validate/v11_web.py:239` | **★ 없음** | 없음 | trace/14-web.md:123 · chapters/61-web.md:1239 · chapters/61-web.md:2183 |
| `V11-65` | 기본 정렬이 규격대로임 | run | `validate/v11_web.py:244` | **★ 없음** | 없음 | trace/14-web.md:61 · chapters/61-web.md:1260 · chapters/61-web.md:2184 |
| `V11-66` | 필터가 목록 위에 있음 | run | `validate/v11_web.py:248` | **★ 없음** | 없음 | trace/14-web.md:60 · chapters/61-web.md:1281 · chapters/61-web.md:2185 |
| `V11-67` | 단추가 켜짐·꺼짐을 오감 | run | `validate/v11_web.py:251` | **★ 없음** | 없음 | guide/03_이력.md:295 · chapters/61-web.md:1282 · chapters/61-web.md:2186 |
...
| `V11-96` | ♡ 가 제목 줄에 있음 | run | `validate/v11_web.py:422` | **★ 없음** | 없음 | trace/14-web.md:56 · guide/03_이력.md:324 · chapters/61-web.md:806 |
...
| `V11-102` | 비교가 옵션 차이만 냄 | run | `validate/v11_web.py:385` | **★ 없음** | 없음 | trace/14-web.md:115 · guide/03_이력.md:332 · chapters/61-web.md:718 |
...
| `V11-150` | 메뉴 라벨이 경로가 아님 | run | `validate/v11_web.py:520` | **★ 없음** | 없음 | guide/03_이력.md:416 · chapters/61-web.md:265 |
