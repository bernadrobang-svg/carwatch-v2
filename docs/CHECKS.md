...
| `S46-54` | 짝 중 등급이 두 칸 갈린 것 | warn | `validate/v0_guide.py:2040` | **★ 없음** | 없음 | CROSS_SITE_COMPARE.md:7 · CROSS_SITE_COMPARE.md:254 · CROSS_SITE_COMPARE.md:422 |
| `S46-55` | 짝 중 값이 30% 갈린 것 | warn | `validate/v0_guide.py:2065` | **★ 없음** | 없음 | CROSS_SITE_COMPARE.md:7 · CROSS_SITE_COMPARE.md:255 |
| `S46-56` | 짝 중 사고 판정이 갈린 것 | warn | `validate/v0_guide.py:2091` | **★ 없음** | 없음 | CROSS_SITE_COMPARE.md:7 · CROSS_SITE_COMPARE.md:256 |
...
| `S46-77` | KB 는 우리 20종만 받는가 | fatal | `validate/v0_guide.py:1757` | **★ 없음** | 없음 | — |
| `S46-78` | 엔카 전용 경로가 좁혀 있는가 | fatal | `validate/v0_guide.py:1812` | **★ 없음** | 없음 | guide/03_이력.md:771 |
| `S46-87` | 부른 주소가 그 매물의 사이트인가 | fatal | `validate/v0_guide.py:1854` | **★ 없음** | 없음 | guide/03_이력.md:772 · guide/03_이력.md:773 · guide/03_이력.md:855 |
| `S46-88` | 엔카가 막히면 화면이 까닭을 말하는가 | fatal | `validate/v0_guide.py:1923` | **★ 없음** | 없음 | guide/03_이력.md:773 |
| `S46-90` | 근거가 절반도 없는데 등급을 매기지 않는가 | fatal | `validate/v0_guide.py:2131` | **★ 없음** | 없음 | UI_REVIEW.md:1082 · guide/03_이력.md:780 |
| `S46-91` | 받은 원문이 저장까지 갔는가 | fatal | `validate/v0_guide.py:2238` | **★ 없음** | 없음 | guide/03_이력.md:781 · guide/06_오판대장.md:225 |
| `S46-92` | 브라우저 수집이 0건을 받았는가 | warn | `validate/v0_guide.py:2977` | **★ 없음** | 없음 | guide/03_이력.md:783 · guide/03_이력.md:784 |
| `S46-94` | 원문 문이 그 매물의 사이트로 가는가 | fatal | `validate/v0_guide.py:2194` | **★ 없음** | 없음 | guide/03_이력.md:787 · guide/06_오판대장.md:228 |
| `S46-95` | 배포된 화면이 다 열리는가 | fatal | `validate/v0_guide.py:2881` | **★ 없음** | 없음 | guide/03_이력.md:788 · guide/03_이력.md:789 · guide/03_이력.md:792 |
| `S46-96` | 사이트가 파는 차종인데 코드가 없는가 | warn | `validate/v0_guide.py:2937` | **★ 없음** | 없음 | guide/03_이력.md:791 · guide/03_이력.md:860 · guide/04_질의.md:718 |
| `S46-97` | 원문이 source_id 로 매물에 이어지는가 | fatal | `validate/v0_guide.py:2310` | **★ 없음** | 없음 | guide/03_이력.md:792 · guide/03_이력.md:879 · guide/06_오판대장.md:263 |
| `S46-98` | 시안의 낱말이 화면에 있는가 | fatal | `validate/v0_guide.py:2775` | **★ 없음** | 없음 | UI_REVIEW.md:1880 · guide/03_이력.md:793 · guide/03_이력.md:794 |
| `S46-99` | 로그인하면 관심·관리가 열리는가 | fatal | `validate/v0_guide.py:2378` | **★ 없음** | 없음 | guide/03_이력.md:794 · guide/03_이력.md:879 · guide/03_이력.md:1009 |
| `S46-100` | 시안의 낱말 차례가 화면과 같은가 | fatal | `validate/v0_guide.py:2545` | **★ 없음** | 없음 | guide/03_이력.md:804 · guide/03_이력.md:879 · guide/03_이력.md:1009 |
| `S46-102` | 「전기만」에 전기 아닌 것이 없는가 | fatal | `validate/v0_guide.py:2682` | **★ 없음** | 없음 | UI_REVIEW.md:1133 · guide/03_이력.md:814 · guide/06_오판대장.md:239 |
| `S46-103` | 시안의 크기·자리 값을 담았는가 | fatal | `validate/v0_guide.py:2734` | **★ 없음** | 없음 | guide/03_이력.md:819 · guide/03_이력.md:847 · guide/06_오판대장.md:241 |
...
| `S46-129` | 표의 합이 맞는가 | fatal | `validate/v0_guide.py:3227` | **★ 없음** | 없음 | guide/03_이력.md:977 · guide/03_이력.md:987 · guide/06_오판대장.md:260 |
| `S46-130` | 합계표가 문서마다 하나인가 | fatal | `validate/v0_guide.py:3483` | **★ 없음** | 없음 | guide/03_이력.md:1001 · guide/06_오판대장.md:261 |
| `S46-131` | 「쪽넘김이 없다」에 실측이 있는가 | fatal | `validate/v0_guide.py:3367` | **★ 없음** | 없음 | guide/06_오판대장.md:262 · guide/07_밀린일대장.md:39 |
| `S46-132` | 인계문이 다시 재라고 적는가 | fatal | `validate/v0_guide.py:3259` | **★ 없음** | 없음 | guide/06_오판대장.md:263 |
| `S46-133` | 검사 구멍이 밀린일에 있는가 | fatal | `validate/v0_guide.py:3622` | **★ 없음** | 없음 | guide/06_오판대장.md:264 |
| `S46-134` | 질의와 규격이 어긋나지 않는가 | fatal | `validate/v0_guide.py:3500` | **★ 없음** | 없음 | guide/06_오판대장.md:265 |
| `S46-135` | 일반화에 표본이 있는가 | fatal | `validate/v0_guide.py:3389` | **★ 없음** | 없음 | guide/06_오판대장.md:266 |
| `S46-136` | 규격의 warn 수가 지금 값과 같은가 | fatal | `validate/v0_guide.py:3640` | **★ 없음** | 없음 | guide/06_오판대장.md:267 · guide/07_밀린일대장.md:40 |
| `S46-137` | 질의 열쇠를 읽는 코드가 있는가 | fatal | `validate/v0_guide.py:3662` | **★ 없음** | 없음 | guide/06_오판대장.md:268 |
| `S46-138` | 「전량」에 세는 법이 있는가 | fatal | `validate/v0_guide.py:3406` | **★ 없음** | 없음 | guide/03_이력.md:999 · guide/06_오판대장.md:269 |
| `S46-139` | 「칸이 비었다」에 전수가 있는가 | fatal | `validate/v0_guide.py:3691` | **★ 없음** | 없음 | guide/06_오판대장.md:270 |
| `S46-140` | 쓰는 호스트가 robots 문서에 있는가 | fatal | `validate/v0_guide.py:3273` | **★ 없음** | 없음 | guide/06_오판대장.md:271 · guide/07_밀린일대장.md:39 |
| `S46-141` | 거르개 판정에 실측이 있는가 | fatal | `validate/v0_guide.py:3526` | **★ 없음** | 없음 | guide/06_오판대장.md:272 |
| `S46-142` | 「N 사이트」가 config 와 같은가 | fatal | `validate/v0_guide.py:3292` | **★ 없음** | 없음 | guide/06_오판대장.md:273 · guide/07_밀린일대장.md:40 |
| `S46-143` | 마스터께 올릴 것이 세어졌는가 | fatal | `validate/v0_guide.py:3543` | **★ 없음** | 없음 | guide/03_이력.md:1001 · guide/06_오판대장.md:274 |
| `S46-144` | 「비었다」가 ⑤·⑥·⑦ 로 갈렸는가 | fatal | `validate/v0_guide.py:3772` | **★ 없음** | 없음 | guide/03_이력.md:983 · guide/06_오판대장.md:275 · guide/12_남은것_20260829.md:15 |
| `S46-145` | 마스터께 드리는 표에 수의 뜻이 있는가 | fatal | `validate/v0_guide.py:3125` | **★ 없음** | 없음 | guide/03_이력.md:985 · guide/06_오판대장.md:276 |
| `S46-146` | 「안 준다」를 쓰며 파서를 봤는가 | fatal | `validate/v0_guide.py:3323` | **★ 없음** | 없음 | guide/03_이력.md:997 · guide/06_오판대장.md:277 |
| `S46-147` | 「안 준다」의 표본이 열 건인가 | fatal | `validate/v0_guide.py:3578` | **★ 없음** | 없음 | guide/05_가이드역할.md:1500 · guide/06_오판대장.md:278 · evidence/absence_20260829.md:6 |
| `S46-148` | 「축이 빈다」가 칼럼·파서를 짚는가 | fatal | `validate/v0_guide.py:3708` | **★ 없음** | 없음 | guide/03_이력.md:1001 · guide/06_오판대장.md:279 |
| `S46-149` | 자백이 닫혔는가 | fatal | `validate/v0_guide.py:3430` | **★ 없음** | 없음 | guide/06_오판대장.md:280 · guide/07_밀린일대장.md:40 |
| `S46-150` | 규격의 칼럼이 DDL 에 있는가 | fatal | `validate/v0_guide.py:3600` | **★ 없음** | 없음 | guide/06_오판대장.md:281 |
| `S46-152` | 마지막 개발 회차를 읽었는가 | fatal | `validate/v0_guide.py:3726` | **★ 없음** | 없음 | guide/03_이력.md:991 · guide/03_이력.md:1007 · guide/03_이력.md:1009 |
| `S46-153` | 「마스터 몫」이 진짜 마스터 몫인가 | fatal | `validate/v0_guide.py:3789` | **★ 없음** | 없음 | guide/03_이력.md:1007 · guide/03_이력.md:1009 · guide/06_오판대장.md:284 |
| `S46-154` | 마스터 말씀이 요구 추적표에 있는가 | fatal | `validate/v0_guide.py:3345` | **★ 없음** | 없음 | guide/01_요구사항.md:49 · guide/03_이력.md:1005 · guide/06_오판대장.md:285 |
| `S46-155` | 화면 규격마다 시안이 있는가 | fatal | `validate/v0_guide.py:3154` | **★ 없음** | 없음 | guide/03_이력.md:985 · guide/03_이력.md:1003 · guide/06_오판대장.md:286 |
| `S46-156` | 개발측 물음의 답이 규격에 있는가 | fatal | `validate/v0_guide.py:3457` | **★ 없음** | 없음 | guide/06_오판대장.md:287 |
| `S46-157` | 성능 판정에 시간이 있는가 | fatal | `validate/v0_guide.py:3821` | **★ 없음** | 없음 | guide/06_오판대장.md:288 |
| `S46-158` | 용량 판정에 수가 있는가 | fatal | `validate/v0_guide.py:3839` | **★ 없음** | 없음 | guide/06_오판대장.md:289 |
| `S46-159` | 설계도가 할 수 있는 것만 시키는가 | fatal | `validate/v0_guide.py:3753` | **★ 없음** | 없음 | guide/06_오판대장.md:290 · guide/07_밀린일대장.md:40 |
| `S46-160` | 전기차 누유가 만점·분모 910 인가 | fatal | `validate/v0_guide.py:3857` | **★ 없음** | 없음 | guide/03_이력.md:971 · guide/06_오판대장.md:291 · guide/06_오판대장.md:292 |
| `S46-161` | 「사이트가 안 준다」에 증거가 있는가 | fatal | `validate/v0_guide.py:3046` | **★ 없음** | 없음 | guide/03_이력.md:975 · guide/03_이력.md:977 · guide/03_이력.md:979 |
| `S46-162` | 오판이 약속한 검사가 실제로 있는가 | fatal | `validate/v0_guide.py:3095` | **★ 없음** | 없음 | guide/03_이력.md:977 · guide/03_이력.md:979 · guide/03_이력.md:985 |
| `S46-163` | 시안마다 라우팅 표에 주소가 있는가 | fatal | `validate/v0_guide.py:3187` | **★ 없음** | 없음 | guide/03_이력.md:985 · guide/03_이력.md:1003 · guide/06_오판대장.md:294 |
| `S46-164` | 개발 회차의 「마스터 몫」에 답을 냈는가 | fatal | `validate/v0_guide.py:3874` | **★ 없음** | 없음 | guide/03_이력.md:991 · guide/06_오판대장.md:295 · guide/14_누가할것_20260829.md:39 |
| `S46-165` | 「못 잰다」가 진짜인가 | fatal | `validate/v0_guide.py:3902` | **★ 없음** | 없음 | guide/03_이력.md:1011 · guide/06_오판대장.md:296 · guide/06_오판대장.md:297 |
| `S46-166` | 마스터 확정이 장 규격에 닿았는가 | fatal | `validate/v0_guide.py:3940` | **★ 없음** | 없음 | guide/03_이력.md:1017 · guide/06_오판대장.md:298 · chapters/41-view.md:974 |
