...
|---|---|---|---|---|---|---|---|:--:|
| WB-001 | `[화면]` | **가변형 반응형** — 값을 버리지 않는다 | `[마스터]` 278 | `61-web/a-common` | `report/screens/build.py::view_recommend` | 전 화면 | V11-70·71 | ○ |
...
| WB-011 | `[화면]` | **CSS 에 지문을 붙인다** — 캐시 | `[마스터]` | `61-web` | 미구현 | 화면 없음 | V11-82 | ◐ |
...
| WB-015 | `[판정·화면]` | v1 22열 · 축을 열로 | `[시안]` 277 | `61-web/b-list` | 미구현 | 목록 | V11-68 | ○ |
