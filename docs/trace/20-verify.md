...
| VF-009 | `[검사]` | `kind` 를 안 정하면 `Check` 생성 거부 | `[기술]` 강제하지 않으면 안 적는다 | `20-verify` | ✓ `validate/base.py::Check` | 해당 없음 | V4-19 | ○ |
...
| VF-014 | `[검사]` | 차수를 늘리면 정규식도 함께 고친다 | `[기술]` `\d+` 로 받는 편이 낫다 | `20-verify` | ~ `tools/check_src.py:25` | 해당 없음 | S19 | ◐ |
