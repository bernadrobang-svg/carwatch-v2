...
```
필수  ★ ★ **`status='gone'` 을 ★ 이것으로 정한다**
      ★ ★ 지금은 ★ **목록에서 사라진 것**으로만 안다 — ★ 하루 늦다
      ★ ★ **404 면 ★ 그 자리에서 `gone`** 이다
필수  ★ ★ **마스터께서 「엔카 받기」를 누르실 때 ★ 함께 잰다**
      ★ ★ 우리 서버 IP 는 ★ **막힌다** — ★ 마스터 회선으로만 된다
      ★ ★ **관심에 담은 것부터** 재라 — ★ 마스터께서 보시는 차다
필수  ★ ★ 404 인 것은 ★ **지우지 않는다** — ★ 딱지를 「팔림」으로 바꾼다 (마스터 확정 08-24)
검산  ★ ★ **`S46-114`** — ★ `gone` 인데 ★ 마지막 확인이 ★ 사흘 넘었으면 ★ 알림
```
