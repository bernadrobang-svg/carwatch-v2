...
| `OPTION_CATALOG.md` | 257 | 12 |
| `README.md` | 65 | 1 |
| `REBORNCAR_API.md` | 445 | 23 |
| `ROADMAP_20260830.md` | 126 | 4 |
| `SCHEMA.md` | 112 | 5 |
| `SERVER_SURVIVAL.md` | 258 | 12 |
| `SOURCE.md` | 728 | 54 |
| `TARGET_KEY_MAP.md` | 229 | 11 |
...
| `chapters/30-score/f-table.md`  ★ | 2,509 | 119 |
