...
`SPEC-2026.08.28-r790` · 2026-08-22 · **가이드가 직접 실측했다 (원칙 4)**
...
```
★ 매물번호는 ★ **`carCd`** 다 — `stockCar/list` 가 준다 (보기 `EC61388152`)
```
